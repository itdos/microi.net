<template>
	<div class="ccmpvue-picker">
		<div :class="{'pickerMask':showPicker}" @click="maskClick" catchtouchmove="true"></div>
		<div class="ccmpvue-picker-content " :class="{'ccmpvue-picker-view-show':showPicker}">
			<div class="ccmpvue-picker__hd" catchtouchmove="true">
				<div class="ccmpvue-picker__action" @click="pickerCancel">取消</div>
				<div class="ccmpvue-picker__action" :style="{color:themeColor}" @click="pickerConfirm">确定</div>
			</div>
			<picker-view indicator-style="height: 40px;" class="ccmpvue-picker-view" :value="pickerValue" @change="pickerChange">
				<!-- <block> -->
					<picker-view-column>
...
<style>
	...
	.ccmpvue-picker__action {
		display: block;
		flex: 1;
		color: #1aad19;
	}

	.ccmpvue-picker__action:first-child {
		text-align: left;
		color: #888;
	}

	.ccmpvue-picker__action:last-child {
		text-align: right;
	}
