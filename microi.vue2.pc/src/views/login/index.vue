            ...
            <div
                        ...
                        <div class="input-group">
                            ...
                            <div
                                ...
                                <span class="input-group-text" style="padding: 0;">
                                    ...
                                    <span @click="Login">
                                        <i id="faLogin"  class="fas fa-arrow-right hand" style="width: 50px;height: 36px;line-height: 36px;" />
                                    </span>
                                </span>
                            </div>
                        </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <p>
                            <a href="javascript:;">
                                ...
                                {{ $t('Msg.Version') }}{{ Lang == 'cn' ? '：' : ': ' }}{{$root.OsVersion}}
                            </a>
                        </p>
                        <p>
                    ...
                    <p>
                        ...
                        <a href="javascript:;" :style="{fontWeight: Lang == 'cn' ? 'bold' : ''}" @click="DiyCommon.ChangeLang('cn')">CN</a>
                    </p>
                </div>
            </div>
            <div
