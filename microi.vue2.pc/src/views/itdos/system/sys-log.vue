            ...
            <el-card class="box-card no-padding-body">
                <el-form
                    ...
                    <el-form-item size="mini">
                        <el-button
                            icon="el-icon-search"
                            @click="GetSysLog(true)">{{ $t('Msg.Search') }}</el-button>
                    </el-form-item>
                </el-form>
                <el-table
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-tooltip effect="light" placement="bottom">
                                <div slot="content" style="max-width:500px;">{{scope.row.Content}}</div>
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            <el-tooltip effect="light" placement="bottom">
                                <div slot="content" style="max-width:500px;">{{scope.row.Api}}</div>
                    ...
                    >
                        <template slot-scope="scope">
                            <el-tooltip effect="light" placement="bottom">
                                <div slot="content" style="max-width:500px;">{{scope.row.Param}}</div>
                    ...
                    <template slot-scope="scope">
                            <el-tooltip effect="light" placement="bottom">
                                <div slot="content" style="max-width:500px;">{{scope.row.OtherInfo}}</div>
...
export default {
    ...
    methods: {
        ...
        GetSysLog(initPageIndex) {
            ...
            self.DiyCommon.Post('/api/syslog/GetSysLog', {
