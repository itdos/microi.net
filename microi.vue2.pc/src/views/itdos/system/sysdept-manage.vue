            ...
            <el-card class="box-card no-padding-body">
                <el-form
                    ...
                    <el-form-item size="mini">
                        <el-button
                            icon="el-icon-search"
                            @click="GetSysDept()">{{ $t('Msg.Search') }}</el-button>
                        ...
                        <el-button
                            type="primary"
                            icon="el-icon-plus"
                            @click="OpenMenuForm()">{{ $t('Msg.Add') }}</el-button>
                    </el-form-item>
                </el-form>
                <el-table
                            ...
                            <el-dropdown trigger="click">
                                ...
                                <el-dropdown-menu
                                    ...
                                    <el-dropdown-item
                                        icon="el-icon-delete"
                                        divided
                                        @click.native="DelSysDept(scope.row)">{{ $t('Msg.Delete') }}</el-dropdown-item>
                                </el-dropdown-menu>
                            </el-dropdown>
                        </template>
                    </el-table-column>
                        ...
                        <el-col
                            ...
                            <div class="container-form-item">
                                <el-form-item
                                    ...
                                    :label="'编码'"
                                    size="mini">
                                    <el-input readonly disabled :value="DiyCommon.IsNull(CurrentSysDeptModel.Code)? '' : CurrentSysDeptModel.Code.substring(0, CurrentSysDeptModel.Code.length - 1)" placeholder="自动生成" ></el-input>
...
// import Fontawesome from "dos.fontawesome";
import {
    mapState,
    mapMutations,
    mapGetters
...
export default {
    ...
    methods: {
        ...
        ChangeTenant(val){
            var self = this;
            if(val){
                var tenantName = _.find(self.TenantList, function(item){ return item.Id == val }).TenantName;
