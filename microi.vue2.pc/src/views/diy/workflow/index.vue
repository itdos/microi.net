<template>
    <div
                            ...
                            <el-table-column
                                ...
                                <template slot-scope="scope">
                                    <el-button
                                        ...
                                        class="marginRight5"
                                        icon="el-icon-s-help"
                                        @click="$router.push('/wf/flow-design/' + scope.row.Id)">{{ $t('Msg.Design') }}</el-button>
            ...
            <el-row :gutter="20">
                <el-skeleton
                    ...
                    <el-col :xs="24" :span="5" 
                        ...
                        >
                        <el-card class="box-card card-data-animate no-padding">
                            <img :src="require('../img/body-bg.svg')" class="preview">
                            <div class="body">
                                ...
                                <div style="float: right;">
                                    <el-button
                                        ...
                                        class="marginRight5"
                                        icon="el-icon-s-help"
                                        @click="$router.push('/wf/flow-design/' + model.Id)">{{ $t('Msg.Design') }}</el-button>
                                    <el-dropdown trigger="click"
                                        v-if="GetCurrentUser._IsAdmin === true"
                                        >
                                        <el-button type="text">
                                        ...
                                        <el-dropdown-menu
                                            ...
                                            <el-dropdown-item
                                                icon="el-icon-delete"
                                                divided
                                                @click.native="DelDiyTableRow(model)">
                                                {{ $t('Msg.Delete') }}
                                            </el-dropdown-item>
                            ...
                            <div class="bottom">
                                ...
                                <el-button type="primary" 
                                    @click="StartFlow(model)"
                                    icon="el-icon-plus"
                                    size="mini" style="float:right;">发起流程</el-button>
                            </div>
                        </el-card>
                    </el-col>
                </el-skeleton>
        ...
        <el-dialog
            ...
            <DiyForm ref="form_diy_flow" 
                :form-mode="DiyFormMode" 
                :table-id="DiyTableId" 
                :table-row-id="CurrentDiyTableModel.Id" 
            />
            <span slot="footer" class="dialog-footer">
                <el-button
                    ...
                    size="mini"
                    icon="el-icon-s-help"
                    @click="DiySave">{{ $t('Msg.Save') }}</el-button>
                <el-button
                    size="mini"
                    icon="el-icon-close"
            ...
            <div slot="title">
                ...
                <div class="pull-right">
                    <el-button
                        size="mini"
                        icon="el-icon-close"
                        @click="ShowStartFlowForm = false">{{ $t('Msg.Close') }}</el-button>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            GetDiyTableRow(initPageIndex) {
                ...
                self.DiyCommon.Post(self.DiyApi.GetDiyTableRow, {
            ...
            DelDiyTableRow(m) {
                ...
                self.DiyCommon.OsConfirm(self.$t('Msg.ConfirmDelTo') + '【' + m.FlowName + '】？', function () {
                    self.DiyCommon.Post(self.DiyApi.DelDiyTableRow, {
                            Id: m.Id,
                            TableId: self.DiyTableId,
                        },
                        function (result) {
