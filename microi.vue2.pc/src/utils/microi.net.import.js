...
// import { DosCommon } from '@/views/diy/utils/dos.common'
// import { DiyCommon } from '@/views/diy/utils/diy.common'
// import { DiyApi } from '@/views/diy/api/api.itdos'
// var tValue = require('@/views/diy/store/diy.store');
...
import 
    {   DosCommon, DiyCommon, DiyApi, DiyStore, 
        ...
        DiyForm, 
        // DiyFormPage, 
        DiyFormDialog, DiyModule,
        DiyChat,
        DiyFlowDesign,WFWorkHandler,WFHistory,WFDesignPreview
    } 
from 'microi.net'
//-------END
export {
