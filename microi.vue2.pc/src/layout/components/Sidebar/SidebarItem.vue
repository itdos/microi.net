<template>
    <div v-if="!item.hidden">
        <template
            ...
            "
        >
                <!-- :to="resolvePath(DosCommon.IsNull(onlyOneChild.Link) ? onlyOneChild.path : onlyOneChild.Link)" -->
            <app-link
...
export default {
    ...
    methods: {
        GetMenuWordColor(){
            var self = this;
            if(self.SysConfig.MenuBg == 'Custom' && !self.DosCommon.IsNull(self.SysConfig.MenuWordColor)){
        ...
        resolvePath(routePath) {
            ...
            var result = path.resolve(this.basePath, routePath);
            return result;
        },
