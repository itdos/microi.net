<template>
  <div id="tags-view-container-microi" class="tags-view-container-microi" :style="GetTagsViewContainerMicroiStyle()">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper-microi" @scroll="handleScroll">
      <router-link
        ...
        tag="span"
        class="tags-view-item-microi"
        @click.middle.native="!isAffix(tag)?closeSelectedTag(tag):''"
        @contextmenu.prevent.native="openMenu(tag,$event)"
      >
        <!-- by itdos -->
        <item v-if="tag.meta" :icon="tag.meta && tag.meta.icon" :title="generateTitle(tag.meta.title)" />
