<template>
  <div :class="classObj" class="app-wrapper-microi">
    ...
    <sidebar 
      ...
      class="sidebar-container-microi" :style="GetMenuBg()"/>
    <div :class="{hasTagsView:needTagsView}" class="main-container-microi"
        :style="GetMainContainerMicroiStyle()">
      <div :class="{'fixed-header-microi':fixedHeader}"
...
export default {
  ...
  methods: {
    ...
    GetMenuBg(){
      var self = this;
      var result = {};
      if(self.SysConfig.MenuBg == 'Custom' && !self.DosCommon.IsNull(self.SysConfig.MenuBackgroundColor)){
          result['backgroundColor'] = self.SysConfig.MenuBackgroundColor;
      }
      if(self.SysConfig.MenuBg == 'Custom' && !self.DosCommon.IsNull(self.SysConfig.MenuBoxShadow)){
          result['boxShadow'] = self.SysConfig.MenuBoxShadow;
      }
      if(self.SysConfig.MenuBg == 'Custom' && !self.DosCommon.IsNull(self.SysConfig.MenuWidth)){
          //这里要判断hideSidebar
