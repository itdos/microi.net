...
public class CacheAndUpgradeRegressionTests
{
    ...
    public void AppStoreUpgrade_RejectsWorkersWithoutPinnedSnapshotCapabilities()
    {
        ...
        Assert.True(Assert.IsType<bool>(hasImporter!.Invoke(null,
            new object[] { importerCode, new System.Version(2, 7, 2) })));
        ...
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("PACKAGE_REPLAY_VERSION_GUARD_V2", "LEGACY_REPLAY_GUARD"), new System.Version(2, 7, 2) })));
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("PackagePointerMode: 'HdfsV1'", "PackagePointerMode: 'Legacy'"), new System.Version(2, 7, 2) })));
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("TRUSTED_EMBEDDED_OFFICIAL_PACKAGE_V1", "LEGACY_EMBEDDED_PACKAGE_TRUST"), new System.Version(2, 7, 2) })));
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("PHYSICAL_NOT_NULL_TENANT_BACKFILL_V1", "LEGACY_NOT_NULL_BACKFILL"), new System.Version(2, 7, 2) })));
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("MARKETPLACE_CHANGELOG_TENANT_COLLISION_REPAIR_V1", "LEGACY_CHANGELOG_BACKFILL"), new System.Version(2, 7, 2) })));
        Assert.False(Assert.IsType<bool>(hasImporter.Invoke(null,
            new object[] { importerCode.Replace("PAGE_ENGINE_OPTIONAL_REFERENCE_V1", "LEGACY_PAGE_REFERENCE"), new System.Version(2, 7, 2) })));
