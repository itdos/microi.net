...
export const officialPackageChangeLogDefinitions = Object.freeze({
  ...
  'app.microi.store.json': Object.freeze({
    version: 'v7.7.0',
    title: 'AI 应用脚手架全面切换平台接口引擎',
    changeType: 'Optimize',
    content: 'ai_app_create v1.2.3 同步维护版 Microi 前端 SDK；新建 Web 与 MicroService 的系统配置、当前用户、租户发现、私有文件及平台业务调用统一使用 platform-* 接口引擎，不再生成已迁移 Controller 的旧地址。',
    releaseTime: '2026-08-26 21:00:00',
  }),
  'app.microi.saas-engine.json': Object.freeze({
    version: 'v7.7.1',
    title: '平台业务 Controller 进一步迁入 V8',
    changeType: 'Optimize',
    content: '数据源、模块、OCR、Office 模板导出、翻译、系统安全治理与用户行为迁入官方 Managed 接口；只保留最小可信 V8 原子和租户 CreateIfMissing Hook。',
