...
test("publisher package metadata matches the v1.9.24 V3 source", () => {
  assert.ok(packagedPublisher);
  assert.equal(packagedPublisher.Version, "v1.9.24");
  assert.equal(
...
test("protocol v3 package write is a committed-proof fenced CAS with pre/post readback", () => {
  assert.match(publisherSource, /Version: v1\.9\.24/);
  assert.match(
    publisherSource,
