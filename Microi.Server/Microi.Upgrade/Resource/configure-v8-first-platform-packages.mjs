...
export const packageDefinitions = Object.freeze([
  Object.freeze({
    ...
    history: '2026-08-25 v7.6.0 系统账号官方接口递归深度统一收敛到运行时硬上限 5000；保留 v6.3.2 Managed 账号管理、可信改密预检与租户 Hook 契约。',
    capabilities: [
  ...
  Object.freeze({
    ...
    history: '2026-08-25 v6.3.8 非敏感租户系统设置列表、保存和删除迁入 Managed V8 接口；敏感明文仍只经过可信后端。',
    capabilities: [
    ...
    engines: [
      { key: 'platform-tenant-system-settings', name: '租户系统设置管理', source: 'platform-tenant-system-settings.js', id: '019d2a01-9d63-7f91-8c02-000000000003', version: 'v1.0.0', enableLog: 1 },
  ...
  Object.freeze({
    ...
    history: '2026-08-26 v1.0.11 补齐 msg_event 依赖的微信模板消息 Managed 适配器；公众号密钥只在当前租户可信宿主读取，并在发送前调用 CreateIfMissing 个性化 Hook。\n2026-08-26 v1.0.10 将全部官方 Managed 消息接口归一为 Platform 所有权，避免内置包重放时发生所有权降级冲突。\n2026-08-25 v1.0.9 修复 SignalR Hub 调用 StopHttp=1 聊天运行时被误判为 HTTP；Hub 使用绑定租户、固定 Key 和权威当前用户的一次性可信协议上下文，V8 原子消费后执行。',
    capabilities: [
    ...
    engines: [
      { key: 'platform-chat-system-message', name: '平台系统消息编排', source: 'platform-chat-system-message.js', id: '019d2a01-9d63-7f91-8c02-000000000005', version: 'v1.1.0', enableLog: 1, stopHttp: 1 },
      { key: 'platform-chat-runtime', name: '平台聊天 Managed 运行时', source: 'platform-chat-runtime.js', id: '019d2a01-9d63-7f91-8c02-00000000000b', version: 'v1.0.1', enableLog: 1, stopHttp: 1 },
  ...
  Object.freeze({
    ...
    history: '2026-08-25 v7.6.0 AI助手官方接口递归深度统一收敛到运行时硬上限 5000；保留 v6.3.6 支付可信网关、Managed 账号编排与非流式 AI 运行时契约。',
    capabilities: [
    ...
    engines: [
      ...
      { key: 'platform-ai-runtime', name: 'AI 非流式兼容运行时', source: 'platform-ai-runtime.js', id: '019d2a01-9d63-7f91-8c02-00000000000a', version: 'v1.0.0', enableLog: 1 },
...
export function configurePackageModel(packageModel, definition) {
  ...
  info.ChangeLog = {
    Version: definition.version,
    Title: 'V8 引擎优先与租户个性化扩展',
    ChangeType: definition.changeType || 'Feature',
    Content: definition.history,
