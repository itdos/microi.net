...
export const packageDefinitions = Object.freeze([
  Object.freeze({
    ...
    changeLogTitle: '系统账号多路由与访问密钥闭包',
    changeType: 'Optimize',
    changeLogContent: '将用户访问密钥四个旧控制器入口迁入 platform-user-access-key Managed 接口引擎，并与系统账号旧路由统一纳入多路由闭包。',
  ...
  Object.freeze({
    ...
    changeLogTitle: '租户系统设置接口引擎化',
    changeType: 'Optimize',
    changeLogContent: '将 TenantSystemSettingsController 迁入 platform-tenant-system-settings；多路由统一普通 CRUD、地图运行时、Secret 保存与二次认证揭示。',
    releaseTime: '2026-08-30 12:00:00',
    capabilities: [
  ...
  Object.freeze({
    ...
    changeLogTitle: '系统消息多路由与发布历史闭包',
    changeType: 'Optimize',
    changeLogContent: '完成 /api/DiyChat/SendSystemMessage 多路由、事务提交后实时投递与官方包追加式发布历史闭包。',
    releaseTime: '2026-08-30 12:00:00',
    capabilities: [
  ...
  Object.freeze({
    ...
    changeLogTitle: 'AI 历史非流式路由接口引擎化',
    changeType: 'Optimize',
    changeLogContent: '将旧 /api/Ai 非流式地址全部收入 platform-ai-runtime 与 platform-ai-account 多路由，动作映射和管理员复核保持不变。',
    releaseTime: '2026-08-30 12:00:00',
    capabilities: [
