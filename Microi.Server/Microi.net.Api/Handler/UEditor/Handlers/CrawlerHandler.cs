    ...
    public class Crawler
    {
        ...
        public Crawler Fetch()
        {
            ...
            using (var response = request.GetResponse() as HttpWebResponse)
            {
                ...
                ServerUrl = PathFormatter.Format(Path.GetFileName(sourceUri.AbsolutePath), UeditorConfig.GetString("catcherPathFormat"));

                var savePath = Path.Combine(UeditorConfig.WebRootPath, ServerUrl);
