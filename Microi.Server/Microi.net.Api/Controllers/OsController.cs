    ...
    {        private static FormEngine _formEngine = new FormEngine();
            ...
            try
            {
                ...
                var AddDiyField = async delegate (DiyFieldParam diyFieldParam)
                {
                    try
                    {
                        ...
                        {
                            result = await new DiyFieldLogic().UptDiyField(fieldParam);
                        }
                        return result;
                    }
                    catch (Exception ex)
                ...
                else if (Version == "v3.8.22")
                {
                    ...
                    try
                    {
                        ...
                        var result = await _formEngine.UptFormDataByWhereAsync(new {
                            OsClient = osClientName,
                            TableName = "Sys_User",
                            _RowModel = new {
                                PwdEncode = "DES"
                ...
                else if (Version == "v3.8.8")
                {
                    //using (var trans = dbSession.BeginTransaction())
                    {
                        ...
                        await new DiyTableLogic().LoadNotDiyTable(new DiyTableParam() {
                            Name = "Sys_Menu",
                        ...
                        await new DiyTableLogic().UptDiyTable(new DiyTableParam()
                        {
                            Id = "1d28e502-70ea-4a2b-9793-699b3f42234e",
                            IsTree = 1,
        ...
        public async Task CheckServer(string OsClient)
        {
            ...
            try
            {
                ...
                try
                {
                    var DiyCacheBase = new MicroiCacheRedis(osClientStr);
        ...
        public async Task DynamicApiEngineInit()
        {
            ...
            try
            {
                ...
                var result = await DynamicRoute.Init(clientModel);
