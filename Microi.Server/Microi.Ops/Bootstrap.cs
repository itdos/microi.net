...
internal static class Bootstrap
{
    public static async Task Run(CancellationToken ct)
    {
        ...
        var image = Env("OPS_BOOTSTRAP_IMAGE", "registry.cn-hangzhou.aliyuncs.com/microios/microi-ops:v1.0.1");
        ...
        Console.WriteLine("Microi.Ops 编排已生成。账号和随机密码保存在 " + envPath + "，不会输出到安装日志。");
