...
namespace Microi.net
{
    ...
    public partial class DiyFieldConfigTableChild
    {
        ...
        public List<DiyFieldConfigTableChildImportBackfill> ImportBackfillFields { get; set; }
    }
    ...
    public partial class DiyFieldConfigTableChildImportBackfill
    {
        public string Father { get; set; }
        public string Parent { get; set; }
        public string Child { get; set; }
        public string FatherFieldName { get; set; }
        public string ParentFieldName { get; set; }
        public string ChildFieldName { get; set; }
        public string ParentFieldLabel { get; set; }
        public string ChildFieldLabel { get; set; }
