...
namespace Microi.net
{
    ...
    public interface IFormEngine
    {
        ...
        Task<DosResult<dynamic>> AddDiyTable(dynamic dynamicParam, DbTrans _trans = null);
        ...
        #region 表管理
        Task<DosResult<dynamic>> AddDiyField(dynamic dynamicParam, DbTrans _trans = null);
