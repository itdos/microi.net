...
namespace MongoDB.Driver.Core.Misc
{
    internal static class WireVersion
    {
        ...
        // Microi 兼容补丁：保留所有特性协商与安全修复；平台使用的旧服务端路径须通过真实 3.6/7.0 回归。
        private static Range<int> __supportedWireVersionRange = CreateSupportedWireVersionRange(minWireVersion: Server36, maxWireVersion: Server91);
