...
export const API = {
  ...
  LIST_DATABASE_BACKUP_TENANTS: '/api/V8Engine/ListDatabaseBackupTenants',
  RUN_DATABASE_BACKUP: '/api/V8Engine/RunDatabaseBackup',
  ...
  LIST_PAGE_ENGINE_HISTORY: '/api/V8Engine/ListPageEngineHistory',
  GET_PAGE_ENGINE_HISTORY: '/api/V8Engine/GetPageEngineHistory',
  COMPARE_PAGE_ENGINE_VERSIONS: '/api/V8Engine/ComparePageEngineVersions',
  EXPORT_PAGE_ENGINE: '/api/V8Engine/ExportPageEngine',
  ROLLBACK_PAGE_ENGINE: '/api/V8Engine/RollbackPageEngine',

  // 业务架构蓝图（System Blueprint）
  LIST_BLUEPRINTS: '/api/V8Engine/ListBlueprints',
  GET_BLUEPRINT: '/api/V8Engine/GetBlueprint',
  LIST_BLUEPRINT_HISTORY: '/api/V8Engine/ListBlueprintHistory',
  GET_BLUEPRINT_HISTORY: '/api/V8Engine/GetBlueprintHistory',
  COMPARE_BLUEPRINT_VERSIONS: '/api/V8Engine/CompareBlueprintVersions',
  EXPORT_BLUEPRINT: '/api/V8Engine/ExportBlueprint',
  SAVE_BLUEPRINT: '/api/V8Engine/SaveBlueprint',
  ROLLBACK_BLUEPRINT: '/api/V8Engine/RollbackBlueprint',
