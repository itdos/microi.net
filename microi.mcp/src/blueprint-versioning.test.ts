...
test('blueprint version tools expose read-only diff and confirmation-gated rollback', async () => {
  ...
  const fakeClient = {
    ...
    rollbackBlueprint: async (data: Record<string, unknown>) => {
