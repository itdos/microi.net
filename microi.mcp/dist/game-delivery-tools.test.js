...
test('game delivery tools gate paid generation and role writes while exposing source cleanup preflight', async () => {
    ...
    try {
        ...
        const confirmationSha256 = JSON.parse(textOf(roleDryRun)).confirmationSha256;
...
//# sourceMappingURL=game-delivery-tools.test.js.map