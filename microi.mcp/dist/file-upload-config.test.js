...
test('附件权限默认值与私有存储约束', () => {
    ...
    assert.equal(buildFileUploadConfig({}).FileUpload.EnableRolePermission, false);
    assert.deepEqual(buildFileUploadConfig({ ConfigurableRoleIds: ['r1', 'r1'] }).FileUpload.ConfigurableRoleIds, ['r1']);
...
//# sourceMappingURL=file-upload-config.test.js.map