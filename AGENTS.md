...
- `Microi.Server/Microi.net/`、`Microi.Server/Microi.AI/`、`Microi.Code/`、`Microi.Client/src/views/webos/`、`Microi.Server/Microi.WorkFlow/`、`Microi.Server/Microi.Vision/` 是六个独立闭源 Git 仓库，只允许从各自仓库根目录推送到公司内部 GitLab。
