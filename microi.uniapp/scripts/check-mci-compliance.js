...
assert(featureFlags.includes('DisableMessageTabBar') && sysConfig.includes('getMessageTabBarEnabled') && aiLauncher.includes('messageTabBarEnabled: true') && customTabBarJs.includes('messageTabBarEnabled: true'), 'Message tabBar visibility must use the negative DisableMessageTabBar switch and default open across custom tabBar runtimes.');
assert(featureFlags.includes('DisableInviteEntry') && sysConfig.includes('getInviteEntryEnabled') && read('src/pages/profile/index.vue').includes('inviteEntryEnabled: true'), 'Profile invitation visibility must use the negative DisableInviteEntry switch and default open.');
