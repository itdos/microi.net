...
namespace Microi.net
{
    public partial class V8EngineMethodExtend
    {
        ...
        //     byte[] subArray = new byte[array.Length - 16];
        //     Array.Copy(array, 0, subArray, 0, subArray.Length);

        //     // byte[] subArray2 = array[^16..];
        //     byte[] subArray2 = new byte[16];
        //     Array.Copy(array, array.Length - 16, subArray2, 0, subArray2.Length);
