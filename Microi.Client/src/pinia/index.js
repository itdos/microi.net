...
import { installPickedPersistence } from "./picked-persistence.js";
...
if (!isEmbeddedWebosWindowRuntime()) pinia.use(context => {
    if (!installPickedPersistence(context)) piniaPluginPersistedstate(context);
});
