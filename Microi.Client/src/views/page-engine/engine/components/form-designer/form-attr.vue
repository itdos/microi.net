...
<template>
  <el-form>
    <el-form-item :label="$pet('页面编号')">
      <el-input size="small" type="text" v-model="formData.Number"></el-input>
    </el-form-item>
    <el-form-item :label="$pet('页面标题')">
      <el-input
        size="small"
        v-model="formData.Title"
        :placeholder="$pet('请输入页面标题')"
      />
    </el-form-item>
    <el-form-item :label="$pet('页面简介')">
      <el-input
        size="small"
        style="width: 90%"
    ...
    <el-form-item :label="$pet('水印文字')">
      <el-input
        v-model="formConfig.watermarkStyle.content"
        size="small"
        :placeholder="$pet('请输入水印文字')"
      />
    </el-form-item>

    <el-form-item :label="$pet('文字大小')" style="width: 90%">
      <el-slider
        :min="0"
        :max="100"
        :step="1"
    ...
    <el-form-item :label="$pet('文字旋转')" style="width: 90%">
      <el-slider
        :min="-180"
        :max="180"
        :step="1"
