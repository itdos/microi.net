...
import { GoThemeSelect } from '@goview/components/GoThemeSelect'
import { GoLangSelect } from '@goview/components/GoLangSelect'
import { ThemeColorSelect } from '@goview/components/Pages/ThemeColorSelect'
import { PageEnum } from '@goview/enums/pageEnum'
