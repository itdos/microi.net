...
import { ErrorPageNameMap, PageEnum } from '@goview/enums/pageEnum'
import { docPath, giteeSourceCodePath } from '@goview/settings/pathConst'
...
import router from '@goview/router'
