...
import { GlobalSetting, CollapseItem, SettingItemBox, SettingItem } from '@goview/components/Pages/ChartItemSetting'
import { option } from './config'
import { ScatterEffectTypeEnumList, SymbolEnumList } from '../shard'
import { axisConfig } from '@goview/packages/chartConfiguration/echarts/index'
