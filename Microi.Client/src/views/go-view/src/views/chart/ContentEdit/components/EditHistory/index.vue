...
import { historyActionTypeName } from '@goview/store/modules/chartHistoryStore/chartHistoryDefine'
import { CreateComponentType } from '@goview/packages/index.d'
import { editHistoryMax } from '@goview/settings/designSetting'
