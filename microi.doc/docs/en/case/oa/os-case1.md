# Successful Case Based on Microi Code-ERP of OA Office System of Group and State-owned Enterprises

## Online Trial Address
> * Address:[https://nbcmc-dev.microi.net](https://nbcmc-dev.microi.net)
> * Account: admin
> * Password: 1234567

## Group, state-owned enterprise OA office system ERP
* SOE Products, Group Structure
* The development cycle is 2 months, developed by one customer, and the official team of Microi Code provides technical support.
## Group, state-owned enterprise OA office system lightweight ERP system introduction, highlights
* 150 function modules, 170 physical tables, 28 interface engines and 49 process engines have been configured.
* Supporting small program process approval, multi-attendance point clock-in.
## System Screenshot
