...
This project recommends using Visual Studio Code for development
...
:::warning
💢Microi code uses Vue's official recommended style guide, please be sure to check it out.
:::
...
| Dependency | Role description |
| :-----------------------------: | :--------------------------------------------------------------------------: |
| husky | Tools for manipulating **git** hooks (execute some commands before **git xx**) |
