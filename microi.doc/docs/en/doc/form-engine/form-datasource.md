...
>* However, after the customer name is modified, the latest customer name needs to be displayed in other associated data. When the customer list modifies the name, the associated data can be updated synchronously through form events.
