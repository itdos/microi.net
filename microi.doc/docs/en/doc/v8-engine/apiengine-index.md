...
| Actual combat project | Link |
| :-- | :-- |
| Send third-party text messages | [CSDN](https://microi.blog.csdn.net/article/details/143990546) |
| Send Aliyun SMS | [CSDN](https://microi.blog.csdn.net/article/details/143990603) |
| Custom Export Excel | [CSDN](https://microi.blog.csdn.net/article/details/143619083) |
| WeChat applet authorizes mobile phone number login | [CSDN](https://microi.blog.csdn.net/article/details/144106817) |
| WeChat v3 Payment JSAPI Order | [CSDN](https://microi.blog.csdn.net/article/details/144156119) |
| WeChat payment callback interface | [CSDN](https://microi.blog.csdn.net/article/details/144168810) |
...
::: details Expand to view the JavaScript code (120 lines)
```js
...
::: details Expand to view JavaScript code (49 lines)
```javascript
//新建一个接口引擎，代码如下：
//动态设置数据源
...
::: details Expand to view JavaScript code (21 lines)
```js
