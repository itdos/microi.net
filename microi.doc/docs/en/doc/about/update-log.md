...
> **Microi is an open-source platform, continuously maintained and updated by the team.**
...
```js
平台开源源码由团队持续维护升级，所有更新日志请见Gitee仓库 https://gitee.com/ITdos/microi.net/commits/master 提交日志
```
:::
