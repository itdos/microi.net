...
> **Support timing execution interface engine or custom development. NET DLL file**

---

## 📌Introduction

The platform supports timing tasks, which can execute interface engines or custom-developed. NET DLL file.
...
## Automatically delete task duplicate result logs
