...
> * It is recommended to use the demo or empty database from the source repository ([GitHub](https://github.com/itdos/microi.net/tree/master/数据库、案例、文档、资料) / [Gitee](https://gitee.com/ITdos/microi.net/tree/master/数据库、案例、文档、资料)), assuming that the new database connection string is: Data Source = 59.110.139.96;Database = microi_demo;User Id = microi_demo;Password = password123456;Port = 1306;Convert Zero Datetime = True;Allow Zero Datetime = True;Charset = utf8mb4;Max Pool Size = 500;Min Pool Size = 5; Lifetime; connection Timeout = 30;Pooling = true;sslmode = None;
