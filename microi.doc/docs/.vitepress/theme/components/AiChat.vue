...
// 预设的AI知识库回复
const knowledgeBase = {
  '是什么': `<strong>Microi吾码</strong> 是一个开源 AI 开发框架，始于2014年（基于Avalon.js），2018年使用 Vue 重构，2025年正式开源。<br/><br/>框架基于 <strong>.NET10 + Vue3 + Element-Plus + Redis</strong>，融合 AI 低代码、微服务与 V8 引擎，提供表单、接口、AI、工作流、3D 等 <strong>20+ 成熟引擎</strong>。在平台能力高度复用的典型业务场景中，可让 AI 开发更省 Token 10 倍+、速度提升 10 倍+，开箱即用、更快交付。`,
