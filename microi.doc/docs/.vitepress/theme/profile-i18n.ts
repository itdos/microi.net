...
const messages = {
  'zh-CN': {
    ...
    overview: '个人中心', createTenant: '创建租户', aiRelay: 'AI 工作台', account: '账号信息',
    ...
    saasTenants: 'SaaS 租户', tenantDesc: '每个租户都是独立低代码数据库与访问入口。默认管理员为 admin，系统会生成高强度随机初始密码，并仅在创建成功后的当前会话展示。',
    ...
    progress: '开通进度', accountLabel: '账号', nameLabel: '姓名', nicknameLabel: '昵称', phoneLabel: '手机号', logout: '退出登录',
    profileEditDesc: '修改你的公开昵称和头像；账号与手机号属于登录凭据，不能在这里修改。', avatarLabel: '账户头像', avatarTip: '支持 JPG、PNG、WebP，最大 5MB；也可以让 AI 为你创作。', generateAvatar: 'AI 生成头像', uploadAvatar: '手动上传', uploadingAvatar: '上传中...', saveProfile: '保存资料', savingProfile: '保存中...', nicknamePlaceholder: '输入你的公开昵称', nicknameInvalid: '昵称需为 1 到 50 个字符。', profileSaved: '账户资料已保存。', profileSaveFailed: '账户资料保存失败。', avatarUploaded: '头像已上传，保存资料后生效。', avatarUploadFailed: '头像上传失败。', avatarTypeError: '仅支持 JPG、PNG 或 WebP 图片。', avatarSizeError: '头像文件不能超过 5MB。',
    generateAvatarTitle: '用 AI 创作你的头像', generateAvatarDesc: '描述人物、气质和背景，MiniMax image-01 会生成 4 张候选图。', closeAvatarGenerator: '关闭 AI 头像生成器', avatarPromptPlaceholder: '例如：一位自信的年轻开发者，短发，微笑，深色科技感背景...', generatingAvatar: '正在生成...', generateCandidates: '生成 4 张候选头像', avatarCandidate: 'AI 头像候选图', avatarGeneratedNotice: 'AI 生成内容可能存在偏差，请确认后使用。', useAvatar: '选用并保存', avatarGenerateFailed: 'AI 头像生成失败，请稍后重试。',
    ...
    unnamedTenant: '未命名租户', enabled: '启用中', disabled: '已停用', accessEntry: '访问入口', defaultAdmin: '默认管理员', changePassword: '随机初始密码仅在本次会话展示，请首次登录后立即修改', initialPasswordHidden: '初始密码已不再展示；如已遗忘，请在后台执行安全重置', copyLink: '复制链接',
    noTenants: '还没有租户', noTenantsDesc: '你可以免费创建第一个 SaaS 数据库，创建完成后立即进入后台使用。',
    licensePersonal: '个人版', licensePersonalTitle: 'Personal（个人版）', licensePersonalDesc: '授权永久有效，含 1 年售后服务；后续可选技术支持 ¥499/年。',
    licenseEnterprise: '企业版', licenseEnterpriseTitle: 'Enterprise（企业版）', licenseEnterpriseDesc: '授权永久有效，含 1 年售后服务；后续可选技术支持 ¥1.5w/年。',
    ...
    starReminderTitle: '创建租户前，诚邀您支持吾码开源项目', starReminderDescription: '吾码是一款持续维护的开源低代码平台。每次创建租户前，请先使用同一个 Gitee 账号点亮 Star，再授权系统读取最基本的公开账号信息并校验当前 Star 状态。', starReminderThanks: '您的每一份支持都很重要，谢谢！', starReminderOpenGitee: '前往 Gitee Star', starReminderContinue: '授权 Gitee 并校验', starReminderCancel: '稍后再创建', starReminderClose: '关闭支持开源提示', starPolicyTitle: '温馨提示', starPolicyDescription: '每次创建租户时，系统都会重新确认您对 Microi吾码 Gitee 开源项目的 Star 支持。若之后取消 Star，系统可能会自动停止对应 SaaS 租户库的访问。感谢您的理解与支持，谢谢！',
    giteeOAuthStarting: '正在前往 Gitee 授权...', giteeStarChecking: '正在校验 Gitee Star...', giteeStarVerified: 'Gitee Star 校验通过，正在创建租户。', giteeStarNotVerified: '当前授权的 Gitee 账号 {account} 尚未确认已 Star {repository}。请确认点亮 Star 与授权使用的是同一账号后重试。', giteeAccountUnidentified: '本次 Gitee 授权未能识别账号，请重新授权；若仍失败，请检查 Gitee 授权是否完成。', giteeOAuthStartFailed: '暂时无法发起 Gitee 授权，请稍后重试。', giteeOAuthNetworkFailed: '连接 Gitee 授权服务失败，请检查网络后重试。', giteeStarStatusFailed: 'Gitee 暂时无法确认当前 Star 状态，请稍后重新授权校验。', giteeDraftExpired: '创建信息已失效，请重新填写后再授权校验。', giteeUserMissing: '当前登录用户信息不完整，请重新登录后再试。'
  },
  'en-US': {
    ...
    overview: 'Overview', createTenant: 'Create tenant', aiRelay: 'AI Workspace', account: 'Account',
    ...
    saasTenants: 'SaaS tenants', tenantDesc: 'Each tenant has an independent low-code database and URL. The default admin is admin. A strong random initial password is shown only in the session that created the tenant.',
    ...
    accountLabel: 'Account', nameLabel: 'Name', nicknameLabel: 'Display name', phoneLabel: 'Phone', logout: 'Sign out',
    profileEditDesc: 'Update your public name and avatar. Your account and phone are sign-in credentials and cannot be changed here.', avatarLabel: 'Profile avatar', avatarTip: 'JPG, PNG, or WebP up to 5 MB, or create one with AI.', generateAvatar: 'Generate with AI', uploadAvatar: 'Upload image', uploadingAvatar: 'Uploading...', saveProfile: 'Save profile', savingProfile: 'Saving...', nicknamePlaceholder: 'Enter your public display name', nicknameInvalid: 'Display name must be 1–50 characters.', profileSaved: 'Profile saved.', profileSaveFailed: 'Unable to save your profile.', avatarUploaded: 'Avatar uploaded. Save your profile to apply it.', avatarUploadFailed: 'Avatar upload failed.', avatarTypeError: 'Only JPG, PNG, and WebP images are supported.', avatarSizeError: 'Avatar image must be 5 MB or smaller.',
    generateAvatarTitle: 'Create your avatar with AI', generateAvatarDesc: 'Describe the person, mood, and background. MiniMax image-01 will create four options.', closeAvatarGenerator: 'Close AI avatar generator', avatarPromptPlaceholder: 'e.g. A confident young developer, short hair, smiling, dark futuristic background...', generatingAvatar: 'Generating...', generateCandidates: 'Generate 4 options', avatarCandidate: 'AI avatar candidate', avatarGeneratedNotice: 'AI output may be imperfect. Review it before use.', useAvatar: 'Use and save', avatarGenerateFailed: 'AI avatar generation failed. Please try again.',
    aiTitle: 'Microi.AI Relay', aiDesc: 'This ApiKey is written into the Microi.AI Relay configuration of new SaaS tenants. Keep it private.',
    ...
    unnamedTenant: 'Unnamed tenant', enabled: 'Enabled', disabled: 'Disabled', accessEntry: 'Access URL', defaultAdmin: 'Default admin', changePassword: 'The random initial password is shown only in this session. Change it after first sign-in.', initialPasswordHidden: 'The initial password is no longer displayed. Use the secure reset flow if needed.', copyLink: 'Copy link',
    noTenants: 'No tenants yet', noTenantsDesc: 'Create your first SaaS database for free and use it immediately.',
    licensePersonal: 'Personal', licensePersonalTitle: 'Personal', licensePersonalDesc: 'Perpetual license with one year of support; optional technical support is ¥499/year.', licenseEnterprise: 'Enterprise', licenseEnterpriseTitle: 'Enterprise', licenseEnterpriseDesc: 'Perpetual license with one year of support; optional technical support is ¥15,000/year.', licenseOpen: 'Open Source', licenseOpenDesc: 'This account uses the open-source edition and can upgrade to Personal or Enterprise.',
