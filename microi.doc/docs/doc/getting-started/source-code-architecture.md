...
| `microi.apps/` | 官方 AI 应用、微服务或可安装应用的源码工作区 | [微服务](/doc/system-engine/micro-app) |
...
- `Microi-V8-Engine/` 通常由插件或 CLI 在本机生成，按服务器与 OsClient 保存接口引擎、事件、数据库快照和同步基线。它可能包含本机 Token 或租户代码，不是应整体提交到公开仓库的产品源码目录。
