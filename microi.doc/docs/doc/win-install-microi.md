...
>* 安装完成后访问：http://localhost:27017 出现以下界面表示安装成功，Windows服务中也会有MongoDB服务正在运行。
...
```
>* f）访问http://localhost:9000，默认帐号均为minioadmin
...
>* 部署完成后，访问是否正常（假设端口为1051）：http://localhost:1051/
