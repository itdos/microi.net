ソースローカル実行-バックエンドソースコードと. NET環境* 使用git工具从开源地址拉取最新代码：[https://gitee.com/ITdos/microi.net](https://gitee.com/ITdos/microi.net)
* 下载并安装.NET 9 SDK：[https://dotnet.microsoft.com/zh-cn/download](https://dotnet.microsoft.com/zh-cn/download)

必須パラメータの設定* 要使项目跑起来，至少需要【数据库 + Redis】两个环境，缺一不可

「Visual Studio Code」を使用してソリューションを開く (Mac推奨)* 下载并安装vs code：[https://code.visualstudio.com/](https://code.visualstudio.com/)
...
【Visual Studio 2022】を使用してソリューションを開く (Windows推奨)* 下载并安装vs2022：[https://visualstudio.microsoft.com/zh-hans/](https://visualstudio.microsoft.com/zh-hans/)
...
環境配置に関する注意事項* 若没有MongoDB环境，则无法使用系统日志功能
