# フローエンジン、ワークフローエンジン
## 前書き
> ** 第一版 **:博主は2008年に仕事をした時、前同僚がマイクロソフトWWFに基づいて開発したワークフローエンジンを引き継ぎ、十数人の国有企業、事業部門oaシステム、ERPシステムなどを開発した
...
> ** 第3版 **: ブロガーは2014年にマイクロソフトの最新WWFを使って第3版ワークフローエンジンを独自に開発し、AvalonJs UEditorと協力して低コードプラットフォームを開発することを要求した数十社の国有企業、事業単位、計量単位を応用する
