ソースコードローカル実行-フロントエンドソースコードと開発ツールのダウンロード* 使用git工具从开源地址拉取最新代码：[https://gitee.com/ITdos/microi.net](https://gitee.com/ITdos/microi.net)
* 下载并安装vs code：[https://code.visualstudio.com/](https://code.visualstudio.com/)

PC側vue2を実行する従来のインタフェースソースコード* 在欢迎页打开Microi吾码开源版【/microi.vue2.pc/】文件夹
...
PC側vue3を実行してwebos osインタフェース (コンパイル版) を模倣する* 进入【/microi.vue3.os.build/】文件夹
* 执行命令#http-server即可跑起来

PC側vue3を実行してwebos osインタフェースのソースコード (個人版) を模倣する* 在欢迎页打开Microi吾码个人版【/microi.vue3.os/】文件夹
...
モバイル端末vue3 uniappソースコードを実行する (図鳥UIに基づく)* 进入【/microi.vue3.tuniao/】文件夹
