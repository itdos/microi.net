    ...
    internal class deserializer
    {
        ...
        internal object ParseDictionary(Dictionary<string, object> d, Dictionary<string, object> globaltypes, Type type, object input)
        {
            ...
            foreach (var kv in d)
            {
                ...
                string name = n;//by iTdos.com 2017-01-10
                if (name == "$map")
                {
                ...
                if (pi.CanWrite)
                {
                    ...
                    if (v != null)// && !v.ToString().DosIsNullOrWhiteSpace()
                    {
                        object oset = null;
                        ...
                        switch (pi.Type)
                        {
                            ...
                            case myPropInfoType.Int: oset = (int)decimal.Parse(v.ToString()); break;//2017-02-13 by iTdos.com
                            //case myPropInfoType.Long: oset = (long)v; break;
                            case myPropInfoType.Long: oset = (long)decimal.Parse(v.ToString()); break;//2017-02-13 by iTdos.com
                            ...
                            case myPropInfoType.Bool:
                                ...
                                {
                                    oset = v.ToString().ToLower() == "true" || v.ToString() == "1";
                                }
                                else
                                {
                                    oset = (bool)v;
