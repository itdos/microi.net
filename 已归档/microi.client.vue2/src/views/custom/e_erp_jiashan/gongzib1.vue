...
export default {
    ...
    data() {
        return {
            ...
            ganghao: "",
            columns: [
                { prop: "xingming", label: "姓名", width: "120" },
                { prop: "gonghao", label: "工号", width: "120" },
                { prop: "kuanhao", label: "款号", width: "120" },
                { prop: "kuanming", label: "款名", width: "150" },
                { prop: "chuangci", label: "床次", width: "100" },
                { prop: "ganghao", label: "缸号", width: "100" },
                { prop: "chima", label: "尺码", width: "100" },
                { prop: "yanse", label: "颜色", width: "100" },
                { prop: "bagNum", label: "包数", width: "100" },
                { prop: "gongxu", label: "工序", width: "120" },
                { prop: "gongjia", label: "工价", width: "150" },
                { prop: "shuliang", label: "数量", width: "120" }
            ]
        };
    },
    methods: {
