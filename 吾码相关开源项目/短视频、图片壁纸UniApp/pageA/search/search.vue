<template>
  <view class="tn-safe-area-inset-bottom">
    ...
    <view 
		v-if="false"
		class="" style="margin-top: 160rpx;" :style="{paddingTop: vuex_custom_bar_height + 'px'}">
    ...
    <view 
	v-if="false"
	class="tn-flex tn-flex-row-between tn-padding-top-xl tn-margin tn-padding-bottom">
      <view class="justify-content-item tn-text-bold">
