    ...
    <div>
        ...
        <div>
            <el-table v-loading="tableLoading" stripe border :data="tableList">
                ...
                <el-table-column prop="YubaoFRQ" label="预报废日期" show-overflow-tooltip />
                <el-table-column prop="YubaoFNX" label="预报废年限" show-overflow-tooltip />
...
export default {
    ...
    methods: {
        async onExportExcel() {
            ...
            const url = `${this.$apiHost}/export/export_yubaofei_zichan_report?` + qs.stringify(payload);
        ...
        async getTableList(init = false) {
            ...
            this.DiyCommon.Get(`${self.$apiHost}/zichan/get_yubaofei_zichan`, payload, function (result) {
                if (result.Code == 1) {
