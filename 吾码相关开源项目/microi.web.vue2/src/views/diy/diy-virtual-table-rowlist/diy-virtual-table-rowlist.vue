                                            ...
                                            <template slot-scope="scope">
                                                ...
                                                <template v-else-if="NeedDiyTemplateFieldLst.indexOf(field.Component) > -1">
                                                    ...
                                                    <template v-if="field.Component == 'DevComponent'">
                                                        <template v-if="!DiyCommon.IsNull(field.Config.DevComponentName)">
                                                            <component
                                                                v-if="
                                                                    !DiyCommon.IsNull(DevComponents[field.Config.DevComponentName]) &&
                                                    ...
                                                    <template v-else-if="field.Component == 'ImgUpload'">
                                                        <template>
                                                            <i
                                                                ...
                                                                :style="{ color: !DiyCommon.IsNull(scope.row[DiyCommon.IsNull(field.AsName) ? field.Name : field.AsName]) ? '#ff6c04' : '#ccc' }"
                                                            ></i>
                                                        </template>
                                                    </template>
                                                </template>
                                                ...
                                                <template v-else>
                                                    ...
                                                    <template v-else-if="field.Component == 'Switch'">
                                                        <el-switch
                                                            :value="
                                                                scope.row[DiyCommon.IsNull(field.AsName) ? field.Name : field.AsName] == true ||
                                                                scope.row[DiyCommon.IsNull(field.AsName) ? field.Name : field.AsName] == 1
                                                                    ? true
                                                                    : false
                                                            "
                                                            :disabled="true"
