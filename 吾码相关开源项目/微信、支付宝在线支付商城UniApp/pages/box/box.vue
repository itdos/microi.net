  ...
  <view class="template-box">
    ...
    <view class="" style="position: fixed;">
      ...
      <view class="row">
        ...
        <view class="item original">POP</view>
        <view class="item original">BLIND</view>
        <view class="item original">BOX</view>
        <view class="item original">TUNIAO</view>
        <view class="item original">XIONG</view>

        <view class="item shadow">POP</view>
        <view class="item shadow">BLIND</view>
        <view class="item shadow">BOX</view>
        <view class="item shadow">TUNIAO</view>
        <view class="item shadow">XIONG</view>
      </view>
        ...
        <view class="card-container">
          <view class="card rotated">
            ...
            <view class="card-contents card-back">
              ...
              <view class="card-depth">
                <view class="card-img"
                  style="background-image:url('/static/img/2222.png');width: 400rpx;height: 400rpx;background-size: cover;overflow: hidden;">
                </view>
                <view class="tn-margin-top tn-text-lg">图鸟·不许凶我</view>
              </view>
                  ...
                  <view class="cube__container">
                    <view class="cube__container__body">
                      <view class="cube__container__body__item cube__container__body__item--front"
                        style="background-image: url(/static/img/2222.png);">
                      </view>
