<template>
    <!--自动编号-->
    <el-input v-model="ModelValue" :disabled="true" :placeholder="field.Config.AutoNumberFixed + DiyCommon.Add0(1, field.Config.AutoNumberLength)" @focus="SelectField(field)">
...
export default {
    ...
    mounted() {
        var self = this;
        self.ModelValue = self.FormDiyTableModel[self.field.Name] || 0;
        self.LastModelValue = self.FormDiyTableModel[self.field.Name] || 0;
