 ...
 * TSC/TSPL 标签打印机指令构建器
 * 
 * 用于佳博等支持TSPL指令集的标签打印机。
 * 从 microi.uniapp.uni-ui/utils/ble/tsc.js 移植，适配Web端使用。
 * 
 * 用法示例：
 *   var command = tsc.jpPrinter.createNew();
 *   command.setSize(75, 65);       // 设置标签尺寸（宽×高 mm）
 *   command.setGap(2);             // 设置标签间距
 *   command.setCls();              // 清除缓存
 *   command.setText(10, 10, "TSS24.BF2", 1, 1, "Hello");
 *   command.setQR(100, 100, "L", 5, "A", "https://microi.net");
 *   command.setPagePrint();        // 打印
