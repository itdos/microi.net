...
import DiyChat from "@/views/chat/index";
import DiyFlowDesign from "@/views/workflow/flow-design";
import DiyDesign from "@/views/diy/diy-design";
import WFWorkHandler from "@/views/workflow/wf-work-handler";
import WFHistory from "@/views/workflow/component/workflow-history";
import WFDesignPreview from "@/views/workflow/component/designer-preview";
...
import DiyMyWork from "@/views/workflow/my-work";
import DiyFlowIndex from "@/views/workflow/index";
import DiyDocument from "@/views/diy/diy-document";
import DiyDesignList from "@/views/diy/diy-table";
import DiyFormWF from "@/views/workflow/diy-form-wf";
import CustomFormWF from "@/views/workflow/custom-form-wf";
...
import DiyOpenTable from '@/views/diy/diy-field-component/diy-opentable.vue';
import DiyMap from '@/views/diy/diy-field-component/diy-map.vue';
import DiyQrcode from '@/views/diy/diy-field-component/diy-qrcode.vue';
import DiyDevComponent from '@/views/diy/diy-field-component/diy-devcomponent.vue';
import DiyTableChild from '@/views/diy/diy-field-component/diy-tablechild.vue';
import DiyJoinTable from '@/views/diy/diy-field-component/diy-jointable.vue';
import DiyJoinForm from '@/views/diy/diy-field-component/diy-joinform.vue';
import DiyV8TmpEngine from '@/views/diy/diy-field-component/diy-v8tmpengine.vue';
import DiyCustomDialog from "@/views/diy/diy-custom-dialog";
import DiySearch from "@/views/diy/diy-search";
import Fontawesome from "@/views/diy/diy-field-component/dos.fontawesome/Fontawesome.vue";
import DiyCodeEditor from "@/views/diy/diy-field-component/diy-code-editor.vue";

// Vue 3: 使用 defineAsyncComponent 包装动态 import
var nodeColConfig = defineAsyncComponent(() => import("@/views/workflow/component/node-col-config.vue"));
