...
-->
  <div id="diviTdosSystemManage" class="pluginPage">
    ...
    <div class="row microi-desktop-tab">
      <div
        :class="
          'microi-desktop-tab-right col-md-10 col-sm-10 col-xs-10 transition3 ' +
          (LeftMenuHide ? 'width100' : '')
        "
        style=""
      >
        <div class="list-group microi-desktop-tab-content">
          ...
          >
            <div class="row">
              ...
              <div
                class="col-md-6"
                v-if="!DiyCommon.IsNull(CurrentSysBaseDataModel.Id)"
              >
                <el-form
                ...
                >
                  ...
                  <el-form-item>
                    <el-button type="primary" @click.stop="UptSysBaseData">{{
                      $t("Msg.Save")
                    }}</el-button>
                  </el-form-item>
                </el-form>
...
export default {
  ...
  methods: {
    ...
    GetSysBaseData() {
      ...
      // self.LoadingCount++;
      self.DiyCommon.Post(
        self.DiyApi.GetSysBaseDataStep(),
        {},
        function (result) {
