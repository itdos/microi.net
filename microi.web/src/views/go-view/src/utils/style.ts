...
import { PickCreateComponentType } from '@goview/packages/index.d'
import { EditCanvasConfigType } from '@goview/store/modules/chartEditStore/chartEditStore.d'
import { chartColors, chartColorsSearch, CustomColorsType } from '@goview/settings/chartThemes/index'
