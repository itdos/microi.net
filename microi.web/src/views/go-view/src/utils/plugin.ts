...
import { DialogEnum } from '@goview/enums/pluginEnum'
import { dialogIconSize } from '@goview/settings/designSetting'
import { maskClosable } from '@goview/settings/designSetting'
