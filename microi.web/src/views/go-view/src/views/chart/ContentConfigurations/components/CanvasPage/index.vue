      ...
      >
        <n-upload-dragger>
          ...
          <div class="upload-img" v-show="!canvasConfig.backgroundImage">
            <img src="@goview/assets/images/canvas/noImage.png" />
...
import { backgroundImageSize } from '@goview/settings/designSetting'
import { swatchesColors } from '@goview/settings/chartThemes/index'
import { FileTypeEnum } from '@goview/enums/fileTypeEnum'
import { useChartEditStore } from '@goview/store/modules/chartEditStore/chartEditStore'
import { EditCanvasConfigEnum } from '@goview/store/modules/chartEditStore/chartEditStore.d'
import { StylesSetting } from '@goview/components/Pages/ChartItemSetting'
import { UploadCustomRequestOptions } from 'naive-ui'
import { fileToUrl, loadAsyncComponent } from '@goview/utils'
import { PreviewScaleEnum } from '@goview/enums/styleEnum'
