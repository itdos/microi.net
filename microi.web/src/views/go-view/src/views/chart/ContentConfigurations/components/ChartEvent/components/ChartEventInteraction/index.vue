...
import { SettingItemBox, SettingItem, CollapseItem } from '@goview/components/Pages/ChartItemSetting'
import { CreateComponentType, CreateComponentGroupType, ChartFrameEnum } from '@goview/packages/index.d'
import { RequestParamsTypeEnum, RequestDataTypeEnum } from '@goview/enums/httpEnum'
import { InteractEventOn, COMPONENT_INTERACT_EVENT_KET } from '@goview/enums/eventEnum'
import { icon } from '@goview/plugins'
import noData from '@goview/assets/images/canvas/noData.png'
import { goDialog } from '@goview/utils'
