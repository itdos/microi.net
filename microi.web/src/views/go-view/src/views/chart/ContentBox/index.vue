...
@include go(content-box) {
  ...
  .content-height-show-top-bottom {
    height: calc(100vh - var(--goview-top-offset, 0px) - #{$--header-height} - #{$topOrBottomHeight});
  }

  .content-height-show-both {
    height: calc(100vh - var(--goview-top-offset, 0px) - #{$--header-height} - #{$topOrBottomHeight} - #{$topOrBottomHeight});
  }
}
</style>
