...
import { useSync } from '@goview/views/chart/hooks/useSync.hook'
import { ChartEnum } from '@goview/enums/pageEnum'
import { SavePageEnum } from '@goview/enums/editPageEnum'
import { editToJsonInterval } from '@goview/settings/designSetting'
