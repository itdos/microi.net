...
import { ChartLayoutStoreEnum, LayerModeEnum } from '@goview/store/modules/chartLayoutStore/chartLayoutStore.d'
...
import { MenuEnum, MouseEventButton, WinKeyboard, MacKeyboard } from '@goview/enums/editPageEnum'
