...
import { AppThemeColorType } from '@goview/store/modules/designStore/designStore.d'
import { icon } from '@goview/plugins'
import themeColorLogo from '@goview/assets/images/exception/theme-color.png'
import { loadAsyncComponent } from '@goview/utils'
import { useScroll } from '@vueuse/core'
import designColor from '@goview/settings/designColor.json'
    ...
    .content-right {
      ...
      .color-name-detail {
        ...
        .select-color {
          ...
          height: 20px;
          border-radius: 3px;
          background-image: url("@goview/assets/images/exception/texture.png");
        }
        .color-name {
          font-family: serif;
          font-size: 80px;
