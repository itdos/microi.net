...
import { defaultTheme, globalThemeJson } from '@goview/settings/chartThemes/index'
import { requestInterval, previewScaleType, requestIntervalUnit } from '@goview/settings/designSetting'
// 记录记录
...
} from '@goview/store/modules/chartHistoryStore/chartHistoryStore.d'
import { MenuEnum } from '@goview/enums/editPageEnum'
import { getUUID, loadingStart, loadingFinish, loadingError, isString, isArray } from '@goview/utils'
import {
  ChartEditStoreEnum,
  ChartEditStorage,
  ChartEditStoreType,
