        ...
        <div class="func-list">
          <div>
            <el-row class="tac">
              ...
              >
                <el-button type="primary" class="changeBtn1" @click="changeLeft"
                  >最大化/还原</el-button
                >
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in fuzhi_menu_data"
                  :key="'fuzhi-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      >
                        <el-select v-model="form.sql" placeholder="请选择">
                          <el-option
                            :label="key"
                            :value="key"
                            v-for="(value, key, index) in fields[0]"
                            :key="index"
                          ></el-option>
                        </el-select>
                      </el-form-item>
                      ...
                      <el-form-item style="margin-top: 50px">
                        <el-button
                          type="primary"
                          @click="onSubmit(item.name, item.index)"
                          >生成代码
                        </el-button>
                        <el-button @click="resetForm(item.name)"
                          >重置</el-button
                        >
                      ...
                      <el-form-item>
                        <el-col style="font-size: 12px; color: #a5a5a5">{{
                          tips
                        }}</el-col>
                      </el-form-item>
                      <el-form-item label="代码结果">
                        ...
                        <div>
                          注：可以直接在框里写代码，但请务必按照如下格式添加，否则该代码不会收录进汇总中！！！
                        </div>
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in action_menu_data"
                  :key="'action-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in sql_menu_data"
                  :key="'sql-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <el-option
                            :label="value.Label"
                            :value="value.Name"
                            v-for="(value, index) in ziduanList"
                            :key="index"
                          ></el-option>
                        </el-select>
                      </el-form-item>
                      ...
                      <el-form-item label="选择条件">
                        ...
                        <el-col :span="4">
                          <el-button type="primary" @click="Inset"
                            >添加</el-button
                          >
                        </el-col>
                      </el-form-item>
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in func_menu_data"
                  :key="'func-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      <el-form-item
                        label="页码"
                        prop="page"
                        v-if="activeIndex == '4-3'"
                      >
                        <el-input
                          type="number"
                          v-model.number="form.page"
                          placeholder="请输入数字，可为空"
                        ></el-input>
                      </el-form-item>
                      <el-form-item
                        label="url"
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in child_table_data"
                  :key="'child-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      >
                        ...
                        <el-col :span="8" style="text-align: center">
                          <el-button type="primary" @click="addSearch('child')"
                            >添加</el-button
                          >
                        </el-col>
                      </el-form-item>
                      ...
                      >
                        ...
                        <el-col
                          v-for="(item, index) in valueSearch"
                          :key="index"
                        >
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in get_post_data"
                  :key="'ajax-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      >
                        <el-input
                          ...
                          :rows="3"
                          v-model="form.params"
                          placeholder="请输入所需参数，json格式，请记得加{}"
                        ></el-input>
                      </el-form-item>
                      <el-form-item
                        label="参数"
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in other_menu_data"
                  :key="'other-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      >
                        ...
                        <el-col :span="8" style="text-align: center">
                          <el-button type="primary" @click="addSearch('other')"
                            >添加</el-button
                          >
                        </el-col>
                      </el-form-item>
                      ...
                      <el-form-item
                        label="参数"
                        prop="value"
                        v-if="activeIndex == '7-3'"
                      >
                        <el-input
                          type="textarea"
                          :rows="3"
                          v-model="form.value"
                          placeholder="请输入所需参数，json格式"
                        ></el-input>
                      </el-form-item>
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in visit_menu_data"
                  :key="'visit-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                ...
                <div
                  v-show="activeIndex == item.index"
                  v-for="(item, index) in work_flow_data"
                  :key="'work-' + index"
                >
                  <div class="fieldset">
                    <h3>{{ item.title }}</h3>
                    ...
                    >
                      ...
                      <el-form-item label="流程图" prop="name">
                        ...
                        >
                          <el-option
                            :label="item.FlowName"
                            :value="item.Id"
                            v-for="(item, index) in liuchengList"
                            :key="index"
                          ></el-option>
                        </el-select>
                      </el-form-item>
                      <el-form-item label="线内容" prop="okText">
                        <el-input
                          type="text"
                          v-model="form.okText"
                          placeholder="请输入LineValue（只有一条线时可不传）"
                        ></el-input>
                      </el-form-item>
              ...
              >
                <el-button type="primary" class="changeBtn" @click="changeRight"
                  >最大化/还原</el-button
                >
...
export default {
  ...
  methods: {
    ...
    SetCodeEditorHeight() {
      var self = this;
      self.CodeEditorHeight =
        $(".v8design-dialog:visible .tac.el-row").height() - 50 + "px";
    ...
    goFunc(item) {
      ...
      if (item.index) {
        if (
          item.index.includes("2-") ||
          item.index.includes("4-1") ||
          item.index.includes("4-7") ||
          item.index.includes("4-8") ||
          item.index.includes("5-2") ||
          item.index.includes("8-8")
        ) {
        ...
        if (valid) {
          ...
          if (type.includes("1-")) {
            ...
            if (formlist.sql) {
              ...
              var txt =
                code + "('" + formlist.msg + "','" + formlist.value + "') \n\n";
            } else {
              var txt =
                code +
                "('" +
          ...
          if (type.includes("2-")) {
            ...
            var txt =
              "// 当前表单选择 " +
              JSON.parse(formlist.type)[1] +
              " 时 \nif (" +
              code +
              " == '" +
              JSON.parse(formlist.type)[0] +
              "') { \n  // your code... \n \n \n} \n";
          }
          ...
          if (type.includes("4-")) {
            ...
            if (type == "4-1") {
              var txt =
                code + "('" + formlist.msg + "'," + formlist.type + ")\n\n";
            }
            if (type == "4-3") {
              if (formlist.page) {
          ...
          if (type.includes("8-")) {
            ...
            if (type == "8-3") {
              var txt =
                code + "." + formlist.name + "." + formlist.attr + "\n\n";
            } else if (type == "8-7") {
              var txt = code + "\n\n";
            } else if (type == "8-8") {
              var txt =
      ...
      if (this.form.attr && this.form.title) {
        if (this.form.value.includes(this.form.attr)) {
          ...
          if (this.valueSearch.length == 1) {
            this.form.value =
              "{" +
              this.valueSearch[0].key +
              ":'" +
              this.valueSearch[0].value +
              "'}";
          } else {
            this.form.value = "";
