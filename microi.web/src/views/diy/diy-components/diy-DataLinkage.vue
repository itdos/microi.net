<template>
    <div>
        ...
        <el-dialog :visible.sync="show" width="60%" title="数据联动设置"
        :modal-append-to-body="false" append-to-body>
            <div class="showhide">
                ...
                <el-row>
                    ...
                    <el-col :span="2" style="margin:0 40px;font-size:16px;line-height: 32px;">
                        联动显示
                    </el-col>
                    <el-col :span="10">
...
export default {
    ...
    methods:{
        onSubmit(){
            ...
            txt = 'V8.Post(\''+this.https+'/api/DiyTable/GetDiyTableRow\',{\n TableId:\''+this.table+'\',\n'+
                ' _SearchEqual:{\n  '+dengyu+
                ' }\n'+'},function(res){\n if(res.Code==1){\n  V8.Form.'+this.chooseData.Name+' = res.Data[0].'+
                this.linkShow+'\n }\n})\n'
