<template>
    <div>
        ...
        <!--            <template #dropdown><el-dropdown-menu class="form-submit-btns">-->
        <!--              <el-dropdown-item-->
        ...
        <!--              >-->
        <!--              <el-dropdown-item v-if="ShowFormBottomBtns.SaveView" :icon="$getIcon(BtnLoading ? 'loading' : 's-help')" :disabled="BtnLoading" @click="SaveDiyTableCommon(false, 'View')">{{-->
        ...
        <!--            </template>-->
        <!--          </template>-->
        <!--          &lt;!&ndash; liucheng2025-7-25去掉弹窗的删除按钮，表单的删除情况少，尽量在列表删不要在详情页删，详情页这里位置重要按钮了不太好。 &ndash;&gt;-->
        <!--          &lt;!&ndash; <el-button-->
        ...
        <!--      &lt;!&ndash; <template #footer class="dialog-footer">-->
