<template>
  <div>
    ...
    >
      ...
      <a
        class="mr-2"
        :href="FormDiyTableModel[field.Name + '_' + field.Name + '_RealPath']"
        target="_blank"
      >
      ...
      <el-table :data="GetFileUpladFils(field)" :show-header="false">
        ...
        <el-table-column width="35">
          <template slot-scope="scope">
            <i
              :class="
                scope.row.State == 0 ? 'el-icon-loading' : 'el-icon-document'
              "
            ></i>
          </template>
        </el-table-column>
        <el-table-column>
          <template slot-scope="scope">
            ...
            <a
              class="fileupload-a"
              :href="
                FormDiyTableModel[field.Name + '_' + scope.row.Id + '_RealPath']
              "
              target="_blank"
            >
              {{ scope.row.Name }}
