    ...
    <el-form
        ...
        <el-form-item
            ...
            <el-button
                ...
                @click="SaveAllDiyField">{{ $t('Msg.SaveAll') }}</el-button>
            <el-button
                :loading="SaveAllDiyFieldLoding"
                icon="el-icon-check"
                type="primary"
            ...
            <el-dialog
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button
                        type="primary"
                        size="mini"
                        icon="el-icon-close">{{ $t('Msg.Close') }}({{ $t('Msg.AutoSave') }})</el-button>
                </span>
            </el-dialog>
        </el-main>
        <el-aside
                ...
                <el-main class="right-main">
                    <el-tabs
                            ...
                            <div
                                ...
                                <el-form
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-94">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.Cascader.Filterable"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <el-form-item
                                    ...
                                    <el-form-item
                                        ...
                                        <el-input
                                            v-model="CurrentDiyFieldModel.Config.SelectTree.Children"
                                            type="text" />
                                    </el-form-item>
                                    <el-form-item
                                        v-if="CurrentDiyFieldModel.Component == 'SelectTree'"
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-83">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.SelectTree.Filterable"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <el-form-item
                                        ...
                                        key="design-82">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.SelectTree.Multiple"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    ...
                                    <el-form-item
                                        ...
                                        <el-input
                                            v-model="CurrentDiyFieldModel.Config.SelectTree.Disabled"
                                            type="text" />
                                    </el-form-item>
                                    <el-form-item
                                        v-if="CurrentDiyFieldModel.Component == 'SelectTree'"
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-79">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.Department.Multiple"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <el-form-item
                                        ...
                                        key="design-78">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.Department.Filterable"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <el-form-item
                                        ...
                                        key="design-77">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.Department.EmitPath"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    ...
                                    <el-form-item
                                        ...
                                        size="mini"
                                        key="design-74">
                                        <i :class="DiyCommon.IsNull(CurrentDiyFieldModel.Config.Button.Icon)
                            ? 'far fa-smile-wink hand' : 'hand ' + CurrentDiyFieldModel.Config.Button.Icon" @click="$refs.refButtonIcon.show()" />
                                        <Fontawesome
                                            ref="refButtonIcon"
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-64">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.TableChild.DisablePagination"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <!-- <el-form-item
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-59">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.OpenTable.MultipleSelect"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    <el-form-item
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-52">
                                        <el-switch
                                            v-model="CurrentDiyFieldModel.Config.FileUpload.Multiple"
                                            active-color="#ff6c04"
                                            inactive-color="#ccc" />
                                    </el-form-item>
                                    ...
                                    <el-form-item
                                        ...
                                        key="design-51">
                                        <el-input-number
                                            v-model="CurrentDiyFieldModel.Config.FileUpload.MaxCount"
                                            :min="1"
                                            label="" />
                                    </el-form-item>
                                    <el-form-item
                        ...
                        "
                                        ...
                                        <i :class="DiyCommon.IsNull(CurrentDiyFieldModel.Config.TextIcon)
                            ? 'far fa-smile-wink hand' : 'hand ' + CurrentDiyFieldModel.Config.TextIcon" @click="$refs.fasTextIcon.show()" />
                                        <Fontawesome
                                            ref="fasTextIcon"
                        ...
                        "
                                        ...
                                        key="design-24">
                                        <el-input-number
                                            v-model="CurrentDiyFieldModel.Config.Textarea.DefaultRows"
                                            :min="1"
                                            label="" />
                                    </el-form-item>
                        ...
                        "
                                        ...
                                        key="design-20">
                                        <el-input-number
                                            v-model="CurrentDiyFieldModel.Config.NumberTextPrecision"
                                            :min="0"
                                            :max="6"
                                            label="" />
                                    </el-form-item>
                                        ...
                                        <div class="form-item-label-slot" slot="label">
                                            ...
                                            trigger="hover">
                                                <div>
                                                    注意：
                                                    <br>
                                                    当Sql数据源数据量较大时、或是持续增长的数据，需要开启远程搜索，以提高加载速度，并且需要在sql数据源中配置Keyword参数、limit前多少条。如：select Id,Name from Table where Name like '%$Keyword$%' limit 0,10
                                                </div>
                                                <i slot="reference" class="fas fa-info-circle mr-1" />
                                            </el-popover>
                                            远程搜索
                        ...
                        "
                                        ...
                                        <el-button
                                            ...
                                            icon="el-icon-delete"
                                            size="mini"
                                            @click="ClearCurrentDiyFieldModelData">清空</el-button>
                                    </el-form-item>
                                        ...
                                        <div class="clear marginTop10">
                                            <el-form
                                                ...
                                                <el-form-item label="">
                                                    ...
                                                    <i :class="DiyCommon.IsNull(CurrentDiyTableTabModel.Icon)
                                                        ? 'far fa-smile-wink hand' : 'hand ' + CurrentDiyTableTabModel.Icon" @click="$refs.fasCDTTMIcon.show()" />
                                                    <Fontawesome
                                                        ref="fasCDTTMIcon"
                                                ...
                                                <el-form-item>
                                                    <el-button
                                                        ...
                                                        icon="el-icon-plus"
                                                        type="text"
                                                        @click="AddDiyTableTab">{{ $t('Msg.Add') }}</el-button>
                                                </el-form-item>
                                            </el-form>
                                        </div>
                                    </el-form-item>
...
export default {
    ...
    methods: {
        RecoverDiyField(){
            var self = this;
            self.DiyCommon.Post('/api/diyfield/RecoverDiyField', {
        ...
        RepairField(){
            ...
            if(self.CurrentErrorFieldModel.ErrorType == 'DbField'){
                self.DiyCommon.Post('/api/diyfield/addDiyField', {
            ...
            //数据库中没有的字段，但DiyField中有
                ...
                self.DiyCommon.Post('/api/diyfield/addDbField', {
                    TableId:self.TableId,
                    Name : self.CurrentErrorFieldModel.Name,
                    Type : self.CurrentErrorFieldModel.Type
                }, function(result){
        ...
        GetDeletedDiyField(){
            var self = this;
            self.DiyCommon.Post('/api/diyfield/getDeletedDiyField', {
                TableId : self.TableId
            }, function(result){
                if(self.DiyCommon.Result(result)){
        ...
        GetExceptionFieldList(){
            var self = this;
            self.DiyCommon.Post('/api/diyfield/getExceptionFieldList', {
                TableId : self.TableId
            }, function(result){
                if(result.Code == 1){
        ...
        GetSysRole() {
            var self = this
            self.DiyCommon.Post(self.DiyApi.GetSysRole(), {}, function (
                result
            ) {
                if (self.DiyCommon.Result(result)) {
        ...
        SaveAllDiyField() {
            ...
            try {
                ...
                if (fieldList.length > 0) {
                    ...
                    self.DiyCommon.Post(self.DiyApi.UptDiyFieldList, {
                        // OsClient: self.OsClient,
        ...
        UptDiyField() {
            ...
            try {
                ...
                param.OsClient = '';
                self.DiyCommon.Post(uptApiUrl, param, function (result) {
                    self.SaveAllDiyFieldLoding = false;
                    if (self.DiyCommon.Result(result)) {
                        self.DiyCommon.Tips(self.$t('Msg.Success'))
        ...
        DelDiyField() {
            var self = this
            try {
                self.DiyCommon.OsConfirm(self.$t('Msg.ConfirmDelTo') + '【' + self.CurrentDiyFieldModel.Name + '】？', function () {
                    self.SaveAllDiyFieldLoding = true
        ...
        GetDiyFieldModel(fieldId) {
            var self = this;
            self.DiyCommon.Post(self.DiyApi.GetDiyFieldModel, {
                Id: fieldId
                // OsClient: self.OsClient
            }, function (result) {
                if (self.DiyCommon.Result(result)) {
