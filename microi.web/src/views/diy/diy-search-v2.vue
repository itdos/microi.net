...
<section class="more-search">
    ...
    <template v-for="(field, index) in SearchFieldList">
        <div v-if="field._SearchComponent == 'Checkbox' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field.Component == 'DateTime'  && field._SeachDisplayType == SearchType"
        :key="'search2_' + field.Id + SearchType"
        :class="field._SeachDisplayType == 'Line' ? 'pull-left more-search-item-line' : 'pull-left more-search-item'"
        style="display: flex;">
            <div
                class="search-line-label pull-left"
        ...
        <div v-else-if="field.Component == 'Department' && field._SeachDisplayType == SearchType"
        ...
        style="display: flex;">
            ...
            <el-cascader
                ...
                :filterable="
                    field.Config.Department.Filterable === true
                "
                @change="
                    (item) => {
        ...
        <div v-else-if="field._SearchComponent == 'Select' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field.Component == 'Cascader' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field.Component == 'SelectTree' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field._SearchComponent == 'NumberText' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field.Component == 'Switch' && field._SeachDisplayType == SearchType"
        ...
        <div v-else-if="field._SeachDisplayType == SearchType"
                    :class="field._SeachDisplayType == 'Line' ? 'pull-left more-search-item-line' : 'pull-left more-search-item'"
...
export default {
            ...
            if (self.SearchFieldIds.length > 0 && self.DiyFieldList.length > 0) {
                ...
                self.SearchFieldIds.forEach((searchField) => {
                    ...
                    if (searchField.Hide !== true) {
                        var newSearchField = {...self.DiyFieldList.find(item => item.Id == searchField.Id)};
    ...
    methods: {
        ...
        SelectChange(item, field) {
            ...
            if (item) {
                self.SearchModel[field.Name] =
                    item[self.GetSelectValueKey(field)];
            } else {
                self.SearchModel[field.Name] = "";
            }
            self.GetDiyTableRow({ _PageIndex: 1 });
