...
<div class="v8-explain">
    <el-collapse>
        ...
        <el-collapse-item name="20">
            <template slot="title">
                <i class="fas fa-code mr-2"></i> V8.OldForm：访问当前表单修改前的所有字段
            </template>
        ...
        <el-collapse-item name="60">
            <template slot="title">
                <i class="fas fa-code mr-2"></i> V8.FormOutAction：离开表单类型，用于离开表单/提交表单后V8引擎
            </template>
            <div class="code">可能的值：Update/Insert/Close/Delete</div>
        </el-collapse-item>
        <el-collapse-item name="60">
            <template slot="title">
                <i class="fas fa-code mr-2"></i> V8.FormOutAfterAction：离开表单后类型，用于离开表单/提交表单后V8引擎
            </template>
