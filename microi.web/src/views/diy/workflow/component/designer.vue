    ...
    <div class="itdos-wf-container" v-if="easyFlowVisible" style="height: calc(100vh - 120px);background-color:#fff;">
        <el-form
            ...
            <el-form-item
                ...
                <el-button type="success" icon="el-icon-zoom-in" size="mini" @click="zoomAdd"></el-button>
                <el-button type="success" icon="el-icon-zoom-out" size="mini" @click="zoomSub"></el-button>
            </el-form-item>
        </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            jsPlumbInit() {
                ...
                self.jsPlumb.ready(() => {
                    ...
                    self.jsPlumb.bind("beforeDrop", (evt, param2) => {
                        ...
                        self.DiyCommon.Post(self.DiyApi.AddDiyTableRow, {
                            TableName : 'WF_Line',
            ...
            changeNodeSite(nodeModel) {
                // 避免抖动
                if (nodeModel.PositionLeft == this.$refs['refNodeModel_'+ nodeModel.Id][0].style.left 
                    && nodeModel.PositionTop == this.$refs['refNodeModel_'+ nodeModel.Id][0].style.top) {
                    return;
                }
                var data = {
                    Id: nodeModel.Id,
            ...
            SaveWF(){
                ...
                self.DiyCommon.Post('/api/FormEngine/UptFormDataBatch', 
                    // {
                    //     _List : allNodeParam,
                    // },
                    allNodeParam,
                    function(result1){
                        if (self.DiyCommon.Result(result1)) {
                            ...
                            self.DiyCommon.Post('/api/WorkFlow/saveWFFlowDesign', {
