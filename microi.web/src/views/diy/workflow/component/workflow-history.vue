  ...
  <div>
    ...
    <div class="workflow-history">
      <el-timeline style="padding-left: 2px">
        <el-timeline-item v-for="(history, index) in WFHistoryList" :key="history.Id" :icon="'el-icon-more'" :type="'primary'" :color="'#0bbd87'" :size="'large'" :timestamp="history.CreateTime">
          <div slot="dot">
                ...
                <div v-for="(copyUser, index2) in history.Receivers" :key="'receiveUser_' + copyUser.Id" style="text-align: center; margin-bottom: 5px; margin-right: 5px; float: left">
                  ...
                  <el-tag class="user-item" type="danger">
                    <div class="user-item-avatar">
                      <el-avatar :size="'small'" :src="copyUser.Avatar" shape="circle" style="width: 22px; height: 22px"> </el-avatar>
                    </div>
