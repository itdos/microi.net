    ...
    <el-dialog
        ...
        <div class="list-group microi-desktop-tab-content openDiv" style="padding-top:0px;">
            ...
            <div
                ...
                <el-tabs v-model="CurrentSysMenuModelTab"
                    id="field-form-tabs"
                    class="field-form-tabs">
                                ...
                                <el-row :gutter="20">
                                            ...
                                            <el-form-item
                                                ...
                                                <el-popover
                                                    ...
                                                    <el-button
                                                        size="mini"
                                                        slot="reference"
                                                        style="width:200px;padding: 10px 20px;margin-right:15px;">
                                                        {{ ParentName }}
                                                    </el-button>
                                                </el-popover>
                                    ...
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                class="form-item"
                                                :label="$t('Msg.IconClass')"
                                                size="mini">
                                                <div @click="$refs.fasCSMMIcon.show()"
                                                    style="height:25px;width:25px;background: #f5f5f5;cursor: pointer;text-align: center;border-radius: 5px;">
                                                <i :class="DiyCommon.IsNull(CurrentSysMenuModel.IconClass)
                                                    ? 'far fa-smile-wink hand' : 'hand ' +CurrentSysMenuModel.IconClass"
                                                     />
                                                </div>
                                    ...
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                class="form-item"
                                                :label="$t('Msg.OpenType')"
                                                size="mini">
                                                <el-select
                                                    v-model="CurrentSysMenuModel.OpenType"
                                                    style="width:100%;"
                                                    placeholder="请选择">
                                                    <el-option
                                                        v-for="item in ['Diy','Component','Iframe', 'SecondMenu', 'Report']"
                                                        :key="item"
                                                        :label="item"
                                                        :value="item" />
                                                </el-select>
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                ...
                                                <el-upload
                                                    ...
                                                    :data="{Path: 'sysmenu',CompressMaxWidth:DiyCommon.CompressMaxWidth,CompressMaxSize:DiyCommon.CompressMaxSize}"
                                                    :headers="{authorization: 'Bearer ' + DiyCommon.Authorization()}">
                                                    <img v-if="!DiyCommon.IsNull(CurrentSysMenuModel.Icon)" :src="DiyCommon.GetServerPath(CurrentSysMenuModel.Icon)" class="avatar" style="width:50px;height:50px;" />
                                    ...
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                class="form-item"
                                                :label="(CurrentSysMenuModel.OpenType == 'Diy' ? '*' : '') + $t('Msg.Url')"
                                                size="mini">
                                    ...
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                ...
                                                <el-switch
                                                    v-model="CurrentSysMenuModel.Display"
                                                    active-color="#ff6c04"
                                                    :active-value="1"
                                                    :inactive-value="0"
                                                    inactive-color="#ccc" />
                                    ...
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                class="form-item"
                                                :label="'移动端' + $t('Msg.Display')"
                                                size="mini">
                                                <!-- <el-checkbox v-model="CurrentSysMenuModel.Display" /> -->
                                                <el-switch
                                                    v-model="CurrentSysMenuModel.AppDisplay"
                                                    active-color="#ff6c04"
                                                    :active-value="1"
                                                    :inactive-value="0"
                                                    inactive-color="#ccc" />
                                    ...
                                    <template v-if="CurrentSysMenuModel.OpenType == 'Diy'">
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    class="form-item"
                                                    :label="(CurrentSysMenuModel.OpenType == 'Diy' ? '*' : '') + '自定义表'"
                                                    size="mini">
                                                    <el-select
                                                        v-model="CurrentSysMenuModel.DiyTableId"
                                                        filterable
                                                        clearable
                                                        placeholder
                                                        @change="DiyTableIdChange">
                                                        <!-- .replace('Diy_', '') -->
                                                        <el-option
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    class="form-item"
                                                    :label="(CurrentSysMenuModel.OpenType == 'Diy' ? '*' : '') + '界面模板'"
                                                    size="mini">
                                                    <el-select
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    :label="$t('Msg.ComponentPath')"
                                                    size="mini">
                                                    <input v-model="CurrentSysMenuModel.ComponentPath" placeholder="无需以'/views'开头，因为SysMenu的界面模板[ComponentPath]一定是在'/viws'里面" class="form-control" type="text" />
                                                </el-form-item>
                                            </div>
                                        </el-col>
                                    </template>
                                    <el-col
                                        ...
                                        <div class="container-form-item">
                                            <el-form-item
                                                ...
                                                <el-switch
                                                    v-model="CurrentSysMenuModel.IsMicroiService"
                                                    active-color="#ff6c04"
                                                    :active-value="1"
                                                    :inactive-value="0"
                                                    inactive-color="#ccc" />
                            ...
                            <el-form
                                ...
                                <el-row :gutter="20">
                                    <template v-if="!DiyCommon.IsNull(CurrentSysMenuModel.DiyTableId)">
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div v-for="(item,i) in CurrentSysMenuModel.JoinTables"
                                                        :key="'c_jointables_' + item.Name">
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div v-for="(item,i) in CurrentSysMenuModel.SelectFields"
                                                        :key="'selectfields_' + item.Id">
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <el-tag
                                                        v-for="field in CurrentSysMenuModel.SelectFields"
                                                        :key="'crrent_menu_fields_' + field.Name"
                                                        :type="field.IsShow ? '' : 'info'">
                                                        {{tag.Label}} <i :class="field.IsShow ? 'fas fa-eye hand' : 'far fa-eye-slash hand'"></i>
                                                    </el-tag>
                                                    <!-- <div>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <el-select
                                                        style="width:100%;"
                                                        v-model="CurrentSysMenuModel.NotShowFields"
                                                        filterable
                                                        multiple
                                                        clearable
                                                        placeholder>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <el-select
                                                        style="width:100%;"
                                                        v-model="CurrentSysMenuModel.SortFieldIds"
                                                        filterable
                                                        multiple
                                                        clearable
                                                        placeholder>
                                            ...
                                            <div class="container-form-item">
                                                ...
                                                <div>
                                                    <el-button
                                                        ...
                                                        icon="el-icon-plus"
                                                        type="text"
                                                        @click="AddDefaultSort()">{{ $t('Msg.Add') }}</el-button>
                                                </div>
                                            </div>
                                        </el-col>
                                        <!-- <el-col
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div v-for="(item,i) in CurrentSysMenuModel.SearchFieldIds"
                                                        :key="'searchfields5_' + item.Id">
                                                        <el-input
                                                            class="input-append-width-1"
                                                            placeholder="请输入字段别名，例如：UserName" v-model="item.AsName"
                                                            >
                                                            <template slot="prepend">
                                                                {{item.Label + ' - ' + item.Name  + ' - (' + item.TableDescription + ' - ' + item.TableName + ')'}}
                                                            </template>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <el-select
                                                        style="width:100%;"
                                                        v-model="CurrentSysMenuModel.StatisticsFields"
                                                        filterable
                                                        multiple
                                                        clearable
                                                        placeholder>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-switch
                                                        v-model="CurrentSysMenuModel.InTableEdit"
                                        ...
                                        <el-col
                                            v-if="CurrentSysMenuModel.InTableEdit"
                                            :span="24"
                                            :xs="24"
                                            >
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <el-select
                                                        style="width:100%;"
                                                        v-model="CurrentSysMenuModel.InTableEditFields"
                                                        filterable
                                                        multiple
                                                        clearable
                                                        placeholder>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.SqlJoin"
                                                        type="textarea"
                                                        rows="2"
                                                        placeholder=""
                                                    />
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <p>示例：INNER JOIN Sys_User B ON A.UserId = B.Id
                                                    </p>
                                                    <p>示例：INNER JOIN Diy_Customer B
                                                    ON A.KehuXXID = B.Id
                                                    AND B.GuanlianZH like '%$CurrentUser.Id$%'
                                                    </p>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.SqlWhere"
                                                        type="textarea"
                                                        rows="2"
                                                        placeholder=""
                                                    />
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                     ...
                                                     <a
                                                        v-if="!DiyCommon.IsNull(CurrentSysMenuModel.ImportTemplate)"
                                                        target="_blank"
                                                        :href="CurrentSysMenuModel._ImportTemplateUrl"
                                                    >
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-switch
                                                        v-model="CurrentSysMenuModel.TableIndexAdditive"
                                                        :active-value="1"
                                                        :inactive-value="0">
                                                    </el-switch>
                                                </el-form-item>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.DiyConfig.AddBtnText"
                                                        placeholder="新增"
                                                        type="text"
                                                    />
                                                </el-form-item>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.DiyConfig.SaveBtnText"
                                                        placeholder="保存"
                                                        type="text"
                                                    />
                                                </el-form-item>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.DiyConfig.ImportApi"
                                                        placeholder=""
                                                        type="text"
                                                    />
                                                </el-form-item>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.DiyConfig.ImportProgressApi"
                                                        placeholder="返回DosResult(1, List<string>)"
                                                        type="text"
                                                    />
                                                </el-form-item>
                                            </div>
                                        ...
                                        <el-col
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    size="mini">
                                                    <el-input
                                                        v-model="CurrentSysMenuModel.DiyConfig.ExportApi"
                                                        placeholder=""
                                                        type="text"
                                                    />
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear">
                                                        <el-table
                                                            class="diy-table"
                                                            :data="CurrentSysMenuModel.FormBtns"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                width="55">
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon" @click="$refs['fasFormBtnsIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                                        :ref="'fasFormBtnsIcon_' + scope.$index"
                                                            ...
                                                            <el-table-column :label="'按钮显示条件V8'">
                                                                <template slot-scope="scope">
                                                                    <el-input
                                                                        v-model="scope.row.V8CodeShow"
                                                                        placeholder="V8CodeShow"
                                                                        style="width:100px" />
                                                                    <el-button
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'FormBtns')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuFormBtnsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuFormBtnsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                            ...
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuFormBtnsModel.Name"
                                                                    style="width:200px;"
                                                            ...
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuFormBtnsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuFormBtnsModel.Icon"
                                                                    @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuFormBtnsModel.Icon" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuFormBtnsModel.V8Code"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuFormBtnsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('FormBtns')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear">
                                                        <el-table
                                                            class="diy-table"
                                                            :data="CurrentSysMenuModel.MoreBtns"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon" @click="$refs['fasTabsIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                            ...
                                                            <el-table-column :label="'行外部显示'"
                                                                width="120">
                                                                <template slot-scope="scope">
                                                                    <el-checkbox
                                                                        v-model="scope.row.ShowRow">
                                                                    </el-checkbox>
                                                                </template>
                                                            </el-table-column>
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'MoreBtns')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuMoreBtnsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuMoreBtnsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                                    :placeholder="$t('Msg.Sort')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuMoreBtnsModel.Name"
                                                                    style="width:200px;"
                                                                    :placeholder="$t('Msg.Name')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuMoreBtnsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuMoreBtnsModel.Icon" @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuMoreBtnsModel.Icon" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuMoreBtnsModel.V8Code"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuMoreBtnsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('MoreBtns')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear">
                                                        <el-table
                                                            class="diy-table"
                                                            :data="CurrentSysMenuModel.ExportMoreBtns"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon"
                                                                        @click="$refs['fasMoreBtnIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                                        :ref="'fasMoreBtnIcon_' + scope.$index"
                                                                        :model.sync="scope.row.Icon" />
                                                                </template>
                                                            </el-table-column>
                                                            <el-table-column
                                                            ...
                                                            <el-table-column :label="$t('Msg.Url')"
                                                                width="100">
                                                                <template slot-scope="scope">
                                                                    <el-input
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'ExportMoreBtns')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuExportMoreBtnsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuExportMoreBtnsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                                    :placeholder="$t('Msg.Sort')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuExportMoreBtnsModel.Name"
                                                                    style="width:200px;"
                                                                    :placeholder="$t('Msg.Name')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuExportMoreBtnsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuExportMoreBtnsModel.Icon" @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuExportMoreBtnsModel.Icon" />
                                                            </el-form-item>
                                                            <!-- <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                            ...
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    placeholder="Url"
                                                                    v-model="CurrentSysMenuExportMoreBtnsModel.Url"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuExportMoreBtnsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('ExportMoreBtns')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear">
                                                        <el-table
                                                            class="diy-table"
                                                            :data="CurrentSysMenuModel.BatchSelectMoreBtns"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon" @click="$refs['fasBSMBIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                                        :ref="'fasBSMBIcon_' + scope.$index"
                                                                        :model.sync="scope.row.Icon" />
                                                                </template>
                                                            </el-table-column>
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'BatchSelectMoreBtns')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuBatchSelectMoreBtnsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuBatchSelectMoreBtnsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                                    :placeholder="$t('Msg.Sort')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuBatchSelectMoreBtnsModel.Name"
                                                                    style="width:200px;"
                                                                    :placeholder="$t('Msg.Name')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuBatchSelectMoreBtnsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuBatchSelectMoreBtnsModel.Icon"
                                                                    @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuBatchSelectMoreBtnsModel.Icon" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuBatchSelectMoreBtnsModel.V8Code"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuBatchSelectMoreBtnsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('BatchSelectMoreBtns')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear">
                                                        <el-table
                                                            class="diy-table"
                                                            :data="CurrentSysMenuModel.PageBtns"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon" @click="$refs['fasPageBtnsIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                                        :ref="'fasPageBtnsIcon_' + scope.$index"
                                                                        :model.sync="scope.row.Icon" />
                                                                </template>
                                                            </el-table-column>
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'PageBtns')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuPageBtnsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuPageBtnsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                                    :placeholder="$t('Msg.Sort')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuPageBtnsModel.Name"
                                                                    style="width:200px;"
                                                                    :placeholder="$t('Msg.Name')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuPageBtnsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuPageBtnsModel.Icon"
                                                                    @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuPageBtnsModel.Icon" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuPageBtnsModel.V8Code"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuPageBtnsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('PageBtns')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
                                            ...
                                            <div class="container-form-item">
                                                <el-form-item
                                                    ...
                                                    <div class="clear diy-table">
                                                        <el-table
                                                            :data="CurrentSysMenuModel.PageTabs"
                                                            class="diy-table table-table table-data"
                                                            style="width: 100%">
                                                            <el-table-column
                                                                :label="$t('Msg.Sort')"
                                                                width="100">
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    <i style="padding-top:5px;" :class="DiyCommon.IsNull(scope.row.Icon)
                                                                        ? 'far fa-smile-wink hand' : 'hand ' + scope.row.Icon" @click="$refs['fasPageTabsIcon_' + scope.$index].show()" />
                                                                    <Fontawesome
                                                                        :ref="'fasPageTabsIcon_' + scope.$index"
                                                                        :model.sync="scope.row.Icon" />
                                                                </template>
                                                            </el-table-column>
                                                            ...
                                                            <el-table-column
                                                                ...
                                                                <template slot-scope="scope">
                                                                    ...
                                                                    <el-button
                                                                        ...
                                                                        icon="el-icon-delete"
                                                                        size="mini"
                                                                        @click="DelMoreBtn(scope.row, 'PageTabs')">{{ $t('Msg.Delete') }}</el-button>
                                                                </template>
                                                            </el-table-column>
                                                    ...
                                                    <div class="clear">
                                                        <el-form
                                                            :inline="true"
                                                            :model="CurrentSysMenuPageTabsModel"
                                                            class="demo-form-inline">
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuPageTabsModel.Sort"
                                                                    style="width:100px;"
                                                                    type="number"
                                                                    :placeholder="$t('Msg.Sort')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                <el-input
                                                                    v-model="CurrentSysMenuPageTabsModel.Name"
                                                                    style="width:200px;"
                                                                    :placeholder="$t('Msg.Name')" />
                                                            </el-form-item>
                                                            <el-form-item label="">
                                                                ...
                                                                <i :class="DiyCommon.IsNull(CurrentSysMenuPageTabsModel.Icon)
                                                                    ? 'far fa-smile-wink hand' : 'hand ' + CurrentSysMenuPageTabsModel.Icon"
                                                                    @click="$refs.fasCDTTMIcon.show()" />
                                                                <Fontawesome
                                                                    ref="fasCDTTMIcon"
                                                                    :model.sync="CurrentSysMenuPageTabsModel.Icon" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuPageTabsModel.V8Code"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item label="" v-show="false">
                                                                <el-input
                                                                    value=""
                                                                    v-model="CurrentSysMenuPageTabsModel.V8CodeShow"
                                                                    style="width:60px;" />
                                                            </el-form-item>
                                                            <el-form-item>
                                                                <el-button
                                                                    ...
                                                                    icon="el-icon-plus"
                                                                    type="text"
                                                                    @click="AddMoreBtn('PageTabs')">{{ $t('Msg.Add') }}</el-button>
                                                            </el-form-item>
                                                        </el-form>
                                                    </div>
                                                </el-form-item>
        ...
        <span slot="footer" class="dialog-footer">
            <div class="offset-sm-2 col-sm-10">
                <el-button
                    ...
                    size="mini" v-if="!DiyCommon.IsNull(CurrentSysMenuModel.Id)" class="btn-primary mr-2" @click="UptSysMenu()">
                    {{$t('Msg.Update')}}
                </el-button>
                <el-button
                    :loading="BtnLoading"
                    :icon="!DiyCommon.IsNull(CurrentSysMenuModel.Id) ? 'el-icon-copy-document' : 'el-icon-circle-plus'"
                    size="mini" class="btn-info mr-2" @click="AddSysMenu(null, true)">
                ...
                <el-button
                    icon="el-icon-close"
                    size="mini" type="default" @click="ShowMenuForm = false">
                    {{$t('Msg.Close')}}
                </el-button>
            </div>
        </span>
    ...
    <el-dialog
        ...
        <el-tabs v-model="DialogV8Code">
            <el-tab-pane
                ...
                <DiyCodeEditor
                    ref="diyCodeEditor"
                    :key="CurrentV8Sign + CurrentV8SignCol + CurrentV8SignFieldName"
                    v-model="CurrentV8Code"
        ...
        <span slot="footer" class="dialog-footer">
            <el-button
                ...
                size="mini"
                icon="el-icon-close"
                @click="CloseV8CodeEditor">{{ $t('Msg.Close') }}({{ $t('Msg.AutoSave') }})</el-button>
        </span>
    </el-dialog>
    <Fontawesome
        ref="fasCSMMIcon"
        :model.sync="CurrentSysMenuModel.IconClass" />
</div>
</template>
...
export default {
    ...
    watch: {
        "CurrentSysMenuModel.OpenType"(val) {
            ...
            if (
                val == "Diy" &&
                !self.DiyCommon.IsNull(self.CurrentSysMenuModel.DiyTableId)
            ) {
    ...
    'DiyTableId', 'ParentId', 'Sort'],
            ...
            if(sysMenuId){
                ...
                if(self.DiyCommon.Result(getSysMenuModelResult)){
                    ...
                    if (!self.DiyCommon.IsNull(tempModel.SearchFieldIds)) {
                        if (tempModel.SearchFieldIds.length > 0 && tempModel.SearchFieldIds[0].Name == '') {//typeof(tempModel.SearchFieldIds[0]) == 'string'
                            var index = 0;
                            tempModel.SearchFieldIds.forEach(fieldOldModel => {
                                var fieldModel = _.where(self.DiyFieldList, { Id : fieldOldModel.Id })[0];
                                // if (fieldModel) {
                                //     var newFieldModel = {
                                //         Id: fieldOldModel.Id ,
        ...
        AddJoinTable(){
            ...
            self.TempJoinTables.forEach(tableId => {
                var temp = _.where(self.CurrentSysMenuModel.JoinTables, { Id :tableId });
                if (temp.length == 0) {
        ...
        AddSearchFieldId(){
            ...
            self.TempSearchFieldIds.forEach(fieldId => {
                var temp = _.where(self.CurrentSysMenuModel.SearchFieldIds, { Id :fieldId });
                if (temp.length == 0) {
                    // var fieldModel = _.where(self.DiyFieldList, { Id : fieldId })[0];
        ...
        ChangeTableDiyFieldIds(fieldIds, a2){
            ...
            //如果A存在，B不存在，就要新增
            self.CurrentSysMenuModel.TableDiyFieldIds.forEach(fieldId => {
                var currentIndex = _.findIndex(self.CurrentSysMenuModel.SelectFields, {Id : fieldId});
                if (currentIndex == -1) {
                    var fieldModel = _.where(self.DiyFieldList, { Id : fieldId })[0];
                    if (fieldModel) {
                        self.CurrentSysMenuModel.SelectFields.push({
        ...
        SetDiyFieldSort() {
            ...
            try {
                ...
                this.sortable = Sortable.create(el, {
                    ...
                    onEnd: (evt) => {
                        const targetRow = self.CurrentSysMenuModel.TableDiyFieldIds.splice(
                            evt.oldIndex,
                            1
                        )[0];
                        self.CurrentSysMenuModel.TableDiyFieldIds.splice(
                            evt.newIndex,
                            0,
                            targetRow
                        );
        ...
        GetAllCanEditFieldList() {
            ...
            self.DiyFieldList.forEach((element) => {
                ...
                if (
                    !(self.CurrentSysMenuModel.NotShowFields.indexOf(element.Id) > -1)
                ) {
                    result.push(element);
                }
                // result.push(element);
