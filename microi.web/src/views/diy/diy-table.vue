          ...
          <el-col :span="24">
            <el-card class="box-card no-padding-body">
              ...
              >
                ...
                <el-form-item
                  size="mini"
                  v-if="!DiyCommon.IsNull(DbRealTableName)"
                >
                  <el-button
                    type="primary"
                    icon="el-icon-plus"
                  ...
                  >
                    <template slot-scope="scope">
                      <el-button
                        ...
                        class="marginRight5"
                        icon="el-icon-s-help"
                        @click="$router.push('/diy/diy-design/' + scope.row.Id)"
                      ...
                      <el-dropdown trigger="click">
                        ...
                        >
                          ...
                          <el-dropdown-item
                            icon="el-icon-edit"
                            @click.native="
                              OpenDiyTable(model, 'Copy', model.Name)
                            "
                          >
                            {{ $t("Msg.Copy") }}
                          </el-dropdown-item>
                ...
                <el-card class="box-card card-data-animate">
                  <div slot="header">
                    <span class="title">
                      ...
                      {{
                        !DiyCommon.IsNull(model.Description)
                          ? model.Description
                          : model.Name
                      }}</span
                    >
                    <div style="float: right">
                      <el-button
                        ...
                        class="marginRight5"
                        icon="el-icon-s-help"
                        @click="$router.push('/diy/diy-design/' + model.Id)"
                        >{{ $t("Msg.Design") }}</el-button
                      >
                      <el-dropdown trigger="click">
                        <el-button type="text">
                  ...
                  <div class="item">
                    打开方式:
                    {{
                      DiyCommon.IsNull(model.FormOpenType)
                        ? "Drawer"
                        : model.FormOpenType
                    }}
                  </div>
                  ...
                  <div class="bottom-time">
                    ...
                    <div
                      style="float: right; color: cadetblue"
                      v-if="model.ReportId"
                    >
                      虚拟表
                    </div>
