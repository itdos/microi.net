                    ...
                    <template #header>
                        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%">
                            ...
                            <div style="display: flex; flex-direction: column; flex: 1">
                                <span style="font-weight: 500; margin-bottom: 2px; word-break: break-word; white-space: normal; line-height: 1.4">
                                    {{ ShowPrefix ? filedPrefix[ShowTitleName] + "：" + item[ShowTitleName] : item[ShowTitleName] }}
                                </span>
                                <span
                                    v-for="(fieldName, index) in ShowSubTitleList"
                                    :key="index"
                                    style="font-size: 12px; color: #666; margin-bottom: 1px; word-break: break-word; white-space: normal; line-height: 1.3"
                                >
    ...
    methods: {
        ...
        handleDelete(Id) {
            this.$emit("getOpenAnyTableParam", {
                ...
                TableMultipleSelection: Id ? this.tableSelectRow.TableIndexDataList.filter((uns) => uns.Id !== Id) : [],
