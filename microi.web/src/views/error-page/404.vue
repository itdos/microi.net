...
.error-page-main:before{content:'';display:block;background:url(https://static-ali-img.itdos.com/static/img/404-border.png);height:7px;position:absolute;top:-7px;width:100%;left:0}
