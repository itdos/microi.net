                            ...
                            <div class="row card-body card-body-item card-body-todo">
                                ...
                                <div class="col-md-6 col-xs-6 hand">
                                    ...
                                    >
                                        ...
                                        <div class="icon-div">
                                            <i
                                                class="fas fa-check-square icon"
                                            />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <el-card class="box-card">
                            ...
                            <div class="row card-body card-body-item">
								<div v-for="(item, index) in IndexData.NoticeList"
									:key="item.Id"
									...
									<div class="pull-right card-body-item-row-right">{{item.CreateTime}}</div>
								</div>
                  ...
                  <div class="title no-br">建设中</div>
                    ...
                    <div class="col-md-6">
                        ...
                        <el-card class="box-card">
                            ...
                            <div class="row card-body card-body-item card-body-todo">
								<div v-for="(item, index) in IndexData.MyUseMenuList"
									:key="item.Id"
                    ...
                    <div class="col-md-6">
                        ...
                        <el-card class="box-card">
                            ...
                            <div class="row card-body card-body-item">
								<div v-for="(item, index) in IndexData.MyApplyList"
									:key="item.Id"
									class="col-md-12 col-xs-12 card-body-item-row"
									>
									<div class="pull-left no-br over-hide card-body-item-row-left"><i class="el-icon-info"></i> {{item.FlowTitle}} <i>{{ item.FlowState }}</i> </div>
									<div class="pull-right card-body-item-row-right">{{item.CreateTime}}</div>
								</div>
								<div v-if="LoadingIndexData"><i class="el-icon-loading" /> Loading...</div>
          ...
          <div class="row card-body card-body-server-state">
            ...
            <div class="col-md-4 col-xs-12 hand">
                ...
                <el-card class="box-card">
                    ...
                    <div class="row card-body card-body-item">
                        <div v-for="(item, index) in IndexData.NewsList"
							:key="item.Id"
							class="col-md-12 col-xs-12 card-body-item-row"
							>
							<div class="pull-left no-br over-hide card-body-item-row-left"><i class="el-icon-info"></i> {{item.Biaoti}} </div>
