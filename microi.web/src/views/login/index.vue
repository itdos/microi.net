            ...
            <div class="input-group">
              ...
              <div class="input-group-prepend">
                <span class="input-group-text" style="padding: 0">
                  ...
                  <i
                    id="faLogin"
                    v-if="PageType != 'BindWeChat'"
                    @click="Login"
                    class="el-icon-right hand"
          ...
          <div>
            <p v-if="SysConfig.EnableReg">
              <a href="javascript:;" @click="OpenReg"
                ><i class="far fa-registered" style="margin-right: 2px" />
                立即注册</a
              >
            </p>
            <p v-if="PageType == 'BindWeChat'">
              <el-button type="primary" @click="BindWeChat()"
                ><i class="el-icon-right hand" style="margin-right: 2px" />
                立即绑定</el-button
              >
            </p>
...
export default {
  ...
  computed: {
    ...
    LoginBottomContent: {
      get() {
        return (
          this.SysConfig.LoginBottomContent ||
          this.SysConfig.CompanyName ||
          ""
        )
