...
`)+`
`+f);const E=b+m+a,S=b+f+o,L=El(i,i.VERTEX_SHADER,E),P=El(i,i.FRAGMENT_SHADER,S);i.attachShader(_,L),i.attachShader(_,P),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(A){if(s.debug.checkShaderErrors){const G=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(L).trim(),O=i.getShaderInfoLog(P).trim();let Y=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,L,P);else{const J=bl(i,L,"vertex"),F=bl(i,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function Gg(s,e,t){let n=new $a;const i=new Ce,r=new Ce,a=new qe,o=new Ou({depthPacking:Eh}),l=new Bu,c={},h=t.maxTextureSize,u={[An]:It,[It]:An,[Qt]:Qt},d=new Hn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ce},radius:{value:4}},vertexShader:Hg,fragmentShader:Vg}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const g=new ln;g.setAttribute("position",new Ct(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Ot(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Hl;let f=this.type;this.render=function(P,R,w){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||P.length===0)return;const y=s.getRenderTarget(),v=s.getActiveCubeFace(),A=s.getActiveMipmapLevel(),G=s.state;G.setBlending(kn),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const B=f!==vn&&this.type===vn,O=f===vn&&this.type!==vn;for(let Y=0,H=P.length;Y<H;Y++){const J=P[Y],F=J.shadow;if(F===void 0){console.warn("THREE.WebGLShadowMap:",J,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;i.copy(F.mapSize);const K=F.getFrameExtents();if(i.multiply(K),r.copy(F.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/K.x),i.x=r.x*K.x,F.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/K.y),i.y=r.y*K.y,F.mapSize.y=r.y)),F.map===null||B===!0||O===!0){const me=this.type!==vn?{minFilter:Rt,magFilter:Rt}:{};F.map!==null&&F.map.dispose(),F.map=new si(i.x,i.y,me),F.map.texture.name=J.name+".shadowMap",F.camera.updateProjectionMatrix()}s.setRenderTarget(F.map),s.clear();const ne=F.getViewportCount();for(let me=0;me<ne;me++){const xe=F.getViewport(me);a.set(r.x*xe.x,r.y*xe.y,r.x*xe.z,r.y*xe.w),G.viewport(a),F.updateMatrices(J,me),n=F.getFrustum(),S(R,w,F.camera,J,this.type)}F.isPointLightShadow!==!0&&this.type===vn&&b(F,w),F.needsUpdate=!1}f=this.type,m.needsUpdate=!1,s.setRenderTarget(y,v,A)};function b(P,R){const w=e.update(_);d.defines.VSM_SAMPLES!==P.blurSamples&&(d.defines.VSM_SAMPLES=P.blurSamples,p.defines.VSM_SAMPLES=P.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),P.mapPass===null&&(P.mapPass=new si(i.x,i.y)),d.uniforms.shadow_pass.value=P.map.texture,d.uniforms.resolution.value=P.mapSize,d.uniforms.radius.value=P.radius,s.setRenderTarget(P.mapPass),s.clear(),s.renderBufferDirect(R,null,w,d,_,null),p.uniforms.shadow_pass.value=P.mapPass.texture,p.uniforms.resolution.value=P.mapSize,p.uniforms.radius.value=P.radius,s.setRenderTarget(P.map),s.clear(),s.renderBufferDirect(R,null,w,p,_,null)}function E(P,R,w,y){let v=null;const A=w.isPointLight===!0?P.customDistanceMaterial:P.customDepthMaterial;if(A!==void 0)v=A;else if(v=w.isPointLight===!0?l:o,s.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const G=v.uuid,B=R.uuid;let O=c[G];O===void 0&&(O={},c[G]=O);let Y=O[B];Y===void 0&&(Y=v.clone(),O[B]=Y,R.addEventListener("dispose",L)),v=Y}if(v.visible=R.visible,v.wireframe=R.wireframe,y===vn?v.side=R.shadowSide!==null?R.shadowSide:R.side:v.side=R.shadowSide!==null?R.shadowSide:u[R.side],v.alphaMap=R.alphaMap,v.alphaTest=R.alphaTest,v.map=R.map,v.clipShadows=R.clipShadows,v.clippingPlanes=R.clippingPlanes,v.clipIntersection=R.clipIntersection,v.displacementMap=R.displacementMap,v.displacementScale=R.displacementScale,v.displacementBias=R.displacementBias,v.wireframeLinewidth=R.wireframeLinewidth,v.linewidth=R.linewidth,w.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const G=s.properties.get(v);G.light=w}return v}function S(P,R,w,y,v){if(P.visible===!1)return;if(P.layers.test(R.layers)&&(P.isMesh||P.isLine||P.isPoints)&&(P.castShadow||P.receiveShadow&&v===vn)&&(!P.frustumCulled||n.intersectsObject(P))){P.modelViewMatrix.multiplyMatrices(w.matrixWorldInverse,P.matrixWorld);const B=e.update(P),O=P.material;if(Array.isArray(O)){const Y=B.groups;for(let H=0,J=Y.length;H<J;H++){const F=Y[H],K=O[F.materialIndex];if(K&&K.visible){const ne=E(P,K,y,v);P.onBeforeShadow(s,P,R,w,B,ne,F),s.renderBufferDirect(w,null,B,ne,P,F),P.onAfterShadow(s,P,R,w,B,ne,F)}}}else if(O.visible){const Y=E(P,O,y,v);P.onBeforeShadow(s,P,R,w,B,Y,null),s.renderBufferDirect(w,null,B,Y,P,null),P.onAfterShadow(s,P,R,w,B,Y,null)}}const G=P.children;for(let B=0,O=G.length;B<O;B++)S(G[B],R,w,y,v)}function L(P){P.target.removeEventListener("dispose",L);for(const w in c){const y=c[w],v=P.target.uuid;v in y&&(y[v].dispose(),delete y[v])}}}const Wg={[qr]:$r,[Kr]:Qr,[Zr]:ea,[Pi]:Jr,[$r]:qr,[Qr]:Kr,[ea]:Zr,[Jr]:Pi};function Xg(s,e){function t(){let D=!1;const se=new qe;let W=null;const $=new qe(0,0,0,0);return{setMask:function(ce){W!==ce&&!D&&(s.colorMask(ce,ce,ce,ce),W=ce)},setLocked:function(ce){D=ce},setClear:function(ce,le,De,ot,Mt){Mt===!0&&(ce*=ot,le*=ot,De*=ot),se.set(ce,le,De,ot),$.equals(se)===!1&&(s.clearColor(ce,le,De,ot),$.copy(se))},reset:function(){D=!1,W=null,$.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,W=null,$=null,ce=null;return{setReversed:function(le){if(se!==le){const De=e.get("EXT_clip_control");se?De.clipControlEXT(De.LOWER_LEFT_EXT,De.ZERO_TO_ONE_EXT):De.clipControlEXT(De.LOWER_LEFT_EXT,De.NEGATIVE_ONE_TO_ONE_EXT);const ot=ce;ce=null,this.setClear(ot)}se=le},getReversed:function(){return se},setTest:function(le){le?ae(s.DEPTH_TEST):Te(s.DEPTH_TEST)},setMask:function(le){W!==le&&!D&&(s.depthMask(le),W=le)},setFunc:function(le){if(se&&(le=Wg[le]),$!==le){switch(le){case qr:s.depthFunc(s.NEVER);break;case $r:s.depthFunc(s.ALWAYS);break;case Kr:s.depthFunc(s.LESS);break;case Pi:s.depthFunc(s.LEQUAL);break;case Zr:s.depthFunc(s.EQUAL);break;case Jr:s.depthFunc(s.GEQUAL);break;case Qr:s.depthFunc(s.GREATER);break;case ea:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}$=le}},setLocked:function(le){D=le},setClear:function(le){ce!==le&&(se&&(le=1-le),s.clearDepth(le),ce=le)},reset:function(){D=!1,W=null,$=null,ce=null,se=!1}}}function i(){let D=!1,se=null,W=null,$=null,ce=null,le=null,De=null,ot=null,Mt=null;return{setTest:function(Ze){D||(Ze?ae(s.STENCIL_TEST):Te(s.STENCIL_TEST))},setMask:function(Ze){se!==Ze&&!D&&(s.stencilMask(Ze),se=Ze)},setFunc:function(Ze,Wt,un){(W!==Ze||$!==Wt||ce!==un)&&(s.stencilFunc(Ze,Wt,un),W=Ze,$=Wt,ce=un)},setOp:function(Ze,Wt,un){(le!==Ze||De!==Wt||ot!==un)&&(s.stencilOp(Ze,Wt,un),le=Ze,De=Wt,ot=un)},setLocked:function(Ze){D=Ze},setClear:function(Ze){Mt!==Ze&&(s.clearStencil(Ze),Mt=Ze)},reset:function(){D=!1,se=null,W=null,$=null,ce=null,le=null,De=null,ot=null,Mt=null}}}const r=new t,a=new n,o=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,b=null,E=null,S=null,L=null,P=null,R=new Le(0,0,0),w=0,y=!1,v=null,A=null,G=null,B=null,O=null;const Y=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,J=0;const F=s.getParameter(s.VERSION);F.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(F)[1]),H=J>=1):F.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(F)[1]),H=J>=2);let K=null,ne={};const me=s.getParameter(s.SCISSOR_BOX),xe=s.getParameter(s.VIEWPORT),ye=new qe().fromArray(me),X=new qe().fromArray(xe);function ee(D,se,W,$){const ce=new Uint8Array(4),le=s.createTexture();s.bindTexture(D,le),s.texParameteri(D,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(D,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let De=0;De<W;De++)D===s.TEXTURE_3D||D===s.TEXTURE_2D_ARRAY?s.texImage3D(se,0,s.RGBA,1,1,$,0,s.RGBA,s.UNSIGNED_BYTE,ce):s.texImage2D(se+De,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,ce);return le}const ge={};ge[s.TEXTURE_2D]=ee(s.TEXTURE_2D,s.TEXTURE_2D,1),ge[s.TEXTURE_CUBE_MAP]=ee(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),ge[s.TEXTURE_2D_ARRAY]=ee(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),ge[s.TEXTURE_3D]=ee(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ae(s.DEPTH_TEST),a.setFunc(Pi),ze(!1),He(mo),ae(s.CULL_FACE),C(kn);function ae(D){h[D]!==!0&&(s.enable(D),h[D]=!0)}function Te(D){h[D]!==!1&&(s.disable(D),h[D]=!1)}function je(D,se){return u[D]!==se?(s.bindFramebuffer(D,se),u[D]=se,D===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=se),D===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=se),!0):!1}function Ae(D,se){let W=p,$=!1;if(D){W=d.get(se),W===void 0&&(W=[],d.set(se,W));const ce=D.textures;if(W.length!==ce.length||W[0]!==s.COLOR_ATTACHMENT0){for(let le=0,De=ce.length;le<De;le++)W[le]=s.COLOR_ATTACHMENT0+le;W.length=ce.length,$=!0}}else W[0]!==s.BACK&&(W[0]=s.BACK,$=!0);$&&s.drawBuffers(W)}function ct(D){return g!==D?(s.useProgram(D),g=D,!0):!1}const rt={[Qn]:s.FUNC_ADD,[qc]:s.FUNC_SUBTRACT,[$c]:s.FUNC_REVERSE_SUBTRACT};rt[Kc]=s.MIN,rt[Zc]=s.MAX;const ke={[Jc]:s.ZERO,[Qc]:s.ONE,[eh]:s.SRC_COLOR,[Yr]:s.SRC_ALPHA,[ah]:s.SRC_ALPHA_SATURATE,[sh]:s.DST_COLOR,[nh]:s.DST_ALPHA,[th]:s.ONE_MINUS_SRC_COLOR,[jr]:s.ONE_MINUS_SRC_ALPHA,[rh]:s.ONE_MINUS_DST_COLOR,[ih]:s.ONE_MINUS_DST_ALPHA,[oh]:s.CONSTANT_COLOR,[lh]:s.ONE_MINUS_CONSTANT_COLOR,[ch]:s.CONSTANT_ALPHA,[hh]:s.ONE_MINUS_CONSTANT_ALPHA};function C(D,se,W,$,ce,le,De,ot,Mt,Ze){if(D===kn){_===!0&&(Te(s.BLEND),_=!1);return}if(_===!1&&(ae(s.BLEND),_=!0),D!==jc){if(D!==m||Ze!==y){if((f!==Qn||S!==Qn)&&(s.blendEquation(s.FUNC_ADD),f=Qn,S=Qn),Ze)switch(D){case Ai:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case go:s.blendFunc(s.ONE,s.ONE);break;case _o:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case xo:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case Ai:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case go:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case _o:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case xo:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}b=null,E=null,L=null,P=null,R.set(0,0,0),w=0,m=D,y=Ze}return}ce=ce||se,le=le||W,De=De||$,(se!==f||ce!==S)&&(s.blendEquationSeparate(rt[se],rt[ce]),f=se,S=ce),(W!==b||$!==E||le!==L||De!==P)&&(s.blendFuncSeparate(ke[W],ke[$],ke[le],ke[De]),b=W,E=$,L=le,P=De),(ot.equals(R)===!1||Mt!==w)&&(s.blendColor(ot.r,ot.g,ot.b,Mt),R.copy(ot),w=Mt),m=D,y=!1}function Bt(D,se){D.side===Qt?Te(s.CULL_FACE):ae(s.CULL_FACE);let W=D.side===It;se&&(W=!W),ze(W),D.blending===Ai&&D.transparent===!1?C(kn):C(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const $=D.stencilWrite;o.setTest($),$&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),it(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ae(s.SAMPLE_ALPHA_TO_COVERAGE):Te(s.SAMPLE_ALPHA_TO_COVERAGE)}function ze(D){v!==D&&(D?s.frontFace(s.CW):s.frontFace(s.CCW),v=D)}function He(D){D!==Wc?(ae(s.CULL_FACE),D!==A&&(D===mo?s.cullFace(s.BACK):D===Xc?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Te(s.CULL_FACE),A=D}function Me(D){D!==G&&(H&&s.lineWidth(D),G=D)}function it(D,se,W){D?(ae(s.POLYGON_OFFSET_FILL),(B!==se||O!==W)&&(s.polygonOffset(se,W),B=se,O=W)):Te(s.POLYGON_OFFSET_FILL)}function ve(D){D?ae(s.SCISSOR_TEST):Te(s.SCISSOR_TEST)}function T(D){D===void 0&&(D=s.TEXTURE0+Y-1),K!==D&&(s.activeTexture(D),K=D)}function x(D,se,W){W===void 0&&(K===null?W=s.TEXTURE0+Y-1:W=K);let $=ne[W];$===void 0&&($={type:void 0,texture:void 0},ne[W]=$),($.type!==D||$.texture!==se)&&(K!==W&&(s.activeTexture(W),K=W),s.bindTexture(D,se||ge[D]),$.type=D,$.texture=se)}function k(){const D=ne[K];D!==void 0&&D.type!==void 0&&(s.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function q(){try{s.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Z(){try{s.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{s.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function _e(){try{s.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{s.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ue(){try{s.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function We(){try{s.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function te(){try{s.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function de(){try{s.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function be(){try{s.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function we(D){ye.equals(D)===!1&&(s.scissor(D.x,D.y,D.z,D.w),ye.copy(D))}function fe(D){X.equals(D)===!1&&(s.viewport(D.x,D.y,D.z,D.w),X.copy(D))}function Ve(D,se){let W=c.get(se);W===void 0&&(W=new WeakMap,c.set(se,W));let $=W.get(D);$===void 0&&($=s.getUniformBlockIndex(se,D.name),W.set(D,$))}function Ne(D,se){const $=c.get(se).get(D);l.get(se)!==$&&(s.uniformBlockBinding(se,$,D.__bindingPointIndex),l.set(se,$))}function nt(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),a.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},K=null,ne={},u={},d=new WeakMap,p=[],g=null,_=!1,m=null,f=null,b=null,E=null,S=null,L=null,P=null,R=new Le(0,0,0),w=0,y=!1,v=null,A=null,G=null,B=null,O=null,ye.set(0,0,s.canvas.width,s.canvas.height),X.set(0,0,s.canvas.width,s.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:ae,disable:Te,bindFramebuffer:je,drawBuffers:Ae,useProgram:ct,setBlending:C,setMaterial:Bt,setFlipSided:ze,setCullFace:He,setLineWidth:Me,setPolygonOffset:it,setScissorTest:ve,activeTexture:T,bindTexture:x,unbindTexture:k,compressedTexImage2D:q,compressedTexImage3D:Z,texImage2D:de,texImage3D:be,updateUBOMapping:Ve,uniformBlockBinding:Ne,texStorage2D:We,texStorage3D:te,texSubImage2D:j,texSubImage3D:_e,compressedTexSubImage2D:oe,compressedTexSubImage3D:ue,scissor:we,viewport:fe,reset:nt}}function Yg(s,e,t,n,i,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ce,h=new WeakMap;let u;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(T,x){return p?new OffscreenCanvas(T,x):ls("canvas")}function _(T,x,k){let q=1;const Z=ve(T);if((Z.width>k||Z.height>k)&&(q=k/Math.max(Z.width,Z.height)),q<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const j=Math.floor(q*Z.width),_e=Math.floor(q*Z.height);u===void 0&&(u=g(j,_e));const oe=x?g(j,_e):u;return oe.width=j,oe.height=_e,oe.getContext("2d").drawImage(T,0,0,j,_e),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+j+"x"+_e+")."),oe}else return"data"in T&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function m(T){return T.generateMipmaps}function f(T){s.generateMipmap(T)}function b(T){return T.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?s.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function E(T,x,k,q,Z=!1){if(T!==null){if(s[T]!==void 0)return s[T];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let j=x;if(x===s.RED&&(k===s.FLOAT&&(j=s.R32F),k===s.HALF_FLOAT&&(j=s.R16F),k===s.UNSIGNED_BYTE&&(j=s.R8)),x===s.RED_INTEGER&&(k===s.UNSIGNED_BYTE&&(j=s.R8UI),k===s.UNSIGNED_SHORT&&(j=s.R16UI),k===s.UNSIGNED_INT&&(j=s.R32UI),k===s.BYTE&&(j=s.R8I),k===s.SHORT&&(j=s.R16I),k===s.INT&&(j=s.R32I)),x===s.RG&&(k===s.FLOAT&&(j=s.RG32F),k===s.HALF_FLOAT&&(j=s.RG16F),k===s.UNSIGNED_BYTE&&(j=s.RG8)),x===s.RG_INTEGER&&(k===s.UNSIGNED_BYTE&&(j=s.RG8UI),k===s.UNSIGNED_SHORT&&(j=s.RG16UI),k===s.UNSIGNED_INT&&(j=s.RG32UI),k===s.BYTE&&(j=s.RG8I),k===s.SHORT&&(j=s.RG16I),k===s.INT&&(j=s.RG32I)),x===s.RGB_INTEGER&&(k===s.UNSIGNED_BYTE&&(j=s.RGB8UI),k===s.UNSIGNED_SHORT&&(j=s.RGB16UI),k===s.UNSIGNED_INT&&(j=s.RGB32UI),k===s.BYTE&&(j=s.RGB8I),k===s.SHORT&&(j=s.RGB16I),k===s.INT&&(j=s.RGB32I)),x===s.RGBA_INTEGER&&(k===s.UNSIGNED_BYTE&&(j=s.RGBA8UI),k===s.UNSIGNED_SHORT&&(j=s.RGBA16UI),k===s.UNSIGNED_INT&&(j=s.RGBA32UI),k===s.BYTE&&(j=s.RGBA8I),k===s.SHORT&&(j=s.RGBA16I),k===s.INT&&(j=s.RGBA32I)),x===s.RGB&&k===s.UNSIGNED_INT_5_9_9_9_REV&&(j=s.RGB9_E5),x===s.RGBA){const _e=Z?Qs:Ge.getTransfer(q);k===s.FLOAT&&(j=s.RGBA32F),k===s.HALF_FLOAT&&(j=s.RGBA16F),k===s.UNSIGNED_BYTE&&(j=_e===et?s.SRGB8_ALPHA8:s.RGBA8),k===s.UNSIGNED_SHORT_4_4_4_4&&(j=s.RGBA4),k===s.UNSIGNED_SHORT_5_5_5_1&&(j=s.RGB5_A1)}return(j===s.R16F||j===s.R32F||j===s.RG16F||j===s.RG32F||j===s.RGBA16F||j===s.RGBA32F)&&e.get("EXT_color_buffer_float"),j}function S(T,x){let k;return T?x===null||x===ii||x===Ui?k=s.DEPTH24_STENCIL8:x===Dt?k=s.DEPTH32F_STENCIL8:x===rs&&(k=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===ii||x===Ui?k=s.DEPTH_COMPONENT24:x===Dt?k=s.DEPTH_COMPONENT32F:x===rs&&(k=s.DEPTH_COMPONENT16),k}function L(T,x){return m(T)===!0||T.isFramebufferTexture&&T.minFilter!==Rt&&T.minFilter!==gt?Math.log2(Math.max(x.width,x.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?x.mipmaps.length:1}function P(T){const x=T.target;x.removeEventListener("dispose",P),w(x),x.isVideoTexture&&h.delete(x)}function R(T){const x=T.target;x.removeEventListener("dispose",R),v(x)}function w(T){const x=n.get(T);if(x.__webglInit===void 0)return;const k=T.source,q=d.get(k);if(q){const Z=q[x.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&y(T),Object.keys(q).length===0&&d.delete(k)}n.remove(T)}function y(T){const x=n.get(T);s.deleteTexture(x.__webglTexture);const k=T.source,q=d.get(k);delete q[x.__cacheKey],a.memory.textures--}function v(T){const x=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(x.__webglFramebuffer[q]))for(let Z=0;Z<x.__webglFramebuffer[q].length;Z++)s.deleteFramebuffer(x.__webglFramebuffer[q][Z]);else s.deleteFramebuffer(x.__webglFramebuffer[q]);x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer[q])}else{if(Array.isArray(x.__webglFramebuffer))for(let q=0;q<x.__webglFramebuffer.length;q++)s.deleteFramebuffer(x.__webglFramebuffer[q]);else s.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&s.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let q=0;q<x.__webglColorRenderbuffer.length;q++)x.__webglColorRenderbuffer[q]&&s.deleteRenderbuffer(x.__webglColorRenderbuffer[q]);x.__webglDepthRenderbuffer&&s.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const k=T.textures;for(let q=0,Z=k.length;q<Z;q++){const j=n.get(k[q]);j.__webglTexture&&(s.deleteTexture(j.__webglTexture),a.memory.textures--),n.remove(k[q])}n.remove(T)}let A=0;function G(){A=0}function B(){const T=A;return T>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+i.maxTextures),A+=1,T}function O(T){const x=[];return x.push(T.wrapS),x.push(T.wrapT),x.push(T.wrapR||0),x.push(T.magFilter),x.push(T.minFilter),x.push(T.anisotropy),x.push(T.internalFormat),x.push(T.format),x.push(T.type),x.push(T.generateMipmaps),x.push(T.premultiplyAlpha),x.push(T.flipY),x.push(T.unpackAlignment),x.push(T.colorSpace),x.join()}function Y(T,x){const k=n.get(T);if(T.isVideoTexture&&Me(T),T.isRenderTargetTexture===!1&&T.version>0&&k.__version!==T.version){const q=T.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{X(k,T,x);return}}t.bindTexture(s.TEXTURE_2D,k.__webglTexture,s.TEXTURE0+x)}function H(T,x){const k=n.get(T);if(T.version>0&&k.__version!==T.version){X(k,T,x);return}t.bindTexture(s.TEXTURE_2D_ARRAY,k.__webglTexture,s.TEXTURE0+x)}function J(T,x){const k=n.get(T);if(T.version>0&&k.__version!==T.version){X(k,T,x);return}t.bindTexture(s.TEXTURE_3D,k.__webglTexture,s.TEXTURE0+x)}function F(T,x){const k=n.get(T);if(T.version>0&&k.__version!==T.version){ee(k,T,x);return}t.bindTexture(s.TEXTURE_CUBE_MAP,k.__webglTexture,s.TEXTURE0+x)}const K={[Ii]:s.REPEAT,[en]:s.CLAMP_TO_EDGE,[Js]:s.MIRRORED_REPEAT},ne={[Rt]:s.NEAREST,[Xl]:s.NEAREST_MIPMAP_NEAREST,[es]:s.NEAREST_MIPMAP_LINEAR,[gt]:s.LINEAR,[Ws]:s.LINEAR_MIPMAP_NEAREST,[tn]:s.LINEAR_MIPMAP_LINEAR},me={[bh]:s.NEVER,[Lh]:s.ALWAYS,[Ah]:s.LESS,[ic]:s.LEQUAL,[wh]:s.EQUAL,[Ph]:s.GEQUAL,[Rh]:s.GREATER,[Ch]:s.NOTEQUAL};function xe(T,x){if(x.type===Dt&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===gt||x.magFilter===Ws||x.magFilter===es||x.magFilter===tn||x.minFilter===gt||x.minFilter===Ws||x.minFilter===es||x.minFilter===tn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(T,s.TEXTURE_WRAP_S,K[x.wrapS]),s.texParameteri(T,s.TEXTURE_WRAP_T,K[x.wrapT]),(T===s.TEXTURE_3D||T===s.TEXTURE_2D_ARRAY)&&s.texParameteri(T,s.TEXTURE_WRAP_R,K[x.wrapR]),s.texParameteri(T,s.TEXTURE_MAG_FILTER,ne[x.magFilter]),s.texParameteri(T,s.TEXTURE_MIN_FILTER,ne[x.minFilter]),x.compareFunction&&(s.texParameteri(T,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(T,s.TEXTURE_COMPARE_FUNC,me[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===Rt||x.minFilter!==es&&x.minFilter!==tn||x.type===Dt&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const k=e.get("EXT_texture_filter_anisotropic");s.texParameterf(T,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,i.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function ye(T,x){let k=!1;T.__webglInit===void 0&&(T.__webglInit=!0,x.addEventListener("dispose",P));const q=x.source;let Z=d.get(q);Z===void 0&&(Z={},d.set(q,Z));const j=O(x);if(j!==T.__cacheKey){Z[j]===void 0&&(Z[j]={texture:s.createTexture(),usedTimes:0},a.memory.textures++,k=!0),Z[j].usedTimes++;const _e=Z[T.__cacheKey];_e!==void 0&&(Z[T.__cacheKey].usedTimes--,_e.usedTimes===0&&y(x)),T.__cacheKey=j,T.__webglTexture=Z[j].texture}return k}function X(T,x,k){let q=s.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(q=s.TEXTURE_2D_ARRAY),x.isData3DTexture&&(q=s.TEXTURE_3D);const Z=ye(T,x),j=x.source;t.bindTexture(q,T.__webglTexture,s.TEXTURE0+k);const _e=n.get(j);if(j.version!==_e.__version||Z===!0){t.activeTexture(s.TEXTURE0+k);const oe=Ge.getPrimaries(Ge.workingColorSpace),ue=x.colorSpace===On?null:Ge.getPrimaries(x.colorSpace),We=x.colorSpace===On||oe===ue?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,We);let te=_(x.image,!1,i.maxTextureSize);te=it(x,te);const de=r.convert(x.format,x.colorSpace),be=r.convert(x.type);let we=E(x.internalFormat,de,be,x.colorSpace,x.isVideoTexture);xe(q,x);let fe;const Ve=x.mipmaps,Ne=x.isVideoTexture!==!0,nt=_e.__version===void 0||Z===!0,D=j.dataReady,se=L(x,te);if(x.isDepthTexture)we=S(x.format===Ni,x.type),nt&&(Ne?t.texStorage2D(s.TEXTURE_2D,1,we,te.width,te.height):t.texImage2D(s.TEXTURE_2D,0,we,te.width,te.height,0,de,be,null));else if(x.isDataTexture)if(Ve.length>0){Ne&&nt&&t.texStorage2D(s.TEXTURE_2D,se,we,Ve[0].width,Ve[0].height);for(let W=0,$=Ve.length;W<$;W++)fe=Ve[W],Ne?D&&t.texSubImage2D(s.TEXTURE_2D,W,0,0,fe.width,fe.height,de,be,fe.data):t.texImage2D(s.TEXTURE_2D,W,we,fe.width,fe.height,0,de,be,fe.data);x.generateMipmaps=!1}else Ne?(nt&&t.texStorage2D(s.TEXTURE_2D,se,we,te.width,te.height),D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,te.width,te.height,de,be,te.data)):t.texImage2D(s.TEXTURE_2D,0,we,te.width,te.height,0,de,be,te.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Ne&&nt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,se,we,Ve[0].width,Ve[0].height,te.depth);for(let W=0,$=Ve.length;W<$;W++)if(fe=Ve[W],x.format!==Gt)if(de!==null)if(Ne){if(D)if(x.layerUpdates.size>0){const ce=ll(fe.width,fe.height,x.format,x.type);for(const le of x.layerUpdates){const De=fe.data.subarray(le*ce/fe.data.BYTES_PER_ELEMENT,(le+1)*ce/fe.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,W,0,0,le,fe.width,fe.height,1,de,De)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,W,0,0,0,fe.width,fe.height,te.depth,de,fe.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,W,we,fe.width,fe.height,te.depth,0,fe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?D&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,W,0,0,0,fe.width,fe.height,te.depth,de,be,fe.data):t.texImage3D(s.TEXTURE_2D_ARRAY,W,we,fe.width,fe.height,te.depth,0,de,be,fe.data)}else{Ne&&nt&&t.texStorage2D(s.TEXTURE_2D,se,we,Ve[0].width,Ve[0].height);for(let W=0,$=Ve.length;W<$;W++)fe=Ve[W],x.format!==Gt?de!==null?Ne?D&&t.compressedTexSubImage2D(s.TEXTURE_2D,W,0,0,fe.width,fe.height,de,fe.data):t.compressedTexImage2D(s.TEXTURE_2D,W,we,fe.width,fe.height,0,fe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?D&&t.texSubImage2D(s.TEXTURE_2D,W,0,0,fe.width,fe.height,de,be,fe.data):t.texImage2D(s.TEXTURE_2D,W,we,fe.width,fe.height,0,de,be,fe.data)}else if(x.isDataArrayTexture)if(Ne){if(nt&&t.texStorage3D(s.TEXTURE_2D_ARRAY,se,we,te.width,te.height,te.depth),D)if(x.layerUpdates.size>0){const W=ll(te.width,te.height,x.format,x.type);for(const $ of x.layerUpdates){const ce=te.data.subarray($*W/te.data.BYTES_PER_ELEMENT,($+1)*W/te.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,$,te.width,te.height,1,de,be,ce)}x.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,te.width,te.height,te.depth,de,be,te.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,we,te.width,te.height,te.depth,0,de,be,te.data);else if(x.isData3DTexture)Ne?(nt&&t.texStorage3D(s.TEXTURE_3D,se,we,te.width,te.height,te.depth),D&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,te.width,te.height,te.depth,de,be,te.data)):t.texImage3D(s.TEXTURE_3D,0,we,te.width,te.height,te.depth,0,de,be,te.data);else if(x.isFramebufferTexture){if(nt)if(Ne)t.texStorage2D(s.TEXTURE_2D,se,we,te.width,te.height);else{let W=te.width,$=te.height;for(let ce=0;ce<se;ce++)t.texImage2D(s.TEXTURE_2D,ce,we,W,$,0,de,be,null),W>>=1,$>>=1}}else if(Ve.length>0){if(Ne&&nt){const W=ve(Ve[0]);t.texStorage2D(s.TEXTURE_2D,se,we,W.width,W.height)}for(let W=0,$=Ve.length;W<$;W++)fe=Ve[W],Ne?D&&t.texSubImage2D(s.TEXTURE_2D,W,0,0,de,be,fe):t.texImage2D(s.TEXTURE_2D,W,we,de,be,fe);x.generateMipmaps=!1}else if(Ne){if(nt){const W=ve(te);t.texStorage2D(s.TEXTURE_2D,se,we,W.width,W.height)}D&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,de,be,te)}else t.texImage2D(s.TEXTURE_2D,0,we,de,be,te);m(x)&&f(q),_e.__version=j.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function ee(T,x,k){if(x.image.length!==6)return;const q=ye(T,x),Z=x.source;t.bindTexture(s.TEXTURE_CUBE_MAP,T.__webglTexture,s.TEXTURE0+k);const j=n.get(Z);if(Z.version!==j.__version||q===!0){t.activeTexture(s.TEXTURE0+k);const _e=Ge.getPrimaries(Ge.workingColorSpace),oe=x.colorSpace===On?null:Ge.getPrimaries(x.colorSpace),ue=x.colorSpace===On||_e===oe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,ue);const We=x.isCompressedTexture||x.image[0].isCompressedTexture,te=x.image[0]&&x.image[0].isDataTexture,de=[];for(let $=0;$<6;$++)!We&&!te?de[$]=_(x.image[$],!0,i.maxCubemapSize):de[$]=te?x.image[$].image:x.image[$],de[$]=it(x,de[$]);const be=de[0],we=r.convert(x.format,x.colorSpace),fe=r.convert(x.type),Ve=E(x.internalFormat,we,fe,x.colorSpace),Ne=x.isVideoTexture!==!0,nt=j.__version===void 0||q===!0,D=Z.dataReady;let se=L(x,be);xe(s.TEXTURE_CUBE_MAP,x);let W;if(We){Ne&&nt&&t.texStorage2D(s.TEXTURE_CUBE_MAP,se,Ve,be.width,be.height);for(let $=0;$<6;$++){W=de[$].mipmaps;for(let ce=0;ce<W.length;ce++){const le=W[ce];x.format!==Gt?we!==null?Ne?D&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,0,0,le.width,le.height,we,le.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,Ve,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,0,0,le.width,le.height,we,fe,le.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce,Ve,le.width,le.height,0,we,fe,le.data)}}}else{if(W=x.mipmaps,Ne&&nt){W.length>0&&se++;const $=ve(de[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,se,Ve,$.width,$.height)}for(let $=0;$<6;$++)if(te){Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,de[$].width,de[$].height,we,fe,de[$].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ve,de[$].width,de[$].height,0,we,fe,de[$].data);for(let ce=0;ce<W.length;ce++){const De=W[ce].image[$].image;Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,0,0,De.width,De.height,we,fe,De.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,Ve,De.width,De.height,0,we,fe,De.data)}}else{Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,we,fe,de[$]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Ve,we,fe,de[$]);for(let ce=0;ce<W.length;ce++){const le=W[ce];Ne?D&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,0,0,we,fe,le.image[$]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+$,ce+1,Ve,we,fe,le.image[$])}}}m(x)&&f(s.TEXTURE_CUBE_MAP),j.__version=Z.version,x.onUpdate&&x.onUpdate(x)}T.__version=x.version}function ge(T,x,k,q,Z,j){const _e=r.convert(k.format,k.colorSpace),oe=r.convert(k.type),ue=E(k.internalFormat,_e,oe,k.colorSpace),We=n.get(x),te=n.get(k);if(te.__renderTarget=x,!We.__hasExternalTextures){const de=Math.max(1,x.width>>j),be=Math.max(1,x.height>>j);Z===s.TEXTURE_3D||Z===s.TEXTURE_2D_ARRAY?t.texImage3D(Z,j,ue,de,be,x.depth,0,_e,oe,null):t.texImage2D(Z,j,ue,de,be,0,_e,oe,null)}t.bindFramebuffer(s.FRAMEBUFFER,T),He(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,q,Z,te.__webglTexture,0,ze(x)):(Z===s.TEXTURE_2D||Z>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,q,Z,te.__webglTexture,j),t.bindFramebuffer(s.FRAMEBUFFER,null)}function ae(T,x,k){if(s.bindRenderbuffer(s.RENDERBUFFER,T),x.depthBuffer){const q=x.depthTexture,Z=q&&q.isDepthTexture?q.type:null,j=S(x.stencilBuffer,Z),_e=x.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,oe=ze(x);He(x)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,oe,j,x.width,x.height):k?s.renderbufferStorageMultisample(s.RENDERBUFFER,oe,j,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,j,x.width,x.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,_e,s.RENDERBUFFER,T)}else{const q=x.textures;for(let Z=0;Z<q.length;Z++){const j=q[Z],_e=r.convert(j.format,j.colorSpace),oe=r.convert(j.type),ue=E(j.internalFormat,_e,oe,j.colorSpace),We=ze(x);k&&He(x)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,We,ue,x.width,x.height):He(x)?o.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,We,ue,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,ue,x.width,x.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Te(T,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,T),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=n.get(x.depthTexture);q.__renderTarget=x,(!q.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),Y(x.depthTexture,0);const Z=q.__webglTexture,j=ze(x);if(x.depthTexture.format===wi)He(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0,j):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Z,0);else if(x.depthTexture.format===Ni)He(x)?o.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0,j):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function je(T){const x=n.get(T),k=T.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==T.depthTexture){const q=T.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),q){const Z=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,q.removeEventListener("dispose",Z)};q.addEventListener("dispose",Z),x.__depthDisposeCallback=Z}x.__boundDepthTexture=q}if(T.depthTexture&&!x.__autoAllocateDepthBuffer){if(k)throw new Error("target.depthTexture not supported in Cube render targets");Te(x.__webglFramebuffer,T)}else if(k){x.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer[q]),x.__webglDepthbuffer[q]===void 0)x.__webglDepthbuffer[q]=s.createRenderbuffer(),ae(x.__webglDepthbuffer[q],T,!1);else{const Z=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,j=x.__webglDepthbuffer[q];s.bindRenderbuffer(s.RENDERBUFFER,j),s.framebufferRenderbuffer(s.FRAMEBUFFER,Z,s.RENDERBUFFER,j)}}else if(t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=s.createRenderbuffer(),ae(x.__webglDepthbuffer,T,!1);else{const q=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Z=x.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,Z),s.framebufferRenderbuffer(s.FRAMEBUFFER,q,s.RENDERBUFFER,Z)}t.bindFramebuffer(s.FRAMEBUFFER,null)}function Ae(T,x,k){const q=n.get(T);x!==void 0&&ge(q.__webglFramebuffer,T,T.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),k!==void 0&&je(T)}function ct(T){const x=T.texture,k=n.get(T),q=n.get(x);T.addEventListener("dispose",R);const Z=T.textures,j=T.isWebGLCubeRenderTarget===!0,_e=Z.length>1;if(_e||(q.__webglTexture===void 0&&(q.__webglTexture=s.createTexture()),q.__version=x.version,a.memory.textures++),j){k.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer[oe]=[];for(let ue=0;ue<x.mipmaps.length;ue++)k.__webglFramebuffer[oe][ue]=s.createFramebuffer()}else k.__webglFramebuffer[oe]=s.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){k.__webglFramebuffer=[];for(let oe=0;oe<x.mipmaps.length;oe++)k.__webglFramebuffer[oe]=s.createFramebuffer()}else k.__webglFramebuffer=s.createFramebuffer();if(_e)for(let oe=0,ue=Z.length;oe<ue;oe++){const We=n.get(Z[oe]);We.__webglTexture===void 0&&(We.__webglTexture=s.createTexture(),a.memory.textures++)}if(T.samples>0&&He(T)===!1){k.__webglMultisampledFramebuffer=s.createFramebuffer(),k.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const ue=Z[oe];k.__webglColorRenderbuffer[oe]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,k.__webglColorRenderbuffer[oe]);const We=r.convert(ue.format,ue.colorSpace),te=r.convert(ue.type),de=E(ue.internalFormat,We,te,ue.colorSpace,T.isXRRenderTarget===!0),be=ze(T);s.renderbufferStorageMultisample(s.RENDERBUFFER,be,de,T.width,T.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+oe,s.RENDERBUFFER,k.__webglColorRenderbuffer[oe])}s.bindRenderbuffer(s.RENDERBUFFER,null),T.depthBuffer&&(k.__webglDepthRenderbuffer=s.createRenderbuffer(),ae(k.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(j){t.bindTexture(s.TEXTURE_CUBE_MAP,q.__webglTexture),xe(s.TEXTURE_CUBE_MAP,x);for(let oe=0;oe<6;oe++)if(x.mipmaps&&x.mipmaps.length>0)for(let ue=0;ue<x.mipmaps.length;ue++)ge(k.__webglFramebuffer[oe][ue],T,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ue);else ge(k.__webglFramebuffer[oe],T,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(x)&&f(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(_e){for(let oe=0,ue=Z.length;oe<ue;oe++){const We=Z[oe],te=n.get(We);t.bindTexture(s.TEXTURE_2D,te.__webglTexture),xe(s.TEXTURE_2D,We),ge(k.__webglFramebuffer,T,We,s.COLOR_ATTACHMENT0+oe,s.TEXTURE_2D,0),m(We)&&f(s.TEXTURE_2D)}t.unbindTexture()}else{let oe=s.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(oe=T.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(oe,q.__webglTexture),xe(oe,x),x.mipmaps&&x.mipmaps.length>0)for(let ue=0;ue<x.mipmaps.length;ue++)ge(k.__webglFramebuffer[ue],T,x,s.COLOR_ATTACHMENT0,oe,ue);else ge(k.__webglFramebuffer,T,x,s.COLOR_ATTACHMENT0,oe,0);m(x)&&f(oe),t.unbindTexture()}T.depthBuffer&&je(T)}function rt(T){const x=T.textures;for(let k=0,q=x.length;k<q;k++){const Z=x[k];if(m(Z)){const j=b(T),_e=n.get(Z).__webglTexture;t.bindTexture(j,_e),f(j),t.unbindTexture()}}}const ke=[],C=[];function Bt(T){if(T.samples>0){if(He(T)===!1){const x=T.textures,k=T.width,q=T.height;let Z=s.COLOR_BUFFER_BIT;const j=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,_e=n.get(T),oe=x.length>1;if(oe)for(let ue=0;ue<x.length;ue++)t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ue,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ue,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,_e.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglFramebuffer);for(let ue=0;ue<x.length;ue++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=s.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=s.STENCIL_BUFFER_BIT)),oe){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,_e.__webglColorRenderbuffer[ue]);const We=n.get(x[ue]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,We,0)}s.blitFramebuffer(0,0,k,q,0,0,k,q,Z,s.NEAREST),l===!0&&(ke.length=0,C.length=0,ke.push(s.COLOR_ATTACHMENT0+ue),T.depthBuffer&&T.resolveDepthBuffer===!1&&(ke.push(j),C.push(j),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,C)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,ke))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),oe)for(let ue=0;ue<x.length;ue++){t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+ue,s.RENDERBUFFER,_e.__webglColorRenderbuffer[ue]);const We=n.get(x[ue]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,_e.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+ue,s.TEXTURE_2D,We,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,_e.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const x=T.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[x])}}}function ze(T){return Math.min(i.maxSamples,T.samples)}function He(T){const x=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Me(T){const x=a.render.frame;h.get(T)!==x&&(h.set(T,x),T.update())}function it(T,x){const k=T.colorSpace,q=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||k!==Et&&k!==On&&(Ge.getTransfer(k)===et?(q!==Gt||Z!==wn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",k)),x}function ve(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=B,this.resetTextureUnits=G,this.setTexture2D=Y,this.setTexture2DArray=H,this.setTexture3D=J,this.setTextureCube=F,this.rebindTextures=Ae,this.setupRenderTarget=ct,this.updateRenderTargetMipmap=rt,this.updateMultisampleRenderTarget=Bt,this.setupDepthRenderbuffer=je,this.setupFrameBufferTexture=ge,this.useMultisampledRTT=He}function jg(s,e){function t(n,i=On){let r;const a=Ge.getTransfer(i);if(n===wn)return s.UNSIGNED_BYTE;if(n===Ba)return s.UNSIGNED_SHORT_4_4_4_4;if(n===ka)return s.UNSIGNED_SHORT_5_5_5_1;if(n===ql)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Yl)return s.BYTE;if(n===jl)return s.SHORT;if(n===rs)return s.UNSIGNED_SHORT;if(n===Oa)return s.INT;if(n===ii)return s.UNSIGNED_INT;if(n===Dt)return s.FLOAT;if(n===Sn)return s.HALF_FLOAT;if(n===$l)return s.ALPHA;if(n===Kl)return s.RGB;if(n===Gt)return s.RGBA;if(n===Zl)return s.LUMINANCE;if(n===Jl)return s.LUMINANCE_ALPHA;if(n===wi)return s.DEPTH_COMPONENT;if(n===Ni)return s.DEPTH_STENCIL;if(n===za)return s.RED;if(n===Ha)return s.RED_INTEGER;if(n===Ql)return s.RG;if(n===Va)return s.RG_INTEGER;if(n===Ga)return s.RGBA_INTEGER;if(n===Xs||n===Ys||n===js||n===qs)if(a===et)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Xs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Xs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Ys)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===qs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===na||n===ia||n===sa||n===ra)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===na)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ia)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===sa)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===ra)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===aa||n===oa||n===la)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===aa||n===oa)return a===et?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===la)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===ca||n===ha||n===ua||n===da||n===fa||n===pa||n===ma||n===ga||n===_a||n===xa||n===va||n===Ma||n===ya||n===Sa)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===ca)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===ha)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===ua)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===da)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===fa)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===pa)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ma)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===ga)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===_a)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===xa)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===va)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ma)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ya)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Sa)return a===et?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===$s||n===Ea||n===Ta)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===$s)return a===et?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ea)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Ta)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ec||n===ba||n===Aa||n===wa)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===$s)return r.COMPRESSED_RED_RGTC1_EXT;if(n===ba)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Aa)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===wa)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ui?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}const qg=`
void main() {
...
}`;class Kg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const i=new _t,r=e.properties.get(i);r.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Hn({vertexShader:qg,fragmentShader:$g,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ot(new sr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Zg extends ri{constructor(e,t){super();const n=this;let i=null,r=1,a=null,o="local-floor",l=1,c=null,h=null,u=null,d=null,p=null,g=null;const _=new Kg,m=t.getContextAttributes();let f=null,b=null;const E=[],S=[],L=new Ce;let P=null;const R=new wt;R.viewport=new qe;const w=new wt;w.viewport=new qe;const y=[R,w],v=new od;let A=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(X){let ee=E[X];return ee===void 0&&(ee=new Rr,E[X]=ee),ee.getTargetRaySpace()},this.getControllerGrip=function(X){let ee=E[X];return ee===void 0&&(ee=new Rr,E[X]=ee),ee.getGripSpace()},this.getHand=function(X){let ee=E[X];return ee===void 0&&(ee=new Rr,E[X]=ee),ee.getHandSpace()};function B(X){const ee=S.indexOf(X.inputSource);if(ee===-1)return;const ge=E[ee];ge!==void 0&&(ge.update(X.inputSource,X.frame,c||a),ge.dispatchEvent({type:X.type,data:X.inputSource}))}function O(){i.removeEventListener("select",B),i.removeEventListener("selectstart",B),i.removeEventListener("selectend",B),i.removeEventListener("squeeze",B),i.removeEventListener("squeezestart",B),i.removeEventListener("squeezeend",B),i.removeEventListener("end",O),i.removeEventListener("inputsourceschange",Y);for(let X=0;X<E.length;X++){const ee=S[X];ee!==null&&(S[X]=null,E[X].disconnect(ee))}A=null,G=null,_.reset(),e.setRenderTarget(f),p=null,d=null,u=null,i=null,b=null,ye.stop(),n.isPresenting=!1,e.setPixelRatio(P),e.setSize(L.width,L.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(X){r=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(X){o=X,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(X){c=X},this.getBaseLayer=function(){return d!==null?d:p},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(X){if(i=X,i!==null){if(f=e.getRenderTarget(),i.addEventListener("select",B),i.addEventListener("selectstart",B),i.addEventListener("selectend",B),i.addEventListener("squeeze",B),i.addEventListener("squeezestart",B),i.addEventListener("squeezeend",B),i.addEventListener("end",O),i.addEventListener("inputsourceschange",Y),m.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(L),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let ge=null,ae=null,Te=null;m.depth&&(Te=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ge=m.stencil?Ni:wi,ae=m.stencil?Ui:ii);const je={colorFormat:t.RGBA8,depthFormat:Te,scaleFactor:r};u=new XRWebGLBinding(i,t),d=u.createProjectionLayer(je),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),b=new si(d.textureWidth,d.textureHeight,{format:Gt,type:wn,depthTexture:new _c(d.textureWidth,d.textureHeight,ae,void 0,void 0,void 0,void 0,void 0,void 0,ge),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const ge={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:r};p=new XRWebGLLayer(i,t,ge),i.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),b=new si(p.framebufferWidth,p.framebufferHeight,{format:Gt,type:wn,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}b.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await i.requestReferenceSpace(o),ye.setContext(i),ye.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function Y(X){for(let ee=0;ee<X.removed.length;ee++){const ge=X.removed[ee],ae=S.indexOf(ge);ae>=0&&(S[ae]=null,E[ae].disconnect(ge))}for(let ee=0;ee<X.added.length;ee++){const ge=X.added[ee];let ae=S.indexOf(ge);if(ae===-1){for(let je=0;je<E.length;je++)if(je>=S.length){S.push(ge),ae=je;break}else if(S[je]===null){S[je]=ge,ae=je;break}if(ae===-1)break}const Te=E[ae];Te&&Te.connect(ge)}}const H=new I,J=new I;function F(X,ee,ge){H.setFromMatrixPosition(ee.matrixWorld),J.setFromMatrixPosition(ge.matrixWorld);const ae=H.distanceTo(J),Te=ee.projectionMatrix.elements,je=ge.projectionMatrix.elements,Ae=Te[14]/(Te[10]-1),ct=Te[14]/(Te[10]+1),rt=(Te[9]+1)/Te[5],ke=(Te[9]-1)/Te[5],C=(Te[8]-1)/Te[0],Bt=(je[8]+1)/je[0],ze=Ae*C,He=Ae*Bt,Me=ae/(-C+Bt),it=Me*-C;if(ee.matrixWorld.decompose(X.position,X.quaternion,X.scale),X.translateX(it),X.translateZ(Me),X.matrixWorld.compose(X.position,X.quaternion,X.scale),X.matrixWorldInverse.copy(X.matrixWorld).invert(),Te[10]===-1)X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse);else{const ve=Ae+Me,T=ct+Me,x=ze-it,k=He+(ae-it),q=rt*ct/T*ve,Z=ke*ct/T*ve;X.projectionMatrix.makePerspective(x,k,q,Z,ve,T),X.projectionMatrixInverse.copy(X.projectionMatrix).invert()}}function K(X,ee){ee===null?X.matrixWorld.copy(X.matrix):X.matrixWorld.multiplyMatrices(ee.matrixWorld,X.matrix),X.matrixWorldInverse.copy(X.matrixWorld).invert()}this.updateCamera=function(X){if(i===null)return;let ee=X.near,ge=X.far;_.texture!==null&&(_.depthNear>0&&(ee=_.depthNear),_.depthFar>0&&(ge=_.depthFar)),v.near=w.near=R.near=ee,v.far=w.far=R.far=ge,(A!==v.near||G!==v.far)&&(i.updateRenderState({depthNear:v.near,depthFar:v.far}),A=v.near,G=v.far),R.layers.mask=X.layers.mask|2,w.layers.mask=X.layers.mask|4,v.layers.mask=R.layers.mask|w.layers.mask;const ae=X.parent,Te=v.cameras;K(v,ae);for(let je=0;je<Te.length;je++)K(Te[je],ae);Te.length===2?F(v,R,w):v.projectionMatrix.copy(R.projectionMatrix),ne(X,v,ae)};function ne(X,ee,ge){ge===null?X.matrix.copy(ee.matrixWorld):(X.matrix.copy(ge.matrixWorld),X.matrix.invert(),X.matrix.multiply(ee.matrixWorld)),X.matrix.decompose(X.position,X.quaternion,X.scale),X.updateMatrixWorld(!0),X.projectionMatrix.copy(ee.projectionMatrix),X.projectionMatrixInverse.copy(ee.projectionMatrixInverse),X.isPerspectiveCamera&&(X.fov=Fi*2*Math.atan(1/X.projectionMatrix.elements[5]),X.zoom=1)}this.getCamera=function(){return v},this.getFoveation=function(){if(!(d===null&&p===null))return l},this.setFoveation=function(X){l=X,d!==null&&(d.fixedFoveation=X),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=X)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(v)};let me=null;function xe(X,ee){if(h=ee.getViewerPose(c||a),g=ee,h!==null){const ge=h.views;p!==null&&(e.setRenderTargetFramebuffer(b,p.framebuffer),e.setRenderTarget(b));let ae=!1;ge.length!==v.cameras.length&&(v.cameras.length=0,ae=!0);for(let Ae=0;Ae<ge.length;Ae++){const ct=ge[Ae];let rt=null;if(p!==null)rt=p.getViewport(ct);else{const C=u.getViewSubImage(d,ct);rt=C.viewport,Ae===0&&(e.setRenderTargetTextures(b,C.colorTexture,d.ignoreDepthValues?void 0:C.depthStencilTexture),e.setRenderTarget(b))}let ke=y[Ae];ke===void 0&&(ke=new wt,ke.layers.enable(Ae),ke.viewport=new qe,y[Ae]=ke),ke.matrix.fromArray(ct.transform.matrix),ke.matrix.decompose(ke.position,ke.quaternion,ke.scale),ke.projectionMatrix.fromArray(ct.projectionMatrix),ke.projectionMatrixInverse.copy(ke.projectionMatrix).invert(),ke.viewport.set(rt.x,rt.y,rt.width,rt.height),Ae===0&&(v.matrix.copy(ke.matrix),v.matrix.decompose(v.position,v.quaternion,v.scale)),ae===!0&&v.cameras.push(ke)}const Te=i.enabledFeatures;if(Te&&Te.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&u){const Ae=u.getDepthInformation(ge[0]);Ae&&Ae.isValid&&Ae.texture&&_.init(e,Ae,i.renderState)}}for(let ge=0;ge<E.length;ge++){const ae=S[ge],Te=E[ge];ae!==null&&Te!==void 0&&Te.update(ae,ee,c||a)}me&&me(X,ee),ee.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ee}),g=null}const ye=new Mc;ye.setAnimationLoop(xe),this.setAnimationLoop=function(X){me=X},this.dispose=function(){}}}const $n=new an,Jg=new Ue;function Qg(s,e){function t(m,f){m.matrixAutoUpdate===!0&&m.updateMatrix(),f.value.copy(m.matrix)}function n(m,f){f.color.getRGB(m.fogColor.value,uc(s)),f.isFog?(m.fogNear.value=f.near,m.fogFar.value=f.far):f.isFogExp2&&(m.fogDensity.value=f.density)}function i(m,f,b,E,S){f.isMeshBasicMaterial||f.isMeshLambertMaterial?r(m,f):f.isMeshToonMaterial?(r(m,f),u(m,f)):f.isMeshPhongMaterial?(r(m,f),h(m,f)):f.isMeshStandardMaterial?(r(m,f),d(m,f),f.isMeshPhysicalMaterial&&p(m,f,S)):f.isMeshMatcapMaterial?(r(m,f),g(m,f)):f.isMeshDepthMaterial?r(m,f):f.isMeshDistanceMaterial?(r(m,f),_(m,f)):f.isMeshNormalMaterial?r(m,f):f.isLineBasicMaterial?(a(m,f),f.isLineDashedMaterial&&o(m,f)):f.isPointsMaterial?l(m,f,b,E):f.isSpriteMaterial?c(m,f):f.isShadowMaterial?(m.color.value.copy(f.color),m.opacity.value=f.opacity):f.isShaderMaterial&&(f.uniformsNeedUpdate=!1)}function r(m,f){m.opacity.value=f.opacity,f.color&&m.diffuse.value.copy(f.color),f.emissive&&m.emissive.value.copy(f.emissive).multiplyScalar(f.emissiveIntensity),f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.bumpMap&&(m.bumpMap.value=f.bumpMap,t(f.bumpMap,m.bumpMapTransform),m.bumpScale.value=f.bumpScale,f.side===It&&(m.bumpScale.value*=-1)),f.normalMap&&(m.normalMap.value=f.normalMap,t(f.normalMap,m.normalMapTransform),m.normalScale.value.copy(f.normalScale),f.side===It&&m.normalScale.value.negate()),f.displacementMap&&(m.displacementMap.value=f.displacementMap,t(f.displacementMap,m.displacementMapTransform),m.displacementScale.value=f.displacementScale,m.displacementBias.value=f.displacementBias),f.emissiveMap&&(m.emissiveMap.value=f.emissiveMap,t(f.emissiveMap,m.emissiveMapTransform)),f.specularMap&&(m.specularMap.value=f.specularMap,t(f.specularMap,m.specularMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest);const b=e.get(f),E=b.envMap,S=b.envMapRotation;E&&(m.envMap.value=E,$n.copy(S),$n.x*=-1,$n.y*=-1,$n.z*=-1,E.isCubeTexture&&E.isRenderTargetTexture===!1&&($n.y*=-1,$n.z*=-1),m.envMapRotation.value.setFromMatrix4(Jg.makeRotationFromEuler($n)),m.flipEnvMap.value=E.isCubeTexture&&E.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=f.reflectivity,m.ior.value=f.ior,m.refractionRatio.value=f.refractionRatio),f.lightMap&&(m.lightMap.value=f.lightMap,m.lightMapIntensity.value=f.lightMapIntensity,t(f.lightMap,m.lightMapTransform)),f.aoMap&&(m.aoMap.value=f.aoMap,m.aoMapIntensity.value=f.aoMapIntensity,t(f.aoMap,m.aoMapTransform))}function a(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform))}function o(m,f){m.dashSize.value=f.dashSize,m.totalSize.value=f.dashSize+f.gapSize,m.scale.value=f.scale}function l(m,f,b,E){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.size.value=f.size*b,m.scale.value=E*.5,f.map&&(m.map.value=f.map,t(f.map,m.uvTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function c(m,f){m.diffuse.value.copy(f.color),m.opacity.value=f.opacity,m.rotation.value=f.rotation,f.map&&(m.map.value=f.map,t(f.map,m.mapTransform)),f.alphaMap&&(m.alphaMap.value=f.alphaMap,t(f.alphaMap,m.alphaMapTransform)),f.alphaTest>0&&(m.alphaTest.value=f.alphaTest)}function h(m,f){m.specular.value.copy(f.specular),m.shininess.value=Math.max(f.shininess,1e-4)}function u(m,f){f.gradientMap&&(m.gradientMap.value=f.gradientMap)}function d(m,f){m.metalness.value=f.metalness,f.metalnessMap&&(m.metalnessMap.value=f.metalnessMap,t(f.metalnessMap,m.metalnessMapTransform)),m.roughness.value=f.roughness,f.roughnessMap&&(m.roughnessMap.value=f.roughnessMap,t(f.roughnessMap,m.roughnessMapTransform)),f.envMap&&(m.envMapIntensity.value=f.envMapIntensity)}function p(m,f,b){m.ior.value=f.ior,f.sheen>0&&(m.sheenColor.value.copy(f.sheenColor).multiplyScalar(f.sheen),m.sheenRoughness.value=f.sheenRoughness,f.sheenColorMap&&(m.sheenColorMap.value=f.sheenColorMap,t(f.sheenColorMap,m.sheenColorMapTransform)),f.sheenRoughnessMap&&(m.sheenRoughnessMap.value=f.sheenRoughnessMap,t(f.sheenRoughnessMap,m.sheenRoughnessMapTransform))),f.clearcoat>0&&(m.clearcoat.value=f.clearcoat,m.clearcoatRoughness.value=f.clearcoatRoughness,f.clearcoatMap&&(m.clearcoatMap.value=f.clearcoatMap,t(f.clearcoatMap,m.clearcoatMapTransform)),f.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=f.clearcoatRoughnessMap,t(f.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),f.clearcoatNormalMap&&(m.clearcoatNormalMap.value=f.clearcoatNormalMap,t(f.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(f.clearcoatNormalScale),f.side===It&&m.clearcoatNormalScale.value.negate())),f.dispersion>0&&(m.dispersion.value=f.dispersion),f.iridescence>0&&(m.iridescence.value=f.iridescence,m.iridescenceIOR.value=f.iridescenceIOR,m.iridescenceThicknessMinimum.value=f.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=f.iridescenceThicknessRange[1],f.iridescenceMap&&(m.iridescenceMap.value=f.iridescenceMap,t(f.iridescenceMap,m.iridescenceMapTransform)),f.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=f.iridescenceThicknessMap,t(f.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),f.transmission>0&&(m.transmission.value=f.transmission,m.transmissionSamplerMap.value=b.texture,m.transmissionSamplerSize.value.set(b.width,b.height),f.transmissionMap&&(m.transmissionMap.value=f.transmissionMap,t(f.transmissionMap,m.transmissionMapTransform)),m.thickness.value=f.thickness,f.thicknessMap&&(m.thicknessMap.value=f.thicknessMap,t(f.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=f.attenuationDistance,m.attenuationColor.value.copy(f.attenuationColor)),f.anisotropy>0&&(m.anisotropyVector.value.set(f.anisotropy*Math.cos(f.anisotropyRotation),f.anisotropy*Math.sin(f.anisotropyRotation)),f.anisotropyMap&&(m.anisotropyMap.value=f.anisotropyMap,t(f.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=f.specularIntensity,m.specularColor.value.copy(f.specularColor),f.specularColorMap&&(m.specularColorMap.value=f.specularColorMap,t(f.specularColorMap,m.specularColorMapTransform)),f.specularIntensityMap&&(m.specularIntensityMap.value=f.specularIntensityMap,t(f.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,f){f.matcap&&(m.matcap.value=f.matcap)}function _(m,f){const b=e.get(f).light;m.referencePosition.value.setFromMatrixPosition(b.matrixWorld),m.nearDistance.value=b.shadow.camera.near,m.farDistance.value=b.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function e_(s,e,t,n){let i={},r={},a=[];const o=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function l(b,E){const S=E.program;n.uniformBlockBinding(b,S)}function c(b,E){let S=i[b.id];S===void 0&&(g(b),S=h(b),i[b.id]=S,b.addEventListener("dispose",m));const L=E.program;n.updateUBOMapping(b,L);const P=e.render.frame;r[b.id]!==P&&(d(b),r[b.id]=P)}function h(b){const E=u();b.__bindingPointIndex=E;const S=s.createBuffer(),L=b.__size,P=b.usage;return s.bindBuffer(s.UNIFORM_BUFFER,S),s.bufferData(s.UNIFORM_BUFFER,L,P),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,E,S),S}function u(){for(let b=0;b<o;b++)if(a.indexOf(b)===-1)return a.push(b),b;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(b){const E=i[b.id],S=b.uniforms,L=b.__cache;s.bindBuffer(s.UNIFORM_BUFFER,E);for(let P=0,R=S.length;P<R;P++){const w=Array.isArray(S[P])?S[P]:[S[P]];for(let y=0,v=w.length;y<v;y++){const A=w[y];if(p(A,P,y,L)===!0){const G=A.__offset,B=Array.isArray(A.value)?A.value:[A.value];let O=0;for(let Y=0;Y<B.length;Y++){const H=B[Y],J=_(H);typeof H=="number"||typeof H=="boolean"?(A.__data[0]=H,s.bufferSubData(s.UNIFORM_BUFFER,G+O,A.__data)):H.isMatrix3?(A.__data[0]=H.elements[0],A.__data[1]=H.elements[1],A.__data[2]=H.elements[2],A.__data[3]=0,A.__data[4]=H.elements[3],A.__data[5]=H.elements[4],A.__data[6]=H.elements[5],A.__data[7]=0,A.__data[8]=H.elements[6],A.__data[9]=H.elements[7],A.__data[10]=H.elements[8],A.__data[11]=0):(H.toArray(A.__data,O),O+=J.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,G,A.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function p(b,E,S,L){const P=b.value,R=E+"_"+S;if(L[R]===void 0)return typeof P=="number"||typeof P=="boolean"?L[R]=P:L[R]=P.clone(),!0;{const w=L[R];if(typeof P=="number"||typeof P=="boolean"){if(w!==P)return L[R]=P,!0}else if(w.equals(P)===!1)return w.copy(P),!0}return!1}function g(b){const E=b.uniforms;let S=0;const L=16;for(let R=0,w=E.length;R<w;R++){const y=Array.isArray(E[R])?E[R]:[E[R]];for(let v=0,A=y.length;v<A;v++){const G=y[v],B=Array.isArray(G.value)?G.value:[G.value];for(let O=0,Y=B.length;O<Y;O++){const H=B[O],J=_(H),F=S%L,K=F%J.boundary,ne=F+K;S+=K,ne!==0&&L-ne<J.storage&&(S+=L-ne),G.__data=new Float32Array(J.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=S,S+=J.storage}}}const P=S%L;return P>0&&(S+=L-P),b.__size=S,b.__cache={},this}function _(b){const E={boundary:0,storage:0};return typeof b=="number"||typeof b=="boolean"?(E.boundary=4,E.storage=4):b.isVector2?(E.boundary=8,E.storage=8):b.isVector3||b.isColor?(E.boundary=16,E.storage=12):b.isVector4?(E.boundary=16,E.storage=16):b.isMatrix3?(E.boundary=48,E.storage=48):b.isMatrix4?(E.boundary=64,E.storage=64):b.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",b),E}function m(b){const E=b.target;E.removeEventListener("dispose",m);const S=a.indexOf(E.__bindingPointIndex);a.splice(S,1),s.deleteBuffer(i[E.id]),delete i[E.id],delete r[E.id]}function f(){for(const b in i)s.deleteBuffer(i[b]);a=[],i={},r={}}return{bind:l,update:c,dispose:f}}class t_{constructor(e={}){const{canvas:t=qh(),context:n=null,depth:i=!0,stencil:r=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:d=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,f=null;const b=[],E=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=vt,this.toneMapping=zn,this.toneMappingExposure=1;const S=this;let L=!1,P=0,R=0,w=null,y=-1,v=null;const A=new qe,G=new qe;let B=null;const O=new Le(0);let Y=0,H=t.width,J=t.height,F=1,K=null,ne=null;const me=new qe(0,0,H,J),xe=new qe(0,0,H,J);let ye=!1;const X=new $a;let ee=!1,ge=!1;this.transmissionResolutionScale=1;const ae=new Ue,Te=new Ue,je=new I,Ae=new qe,ct={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let rt=!1;function ke(){return w===null?F:1}let C=n;function Bt(M,U){return t.getContext(M,U)}try{const M={alpha:!0,depth:i,stencil:r,antialias:o,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Fa}`),t.addEventListener("webglcontextlost",$,!1),t.addEventListener("webglcontextrestored",ce,!1),t.addEventListener("webglcontextcreationerror",le,!1),C===null){const U="webgl2";if(C=Bt(U,M),C===null)throw Bt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw console.error("THREE.WebGLRenderer: "+M.message),M}let ze,He,Me,it,ve,T,x,k,q,Z,j,_e,oe,ue,We,te,de,be,we,fe,Ve,Ne,nt,D;function se(){ze=new um(C),ze.init(),Ne=new jg(C,ze),He=new sm(C,ze,e,Ne),Me=new Xg(C,ze),He.reverseDepthBuffer&&d&&Me.buffers.depth.setReversed(!0),it=new pm(C),ve=new Dg,T=new Yg(C,ze,Me,ve,He,Ne,it),x=new am(S),k=new hm(S),q=new vd(C),nt=new nm(C,q),Z=new dm(C,q,it,nt),j=new gm(C,Z,q,it),we=new mm(C,He,T),te=new rm(ve),_e=new Lg(S,x,k,ze,He,nt,te),oe=new Qg(S,ve),ue=new Ug,We=new zg(ze),be=new tm(S,x,k,Me,j,p,l),de=new Gg(S,j,He),D=new e_(C,it,He,Me),fe=new im(C,ze,it),Ve=new fm(C,ze,it),it.programs=_e.programs,S.capabilities=He,S.extensions=ze,S.properties=ve,S.renderLists=ue,S.shadowMap=de,S.state=Me,S.info=it}se();const W=new Zg(S,C);this.xr=W,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const M=ze.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=ze.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return F},this.setPixelRatio=function(M){M!==void 0&&(F=M,this.setSize(H,J,!1))},this.getSize=function(M){return M.set(H,J)},this.setSize=function(M,U,z=!0){if(W.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}H=M,J=U,t.width=Math.floor(M*F),t.height=Math.floor(U*F),z===!0&&(t.style.width=M+"px",t.style.height=U+"px"),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(H*F,J*F).floor()},this.setDrawingBufferSize=function(M,U,z){H=M,J=U,F=z,t.width=Math.floor(M*z),t.height=Math.floor(U*z),this.setViewport(0,0,M,U)},this.getCurrentViewport=function(M){return M.copy(A)},this.getViewport=function(M){return M.copy(me)},this.setViewport=function(M,U,z,V){M.isVector4?me.set(M.x,M.y,M.z,M.w):me.set(M,U,z,V),Me.viewport(A.copy(me).multiplyScalar(F).round())},this.getScissor=function(M){return M.copy(xe)},this.setScissor=function(M,U,z,V){M.isVector4?xe.set(M.x,M.y,M.z,M.w):xe.set(M,U,z,V),Me.scissor(G.copy(xe).multiplyScalar(F).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(M){Me.setScissorTest(ye=M)},this.setOpaqueSort=function(M){K=M},this.setTransparentSort=function(M){ne=M},this.getClearColor=function(M){return M.copy(be.getClearColor())},this.setClearColor=function(){be.setClearColor(...arguments)},this.getClearAlpha=function(){return be.getClearAlpha()},this.setClearAlpha=function(){be.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,z=!0){let V=0;if(M){let N=!1;if(w!==null){const Q=w.texture.format;N=Q===Ga||Q===Va||Q===Ha}if(N){const Q=w.texture.type,re=Q===wn||Q===ii||Q===rs||Q===Ui||Q===Ba||Q===ka,he=be.getClearColor(),pe=be.getClearAlpha(),Re=he.r,Pe=he.g,Se=he.b;re?(g[0]=Re,g[1]=Pe,g[2]=Se,g[3]=pe,C.clearBufferuiv(C.COLOR,0,g)):(_[0]=Re,_[1]=Pe,_[2]=Se,_[3]=pe,C.clearBufferiv(C.COLOR,0,_))}else V|=C.COLOR_BUFFER_BIT}U&&(V|=C.DEPTH_BUFFER_BIT),z&&(V|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),C.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",$,!1),t.removeEventListener("webglcontextrestored",ce,!1),t.removeEventListener("webglcontextcreationerror",le,!1),be.dispose(),ue.dispose(),We.dispose(),ve.dispose(),x.dispose(),k.dispose(),j.dispose(),nt.dispose(),D.dispose(),_e.dispose(),W.dispose(),W.removeEventListener("sessionstart",oo),W.removeEventListener("sessionend",lo),Vn.stop()};function $(M){M.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function ce(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const M=it.autoReset,U=de.enabled,z=de.autoUpdate,V=de.needsUpdate,N=de.type;se(),it.autoReset=M,de.enabled=U,de.autoUpdate=z,de.needsUpdate=V,de.type=N}function le(M){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function De(M){const U=M.target;U.removeEventListener("dispose",De),ot(U)}function ot(M){Mt(M),ve.remove(M)}function Mt(M){const U=ve.get(M).programs;U!==void 0&&(U.forEach(function(z){_e.releaseProgram(z)}),M.isShaderMaterial&&_e.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,z,V,N,Q){U===null&&(U=ct);const re=N.isMesh&&N.matrixWorld.determinant()<0,he=Rc(M,U,z,V,N);Me.setMaterial(V,re);let pe=z.index,Re=1;if(V.wireframe===!0){if(pe=Z.getWireframeAttribute(z),pe===void 0)return;Re=2}const Pe=z.drawRange,Se=z.attributes.position;let Xe=Pe.start*Re,$e=(Pe.start+Pe.count)*Re;Q!==null&&(Xe=Math.max(Xe,Q.start*Re),$e=Math.min($e,(Q.start+Q.count)*Re)),pe!==null?(Xe=Math.max(Xe,0),$e=Math.min($e,pe.count)):Se!=null&&(Xe=Math.max(Xe,0),$e=Math.min($e,Se.count));const ht=$e-Xe;if(ht<0||ht===1/0)return;nt.setup(N,V,he,z,pe);let lt,Ye=fe;if(pe!==null&&(lt=q.get(pe),Ye=Ve,Ye.setIndex(lt)),N.isMesh)V.wireframe===!0?(Me.setLineWidth(V.wireframeLinewidth*ke()),Ye.setMode(C.LINES)):Ye.setMode(C.TRIANGLES);else if(N.isLine){let Ee=V.linewidth;Ee===void 0&&(Ee=1),Me.setLineWidth(Ee*ke()),N.isLineSegments?Ye.setMode(C.LINES):N.isLineLoop?Ye.setMode(C.LINE_LOOP):Ye.setMode(C.LINE_STRIP)}else N.isPoints?Ye.setMode(C.POINTS):N.isSprite&&Ye.setMode(C.TRIANGLES);if(N.isBatchedMesh)if(N._multiDrawInstances!==null)Zn("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Ye.renderMultiDrawInstances(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount,N._multiDrawInstances);else if(ze.get("WEBGL_multi_draw"))Ye.renderMultiDraw(N._multiDrawStarts,N._multiDrawCounts,N._multiDrawCount);else{const Ee=N._multiDrawStarts,xt=N._multiDrawCounts,Ke=N._multiDrawCount,Xt=pe?q.get(pe).bytesPerElement:1,oi=ve.get(V).currentProgram.getUniforms();for(let Ut=0;Ut<Ke;Ut++)oi.setValue(C,"_gl_DrawID",Ut),Ye.render(Ee[Ut]/Xt,xt[Ut])}else if(N.isInstancedMesh)Ye.renderInstances(Xe,ht,N.count);else if(z.isInstancedBufferGeometry){const Ee=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,xt=Math.min(z.instanceCount,Ee);Ye.renderInstances(Xe,ht,xt)}else Ye.render(Xe,ht)};function Ze(M,U,z){M.transparent===!0&&M.side===Qt&&M.forceSinglePass===!1?(M.side=It,M.needsUpdate=!0,ps(M,U,z),M.side=An,M.needsUpdate=!0,ps(M,U,z),M.side=Qt):ps(M,U,z)}this.compile=function(M,U,z=null){z===null&&(z=M),f=We.get(z),f.init(U),E.push(f),z.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(f.pushLight(N),N.castShadow&&f.pushShadow(N))}),M!==z&&M.traverseVisible(function(N){N.isLight&&N.layers.test(U.layers)&&(f.pushLight(N),N.castShadow&&f.pushShadow(N))}),f.setupLights();const V=new Set;return M.traverse(function(N){if(!(N.isMesh||N.isPoints||N.isLine||N.isSprite))return;const Q=N.material;if(Q)if(Array.isArray(Q))for(let re=0;re<Q.length;re++){const he=Q[re];Ze(he,z,N),V.add(he)}else Ze(Q,z,N),V.add(Q)}),f=E.pop(),V},this.compileAsync=function(M,U,z=null){const V=this.compile(M,U,z);return new Promise(N=>{function Q(){if(V.forEach(function(re){ve.get(re).currentProgram.isReady()&&V.delete(re)}),V.size===0){N(M);return}setTimeout(Q,10)}ze.get("KHR_parallel_shader_compile")!==null?Q():setTimeout(Q,10)})};let Wt=null;function un(M){Wt&&Wt(M)}function oo(){Vn.stop()}function lo(){Vn.start()}const Vn=new Mc;Vn.setAnimationLoop(un),typeof self<"u"&&Vn.setContext(self),this.setAnimationLoop=function(M){Wt=M,W.setAnimationLoop(M),M===null?Vn.stop():Vn.start()},W.addEventListener("sessionstart",oo),W.addEventListener("sessionend",lo),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),W.enabled===!0&&W.isPresenting===!0&&(W.cameraAutoUpdate===!0&&W.updateCamera(U),U=W.getCamera()),M.isScene===!0&&M.onBeforeRender(S,M,U,w),f=We.get(M,E.length),f.init(U),E.push(f),Te.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),X.setFromProjectionMatrix(Te),ge=this.localClippingEnabled,ee=te.init(this.clippingPlanes,ge),m=ue.get(M,b.length),m.init(),b.push(m),W.enabled===!0&&W.isPresenting===!0){const Q=S.xr.getDepthSensingMesh();Q!==null&&ar(Q,U,-1/0,S.sortObjects)}ar(M,U,0,S.sortObjects),m.finish(),S.sortObjects===!0&&m.sort(K,ne),rt=W.enabled===!1||W.isPresenting===!1||W.hasDepthSensing()===!1,rt&&be.addToRenderList(m,M),this.info.render.frame++,ee===!0&&te.beginShadows();const z=f.state.shadowsArray;de.render(z,M,U),ee===!0&&te.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=m.opaque,N=m.transmissive;if(f.setupLights(),U.isArrayCamera){const Q=U.cameras;if(N.length>0)for(let re=0,he=Q.length;re<he;re++){const pe=Q[re];ho(V,N,M,pe)}rt&&be.render(M);for(let re=0,he=Q.length;re<he;re++){const pe=Q[re];co(m,M,pe,pe.viewport)}}else N.length>0&&ho(V,N,M,U),rt&&be.render(M),co(m,M,U);w!==null&&R===0&&(T.updateMultisampleRenderTarget(w),T.updateRenderTargetMipmap(w)),M.isScene===!0&&M.onAfterRender(S,M,U),nt.resetDefaultState(),y=-1,v=null,E.pop(),E.length>0?(f=E[E.length-1],ee===!0&&te.setGlobalState(S.clippingPlanes,f.state.camera)):f=null,b.pop(),b.length>0?m=b[b.length-1]:m=null};function ar(M,U,z,V){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)z=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLight)f.pushLight(M),M.castShadow&&f.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||X.intersectsSprite(M)){V&&Ae.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Te);const re=j.update(M),he=M.material;he.visible&&m.push(M,re,he,z,Ae.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||X.intersectsObject(M))){const re=j.update(M),he=M.material;if(V&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),Ae.copy(M.boundingSphere.center)):(re.boundingSphere===null&&re.computeBoundingSphere(),Ae.copy(re.boundingSphere.center)),Ae.applyMatrix4(M.matrixWorld).applyMatrix4(Te)),Array.isArray(he)){const pe=re.groups;for(let Re=0,Pe=pe.length;Re<Pe;Re++){const Se=pe[Re],Xe=he[Se.materialIndex];Xe&&Xe.visible&&m.push(M,re,Xe,z,Ae.z,Se)}}else he.visible&&m.push(M,re,he,z,Ae.z,null)}}const Q=M.children;for(let re=0,he=Q.length;re<he;re++)ar(Q[re],U,z,V)}function co(M,U,z,V){const N=M.opaque,Q=M.transmissive,re=M.transparent;f.setupLightsView(z),ee===!0&&te.setGlobalState(S.clippingPlanes,z),V&&Me.viewport(A.copy(V)),N.length>0&&fs(N,U,z),Q.length>0&&fs(Q,U,z),re.length>0&&fs(re,U,z),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function ho(M,U,z,V){if((z.isScene===!0?z.overrideMaterial:null)!==null)return;f.state.transmissionRenderTarget[V.id]===void 0&&(f.state.transmissionRenderTarget[V.id]=new si(1,1,{generateMipmaps:!0,type:ze.has("EXT_color_buffer_half_float")||ze.has("EXT_color_buffer_float")?Sn:wn,minFilter:tn,samples:4,stencilBuffer:r,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ge.workingColorSpace}));const Q=f.state.transmissionRenderTarget[V.id],re=V.viewport||A;Q.setSize(re.z*S.transmissionResolutionScale,re.w*S.transmissionResolutionScale);const he=S.getRenderTarget();S.setRenderTarget(Q),S.getClearColor(O),Y=S.getClearAlpha(),Y<1&&S.setClearColor(16777215,.5),S.clear(),rt&&be.render(z);const pe=S.toneMapping;S.toneMapping=zn;const Re=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),f.setupLightsView(V),ee===!0&&te.setGlobalState(S.clippingPlanes,V),fs(M,z,V),T.updateMultisampleRenderTarget(Q),T.updateRenderTargetMipmap(Q),ze.has("WEBGL_multisampled_render_to_texture")===!1){let Pe=!1;for(let Se=0,Xe=U.length;Se<Xe;Se++){const $e=U[Se],ht=$e.object,lt=$e.geometry,Ye=$e.material,Ee=$e.group;if(Ye.side===Qt&&ht.layers.test(V.layers)){const xt=Ye.side;Ye.side=It,Ye.needsUpdate=!0,uo(ht,z,V,lt,Ye,Ee),Ye.side=xt,Ye.needsUpdate=!0,Pe=!0}}Pe===!0&&(T.updateMultisampleRenderTarget(Q),T.updateRenderTargetMipmap(Q))}S.setRenderTarget(he),S.setClearColor(O,Y),Re!==void 0&&(V.viewport=Re),S.toneMapping=pe}function fs(M,U,z){const V=U.isScene===!0?U.overrideMaterial:null;for(let N=0,Q=M.length;N<Q;N++){const re=M[N],he=re.object,pe=re.geometry,Re=V===null?re.material:V,Pe=re.group;he.layers.test(z.layers)&&uo(he,U,z,pe,Re,Pe)}}function uo(M,U,z,V,N,Q){M.onBeforeRender(S,U,z,V,N,Q),M.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),N.onBeforeRender(S,U,z,V,M,Q),N.transparent===!0&&N.side===Qt&&N.forceSinglePass===!1?(N.side=It,N.needsUpdate=!0,S.renderBufferDirect(z,U,V,N,M,Q),N.side=An,N.needsUpdate=!0,S.renderBufferDirect(z,U,V,N,M,Q),N.side=Qt):S.renderBufferDirect(z,U,V,N,M,Q),M.onAfterRender(S,U,z,V,N,Q)}function ps(M,U,z){U.isScene!==!0&&(U=ct);const V=ve.get(M),N=f.state.lights,Q=f.state.shadowsArray,re=N.state.version,he=_e.getParameters(M,N.state,Q,U,z),pe=_e.getProgramCacheKey(he);let Re=V.programs;V.environment=M.isMeshStandardMaterial?U.environment:null,V.fog=U.fog,V.envMap=(M.isMeshStandardMaterial?k:x).get(M.envMap||V.environment),V.envMapRotation=V.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Re===void 0&&(M.addEventListener("dispose",De),Re=new Map,V.programs=Re);let Pe=Re.get(pe);if(Pe!==void 0){if(V.currentProgram===Pe&&V.lightsStateVersion===re)return po(M,he),Pe}else he.uniforms=_e.getUniforms(M),M.onBeforeCompile(he,S),Pe=_e.acquireProgram(he,pe),Re.set(pe,Pe),V.uniforms=he.uniforms;const Se=V.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(Se.clippingPlanes=te.uniform),po(M,he),V.needsLights=Pc(M),V.lightsStateVersion=re,V.needsLights&&(Se.ambientLightColor.value=N.state.ambient,Se.lightProbe.value=N.state.probe,Se.directionalLights.value=N.state.directional,Se.directionalLightShadows.value=N.state.directionalShadow,Se.spotLights.value=N.state.spot,Se.spotLightShadows.value=N.state.spotShadow,Se.rectAreaLights.value=N.state.rectArea,Se.ltc_1.value=N.state.rectAreaLTC1,Se.ltc_2.value=N.state.rectAreaLTC2,Se.pointLights.value=N.state.point,Se.pointLightShadows.value=N.state.pointShadow,Se.hemisphereLights.value=N.state.hemi,Se.directionalShadowMap.value=N.state.directionalShadowMap,Se.directionalShadowMatrix.value=N.state.directionalShadowMatrix,Se.spotShadowMap.value=N.state.spotShadowMap,Se.spotLightMatrix.value=N.state.spotLightMatrix,Se.spotLightMap.value=N.state.spotLightMap,Se.pointShadowMap.value=N.state.pointShadowMap,Se.pointShadowMatrix.value=N.state.pointShadowMatrix),V.currentProgram=Pe,V.uniformsList=null,Pe}function fo(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Ks.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function po(M,U){const z=ve.get(M);z.outputColorSpace=U.outputColorSpace,z.batching=U.batching,z.batchingColor=U.batchingColor,z.instancing=U.instancing,z.instancingColor=U.instancingColor,z.instancingMorph=U.instancingMorph,z.skinning=U.skinning,z.morphTargets=U.morphTargets,z.morphNormals=U.morphNormals,z.morphColors=U.morphColors,z.morphTargetsCount=U.morphTargetsCount,z.numClippingPlanes=U.numClippingPlanes,z.numIntersection=U.numClipIntersection,z.vertexAlphas=U.vertexAlphas,z.vertexTangents=U.vertexTangents,z.toneMapping=U.toneMapping}function Rc(M,U,z,V,N){U.isScene!==!0&&(U=ct),T.resetTextureUnits();const Q=U.fog,re=V.isMeshStandardMaterial?U.environment:null,he=w===null?S.outputColorSpace:w.isXRRenderTarget===!0?w.texture.colorSpace:Et,pe=(V.isMeshStandardMaterial?k:x).get(V.envMap||re),Re=V.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,Pe=!!z.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Se=!!z.morphAttributes.position,Xe=!!z.morphAttributes.normal,$e=!!z.morphAttributes.color;let ht=zn;V.toneMapped&&(w===null||w.isXRRenderTarget===!0)&&(ht=S.toneMapping);const lt=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Ye=lt!==void 0?lt.length:0,Ee=ve.get(V),xt=f.state.lights;if(ee===!0&&(ge===!0||M!==v)){const Tt=M===v&&V.id===y;te.setState(V,M,Tt)}let Ke=!1;V.version===Ee.__version?(Ee.needsLights&&Ee.lightsStateVersion!==xt.state.version||Ee.outputColorSpace!==he||N.isBatchedMesh&&Ee.batching===!1||!N.isBatchedMesh&&Ee.batching===!0||N.isBatchedMesh&&Ee.batchingColor===!0&&N.colorTexture===null||N.isBatchedMesh&&Ee.batchingColor===!1&&N.colorTexture!==null||N.isInstancedMesh&&Ee.instancing===!1||!N.isInstancedMesh&&Ee.instancing===!0||N.isSkinnedMesh&&Ee.skinning===!1||!N.isSkinnedMesh&&Ee.skinning===!0||N.isInstancedMesh&&Ee.instancingColor===!0&&N.instanceColor===null||N.isInstancedMesh&&Ee.instancingColor===!1&&N.instanceColor!==null||N.isInstancedMesh&&Ee.instancingMorph===!0&&N.morphTexture===null||N.isInstancedMesh&&Ee.instancingMorph===!1&&N.morphTexture!==null||Ee.envMap!==pe||V.fog===!0&&Ee.fog!==Q||Ee.numClippingPlanes!==void 0&&(Ee.numClippingPlanes!==te.numPlanes||Ee.numIntersection!==te.numIntersection)||Ee.vertexAlphas!==Re||Ee.vertexTangents!==Pe||Ee.morphTargets!==Se||Ee.morphNormals!==Xe||Ee.morphColors!==$e||Ee.toneMapping!==ht||Ee.morphTargetsCount!==Ye)&&(Ke=!0):(Ke=!0,Ee.__version=V.version);let Xt=Ee.currentProgram;Ke===!0&&(Xt=ps(V,U,N));let oi=!1,Ut=!1,Wi=!1;const st=Xt.getUniforms(),kt=Ee.uniforms;if(Me.useProgram(Xt.program)&&(oi=!0,Ut=!0,Wi=!0),V.id!==y&&(y=V.id,Ut=!0),oi||v!==M){Me.buffers.depth.getReversed()?(ae.copy(M.projectionMatrix),Kh(ae),Zh(ae),st.setValue(C,"projectionMatrix",ae)):st.setValue(C,"projectionMatrix",M.projectionMatrix),st.setValue(C,"viewMatrix",M.matrixWorldInverse);const Pt=st.map.cameraPosition;Pt!==void 0&&Pt.setValue(C,je.setFromMatrixPosition(M.matrixWorld)),He.logarithmicDepthBuffer&&st.setValue(C,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&st.setValue(C,"isOrthographic",M.isOrthographicCamera===!0),v!==M&&(v=M,Ut=!0,Wi=!0)}if(N.isSkinnedMesh){st.setOptional(C,N,"bindMatrix"),st.setOptional(C,N,"bindMatrixInverse");const Tt=N.skeleton;Tt&&(Tt.boneTexture===null&&Tt.computeBoneTexture(),st.setValue(C,"boneTexture",Tt.boneTexture,T))}N.isBatchedMesh&&(st.setOptional(C,N,"batchingTexture"),st.setValue(C,"batchingTexture",N._matricesTexture,T),st.setOptional(C,N,"batchingIdTexture"),st.setValue(C,"batchingIdTexture",N._indirectTexture,T),st.setOptional(C,N,"batchingColorTexture"),N._colorsTexture!==null&&st.setValue(C,"batchingColorTexture",N._colorsTexture,T));const zt=z.morphAttributes;if((zt.position!==void 0||zt.normal!==void 0||zt.color!==void 0)&&we.update(N,z,Xt),(Ut||Ee.receiveShadow!==N.receiveShadow)&&(Ee.receiveShadow=N.receiveShadow,st.setValue(C,"receiveShadow",N.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(kt.envMap.value=pe,kt.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&U.environment!==null&&(kt.envMapIntensity.value=U.environmentIntensity),Ut&&(st.setValue(C,"toneMappingExposure",S.toneMappingExposure),Ee.needsLights&&Cc(kt,Wi),Q&&V.fog===!0&&oe.refreshFogUniforms(kt,Q),oe.refreshMaterialUniforms(kt,V,F,J,f.state.transmissionRenderTarget[M.id]),Ks.upload(C,fo(Ee),kt,T)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Ks.upload(C,fo(Ee),kt,T),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&st.setValue(C,"center",N.center),st.setValue(C,"modelViewMatrix",N.modelViewMatrix),st.setValue(C,"normalMatrix",N.normalMatrix),st.setValue(C,"modelMatrix",N.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Tt=V.uniformsGroups;for(let Pt=0,or=Tt.length;Pt<or;Pt++){const Gn=Tt[Pt];D.update(Gn,Xt),D.bind(Gn,Xt)}}return Xt}function Cc(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function Pc(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return w},this.setRenderTargetTextures=function(M,U,z){ve.get(M.texture).__webglTexture=U,ve.get(M.depthTexture).__webglTexture=z;const V=ve.get(M);V.__hasExternalTextures=!0,V.__autoAllocateDepthBuffer=z===void 0,V.__autoAllocateDepthBuffer||ze.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(M,U){const z=ve.get(M);z.__webglFramebuffer=U,z.__useDefaultFramebuffer=U===void 0};const Lc=C.createFramebuffer();this.setRenderTarget=function(M,U=0,z=0){w=M,P=U,R=z;let V=!0,N=null,Q=!1,re=!1;if(M){const pe=ve.get(M);if(pe.__useDefaultFramebuffer!==void 0)Me.bindFramebuffer(C.FRAMEBUFFER,null),V=!1;else if(pe.__webglFramebuffer===void 0)T.setupRenderTarget(M);else if(pe.__hasExternalTextures)T.rebindTextures(M,ve.get(M.texture).__webglTexture,ve.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const Se=M.depthTexture;if(pe.__boundDepthTexture!==Se){if(Se!==null&&ve.has(Se)&&(M.width!==Se.image.width||M.height!==Se.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");T.setupDepthRenderbuffer(M)}}const Re=M.texture;(Re.isData3DTexture||Re.isDataArrayTexture||Re.isCompressedArrayTexture)&&(re=!0);const Pe=ve.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Pe[U])?N=Pe[U][z]:N=Pe[U],Q=!0):M.samples>0&&T.useMultisampledRTT(M)===!1?N=ve.get(M).__webglMultisampledFramebuffer:Array.isArray(Pe)?N=Pe[z]:N=Pe,A.copy(M.viewport),G.copy(M.scissor),B=M.scissorTest}else A.copy(me).multiplyScalar(F).floor(),G.copy(xe).multiplyScalar(F).floor(),B=ye;if(z!==0&&(N=Lc),Me.bindFramebuffer(C.FRAMEBUFFER,N)&&V&&Me.drawBuffers(M,N),Me.viewport(A),Me.scissor(G),Me.setScissorTest(B),Q){const pe=ve.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+U,pe.__webglTexture,z)}else if(re){const pe=ve.get(M.texture),Re=U;C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,pe.__webglTexture,z,Re)}else if(M!==null&&z!==0){const pe=ve.get(M.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,pe.__webglTexture,z)}y=-1},this.readRenderTargetPixels=function(M,U,z,V,N,Q,re){if(!(M&&M.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let he=ve.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&re!==void 0&&(he=he[re]),he){Me.bindFramebuffer(C.FRAMEBUFFER,he);try{const pe=M.texture,Re=pe.format,Pe=pe.type;if(!He.textureFormatReadable(Re)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!He.textureTypeReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-V&&z>=0&&z<=M.height-N&&C.readPixels(U,z,V,N,Ne.convert(Re),Ne.convert(Pe),Q)}finally{const pe=w!==null?ve.get(w).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,pe)}}},this.readRenderTargetPixelsAsync=async function(M,U,z,V,N,Q,re){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let he=ve.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&re!==void 0&&(he=he[re]),he){const pe=M.texture,Re=pe.format,Pe=pe.type;if(!He.textureFormatReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!He.textureTypeReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(U>=0&&U<=M.width-V&&z>=0&&z<=M.height-N){Me.bindFramebuffer(C.FRAMEBUFFER,he);const Se=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Se),C.bufferData(C.PIXEL_PACK_BUFFER,Q.byteLength,C.STREAM_READ),C.readPixels(U,z,V,N,Ne.convert(Re),Ne.convert(Pe),0);const Xe=w!==null?ve.get(w).__webglFramebuffer:null;Me.bindFramebuffer(C.FRAMEBUFFER,Xe);const $e=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await $h(C,$e,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Se),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,Q),C.deleteBuffer(Se),C.deleteSync($e),Q}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(M,U=null,z=0){M.isTexture!==!0&&(Zn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),U=arguments[0]||null,M=arguments[1]);const V=Math.pow(2,-z),N=Math.floor(M.image.width*V),Q=Math.floor(M.image.height*V),re=U!==null?U.x:0,he=U!==null?U.y:0;T.setTexture2D(M,0),C.copyTexSubImage2D(C.TEXTURE_2D,z,0,0,re,he,N,Q),Me.unbindTexture()};const Dc=C.createFramebuffer(),Ic=C.createFramebuffer();this.copyTextureToTexture=function(M,U,z=null,V=null,N=0,Q=null){M.isTexture!==!0&&(Zn("WebGLRenderer: copyTextureToTexture function signature has changed."),V=arguments[0]||null,M=arguments[1],U=arguments[2],Q=arguments[3]||0,z=null),Q===null&&(N!==0?(Zn("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Q=N,N=0):Q=0);let re,he,pe,Re,Pe,Se,Xe,$e,ht;const lt=M.isCompressedTexture?M.mipmaps[Q]:M.image;if(z!==null)re=z.max.x-z.min.x,he=z.max.y-z.min.y,pe=z.isBox3?z.max.z-z.min.z:1,Re=z.min.x,Pe=z.min.y,Se=z.isBox3?z.min.z:0;else{const zt=Math.pow(2,-N);re=Math.floor(lt.width*zt),he=Math.floor(lt.height*zt),M.isDataArrayTexture?pe=lt.depth:M.isData3DTexture?pe=Math.floor(lt.depth*zt):pe=1,Re=0,Pe=0,Se=0}V!==null?(Xe=V.x,$e=V.y,ht=V.z):(Xe=0,$e=0,ht=0);const Ye=Ne.convert(U.format),Ee=Ne.convert(U.type);let xt;U.isData3DTexture?(T.setTexture3D(U,0),xt=C.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(T.setTexture2DArray(U,0),xt=C.TEXTURE_2D_ARRAY):(T.setTexture2D(U,0),xt=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,U.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,U.unpackAlignment);const Ke=C.getParameter(C.UNPACK_ROW_LENGTH),Xt=C.getParameter(C.UNPACK_IMAGE_HEIGHT),oi=C.getParameter(C.UNPACK_SKIP_PIXELS),Ut=C.getParameter(C.UNPACK_SKIP_ROWS),Wi=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,lt.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,lt.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Re),C.pixelStorei(C.UNPACK_SKIP_ROWS,Pe),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Se);const st=M.isDataArrayTexture||M.isData3DTexture,kt=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const zt=ve.get(M),Tt=ve.get(U),Pt=ve.get(zt.__renderTarget),or=ve.get(Tt.__renderTarget);Me.bindFramebuffer(C.READ_FRAMEBUFFER,Pt.__webglFramebuffer),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,or.__webglFramebuffer);for(let Gn=0;Gn<pe;Gn++)st&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,ve.get(M).__webglTexture,N,Se+Gn),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,ve.get(U).__webglTexture,Q,ht+Gn)),C.blitFramebuffer(Re,Pe,re,he,Xe,$e,re,he,C.DEPTH_BUFFER_BIT,C.NEAREST);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(N!==0||M.isRenderTargetTexture||ve.has(M)){const zt=ve.get(M),Tt=ve.get(U);Me.bindFramebuffer(C.READ_FRAMEBUFFER,Dc),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,Ic);for(let Pt=0;Pt<pe;Pt++)st?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,zt.__webglTexture,N,Se+Pt):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,zt.__webglTexture,N),kt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Tt.__webglTexture,Q,ht+Pt):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Tt.__webglTexture,Q),N!==0?C.blitFramebuffer(Re,Pe,re,he,Xe,$e,re,he,C.COLOR_BUFFER_BIT,C.NEAREST):kt?C.copyTexSubImage3D(xt,Q,Xe,$e,ht+Pt,Re,Pe,re,he):C.copyTexSubImage2D(xt,Q,Xe,$e,Re,Pe,re,he);Me.bindFramebuffer(C.READ_FRAMEBUFFER,null),Me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else kt?M.isDataTexture||M.isData3DTexture?C.texSubImage3D(xt,Q,Xe,$e,ht,re,he,pe,Ye,Ee,lt.data):U.isCompressedArrayTexture?C.compressedTexSubImage3D(xt,Q,Xe,$e,ht,re,he,pe,Ye,lt.data):C.texSubImage3D(xt,Q,Xe,$e,ht,re,he,pe,Ye,Ee,lt):M.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,Q,Xe,$e,re,he,Ye,Ee,lt.data):M.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,Q,Xe,$e,lt.width,lt.height,Ye,lt.data):C.texSubImage2D(C.TEXTURE_2D,Q,Xe,$e,re,he,Ye,Ee,lt);C.pixelStorei(C.UNPACK_ROW_LENGTH,Ke),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,Xt),C.pixelStorei(C.UNPACK_SKIP_PIXELS,oi),C.pixelStorei(C.UNPACK_SKIP_ROWS,Ut),C.pixelStorei(C.UNPACK_SKIP_IMAGES,Wi),Q===0&&U.generateMipmaps&&C.generateMipmap(xt),Me.unbindTexture()},this.copyTextureToTexture3D=function(M,U,z=null,V=null,N=0){return M.isTexture!==!0&&(Zn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),z=arguments[0]||null,V=arguments[1]||null,M=arguments[2],U=arguments[3],N=arguments[4]||0),Zn('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(M,U,z,V,N)},this.initRenderTarget=function(M){ve.get(M).__webglFramebuffer===void 0&&T.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?T.setTextureCube(M,0):M.isData3DTexture?T.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?T.setTexture2DArray(M,0):T.setTexture2D(M,0),Me.unbindTexture()},this.resetState=function(){P=0,R=0,w=null,Me.reset(),nt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return En}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=Ge._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ge._getUnpackColorSpace()}}/**
 * lil-gui
