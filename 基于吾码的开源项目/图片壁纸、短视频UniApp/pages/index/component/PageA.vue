							...
							<view v-for="(item, index) in rightList" :key="index" class="wallpaper__item"
								...
								<view class="item__image" style="position: relative;">
									<tn-lazy-load :threshold="6000" height="100%"
										:image="'https://os.microios.com:1110/jsnzk-public' + item.YulanT" :index="item.Id"
										...
										<view class="justify-content-item">
											<view class="tn-flex tn-flex-col-center tn-flex-row-left">
												<view class="logo-pic">
													<view class="logo-image">
														<view class=""
															:style="'background-image:url('+ 'https://os.microios.com:1110/jsnzk-public' + item.YulanT +');width: 40rpx;height: 40rpx;background-size: cover;'">
														</view>
													</view>
												</view>
												<view class="tn-padding-left-xs">
