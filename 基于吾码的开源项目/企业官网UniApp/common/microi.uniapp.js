 ...
 */
export var Microi = {
	ApiBase: ApiBase || 'https://api.microios.com', //接口前缀，前端写死
	OsClient: OsClient || 'huayu', //OsClient值，前端写死
	FileServer : FileServer || 'https://file.microios.com/huayu-public', //自动从SysConfig系统设置中获取
	H5Url:'',
	AppLogo: '/huayu/img/upload/logo.jpeg',///jinhai/img/20240203/jinhai-logo.jpeg
	AppKey: '',
	SysConfig : {},
	...
	FormEngine : {
		 ...
		 * 用法1：Microi.FormEngine.GetTableDataAnonymous('sys_user', {
					_Where : [{}]
				 }, function(result){
					 
				 });
		 * 用法2：Microi.FormEngine.GetTableDataAnonymous({
