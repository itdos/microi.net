<template>
  <div>
    ...
    <!-- 弹窗，V8设计器 -->
    <el-dialog :visible.sync="dialogShow" width="90%" top="10vh" :before-close="handleClose" title="V8引擎设计器"
            ...
            <div>
              <el-row class="tac">
                ...
                <el-col v-show="spanLeft>0" :span="spanLeft" style="position: relative;">
                  <el-button type="primary" class="changeBtn1" @click="changeLeft">切换</el-button>
                  ...
                  <div v-show="activeIndex==item.index" v-for="(item,index) in func_menu_data" :key="'func-'+index">
                    <div class="fieldset">
                      ...
                      <el-form :ref="`func-form${index}`" class="fieldset-form" :model="form" label-width="80px" :rules="rules" >
                        ...
                        <el-form-item label="内容" prop="msg" v-if="activeIndex=='4-1' || activeIndex=='4-2' || activeIndex=='4-6' || activeIndex=='4-9' || activeIndex=='4-10'">
                  ...
                  <div v-show="activeIndex==item.index" v-for="(item,index) in get_post_data" :key="'ajax-'+index">
                    <div class="fieldset">
                      ...
                      <el-form :ref="`ajax-form${index}`" class="fieldset-form" :model="form" label-width="80px" :rules="rules" >
                        ...
                        <el-form-item label="参数" prop="params" v-if="activeIndex=='6-1'||activeIndex=='6-2'||activeIndex=='6-3'||activeIndex=='6-4'||activeIndex=='6-5'">
                  ...
                  <div v-show="activeIndex==item.index" v-for="(item,index) in visit_menu_data" :key="'visit-'+index">
                    <div class="fieldset">
                      ...
                      <el-form :ref="`visit-form${index}`" class="fieldset-form" :model="form" label-width="80px" :rules="rules" >
                        ...
                        <el-form-item label="字段名称" prop="name" v-if="activeIndex!=='8-7' &&activeIndex!=='8-8' && activeIndex!=='8-9' && activeIndex!=='8-10' && activeIndex!=='8-11' && activeIndex!=='8-13'">
                          <el-select v-model="form.name" placeholder="请选择">
                            <el-option :label="value.Label" :value="value.Name" v-for="(value,index) in fields" :key="index"></el-option>
                          </el-select>
                        </el-form-item>
                ...
                <el-col v-show="spanRight>0" :span="spanRight" style="border-left: 1px solid #e6e6e6;position: relative;">
                  <el-button type="primary" class="changeBtn" @click="changeRight">切换</el-button>
                  <div style="padding:20px;">
                    <el-col :span="22" class="codetips">注：可以直接在框里写代码，但请务必按照如下格式添加，否则该代码不会收录进汇总中！！！</el-col>
                    <el-col class="codetips">//## 功能方法名字（必填）, 描述（选填） START </el-col>
                    <el-col class="codetips">...你的代码 </el-col>
                    <el-col class="codetips" style="margin-bottom:20px;">//## 功能方法名字（必填） END </el-col>
    ...
    return {
      ...
      visit_menu_data:[
        ...
        },
        {
          ...
          title: '当前登陆用户信息',
          index: '8-5',
          cont:'V8.CurrentUser：访问当前登陆用户信息。例如：V8.CurrentUser.属性',
          code:'V8.CurrentUser',
        },
        {
          name: 'visit-form5',
      ...
      this.$refs[formName][0].validate((valid) => {
          if (valid) {
            ...
            if (type.includes('6-')){
              ...
              if (type=='6-5'){
                if (formlist.params){
                  var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\',_RowModel:' + formlist.params 
                  + '},function(data){\n  //your code...\n\n})\n\n'
                }else{
              ...
              if (type=='6-6'||type=='6-7'){
                var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\',_RowModel:' + formlist.rowModel 
                + '},function(data){\n  //your code...\n\n})\n\n'
              }
              if (type=='6-8'){
                var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\'},function(data){\n  //your code...\n\n})\n\n'
...
.CodeMirror-code {
    line-height: 20px;
    //line-height: 1.15;//官方默认是给html设置这个值
}
</style>
