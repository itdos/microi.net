<template>
    <div class="diy-v8design">
        ...
        <el-dialog :visible.sync="dialogShow" width="90vw" top="10vh" 
            :before-close="handleClose" title="V8引擎设计器"
                    ...
                    <div>
                        <el-row class="tac">
                            <el-col :span="4" style="max-height: 700px;overflow-y: auto;">
                                <el-select class="searchV8" v-model="value" filterable remote reserve-keyword
                                ...
                                <el-menu class="el-menu-vertical-demo" @open="Open" @close="Close"
                            ...
                            <el-col v-show="spanLeft > 0" :span="spanLeft" style="position: relative;">
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in fuzhi_menu_data"
                                    :key="'fuzhi-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`fuzhu-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="字段名称" prop="name"
                                                v-if="activeIndex !== '1-3' && activeIndex !== '1-4'">
                                                <el-select v-model="form.name" placeholder="请选择">
                                                    <el-option :label="value.Label" :value="value.Name"
                                                        v-for="(value, index) in fields" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="属性" prop="sql" v-if="activeIndex == '1-1'">
                                                <el-select v-model="form.sql" placeholder="请选择">
                                                    <el-option :label="key" :value="key"
                                                        v-for="(value, key, index) in fields[0]" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="字段名称" prop="msg"
                                                v-if="activeIndex == '1-3' || activeIndex == '1-4'">
                                                <el-input style="width:215px;" v-model="form.msg" placeholder="请输入">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="值" prop="value">
                                                <el-input style="width:215px;" v-model="form.value" placeholder="请输入">
                                                </el-input>
                                            </el-form-item>

                                            <el-form-item style="margin-top:50px;">
                                                <el-button type="primary" @click="onSubmit(item.name, item.index)">生成代码
                                                </el-button>
                            ...
                            v-model="form.code">
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in action_menu_data"
                                    :key="'action-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`action-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="类型" prop="type">
                                                <el-select v-model="form.type" placeholder="请选择">
                                                    <el-option :label="value" :value="JSON.stringify([key, value])"
                                                        v-for="(value, key, index) in typeList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in sql_menu_data"
                                    :key="'sql-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`sql-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                          ...
                          <el-input type="textarea" :rows="3" v-model="form.sql" placeholder="请输入"></el-input>
                                            ...
                                            <el-form-item label="选择表单" prop="name">
                                                <el-select v-model="form.name" placeholder="请选择" @change="formChange">
                                                    <el-option :label="value.Description" :value="value.Name"
                                                        v-for="(value, index) in TableList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            ...
                                            <el-form-item v-if="!form.all" label="显示字段" prop="attr">
                                                <el-select v-model="form.attr" multiple placeholder="请选择">
                                                    <el-option :label="value.Label" :value="value.Name"
                                                        v-for="(value, index) in ziduanList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            ...
                                            <el-form-item label="选择条件">
                                                <el-col :span="6" style="margin-right:10px;">
                                                    <el-select v-model="form.value" placeholder="请选择">
                                                        <el-option :label="value.Label" :value="value.Name"
                                                            v-for="(value, index) in ziduanList" :key="index">
                                                        </el-option>
                                                    </el-select>
                                                </el-col>
                                                ...
                                                <el-col :span="6" style="margin-right:10px;">
                                                    <el-input type="text" placeholder="请输入内容" v-model="form.okText">
                                                    </el-input>
                                                </el-col>
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in func_menu_data"
                                    :key="'func-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`func-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="类型" prop="value" v-if="activeIndex == '4-10'">
                                                <el-input type="text" v-model="form.value" placeholder="请输入类型">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="内容" prop="msg"
                                                v-if="activeIndex == '4-1' || activeIndex == '4-2' || activeIndex == '4-6' || activeIndex == '4-9' || activeIndex == '4-10'">
                                                <el-input type="textarea" :rows="3" v-model="form.msg"
                                                    placeholder="请输入"></el-input>
                                            </el-form-item>
                                            <el-form-item label="标题" prop="sql"
                                                v-if="activeIndex == '4-9' || activeIndex == '4-10'">
                                                <el-input type="text" v-model="form.sql" placeholder="请输入标题"></el-input>
                                            </el-form-item>
                                            <el-form-item label="确认按钮" prop="okText" v-if="activeIndex == '4-9'">
                                                <el-input type="text" v-model="form.okText" placeholder="请输入确认按钮文字">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="取消按钮" prop="cancelText" v-if="activeIndex == '4-9'">
                                                <el-input type="text" v-model="form.cancelText" placeholder="请输入取消按钮文字">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="全拼前几" prop="value" v-if="activeIndex == '4-2'">
                                                <el-input type="text" v-model="form.value" placeholder="请输入数字值">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="类型" prop="type"
                                                v-if="activeIndex == '4-1' || activeIndex == '4-2' || activeIndex == '4-7' || activeIndex == '4-8'">
                                                <el-select v-model="form.type" placeholder="请选择">
                                            ...
                                            <el-form-item label="页码" prop="page" v-if="activeIndex == '4-3'">
                                                <el-input type="number" v-model.number="form.page"
                                                    placeholder="请输入数字，可为空"></el-input>
                                            </el-form-item>
                                            <el-form-item label="url" prop="url"
                                                v-if="activeIndex == '4-4' || activeIndex == '4-5'">
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in child_table_data"
                                    :key="'child-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`child-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="子表名称" prop="name" v-if="activeIndex !== '5-2'">
                                                <el-select v-model="form.name" placeholder="请选择" @change="tableChange">
                                                    <el-option :label="value.Label" :value="value.Name"
                                                        v-for="(value, index) in childList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            ...
                                            <el-form-item label="搜索条件" v-if="activeIndex == '5-3' || activeIndex == '5-4'">
                                                <el-col :span="8">
                                                    <el-form-item prop="attr">
                                                        <el-select v-model="form.attr" placeholder="请选择">
                                                            <el-option :label="value.Label" :value="value.Name"
                                                                v-for="(value, index) in nameList" :key="index">
                                                            </el-option>
                                                        </el-select>
                                                    </el-form-item>
                                                </el-col>
                                                <el-col :span="8">
                                                    <el-form-item prop="title">
                                                        <el-input type="text" v-model="form.title" placeholder="请输入">
                                                        </el-input>
                                                    </el-form-item>
                                                </el-col>
                                            ...
                                            <el-form-item label="已添加" prop="value"
                                                v-if="activeIndex == '5-3' || activeIndex == '5-4'">
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in get_post_data"
                                    :key="'ajax-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`ajax-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="url" prop="url"
                                                v-if="activeIndex == '6-1' || activeIndex == '6-2' || activeIndex == '6-3' || activeIndex == '6-4'">
                                                <el-input type="text" v-model="form.url" placeholder="请输入请求地址">
                                                </el-input>
                                            </el-form-item>
                                            <el-form-item label="表单名" prop="value"
                                                v-if="activeIndex == '6-5' || activeIndex == '6-6' || activeIndex == '6-7' || activeIndex == '6-8'">
                                                <!-- <el-input type="text" v-model="form.value" placeholder="请输入表单id（TableId）"></el-input> -->
                                                <el-select v-model="form.value" placeholder="请选择"
                                                    @change="getTableRowId(form.value)">
                                                    <el-option :label="item.Description" :value="item.Id"
                                                        v-for="(item, index) in TableList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="选择数据" prop="msg"
                                                v-if="activeIndex == '6-5' || activeIndex == '6-6' || activeIndex == '6-7' || activeIndex == '6-8'">
                                                <!-- <el-input type="text" v-model="form.msg" placeholder="请输入表单行id（TableRowId）"></el-input> -->
                                                <el-select v-model="form.msg" placeholder="请选择">
                                                    <el-option :label="item.Mingcheng" :value="item.Id"
                                                        v-for="(item, index) in TableRowList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="参数" prop="params"
                                                v-if="activeIndex == '6-1' || activeIndex == '6-2' || activeIndex == '6-3' || activeIndex == '6-4' || activeIndex == '6-5'">
                                                <el-input type="textarea" :rows="3" v-model="form.params"
                                                    placeholder="请输入所需参数，json格式，请记得加{}"></el-input>
                                            </el-form-item>
                                            <el-form-item label="参数" prop="rowModel"
                                                v-if="activeIndex == '6-6' || activeIndex == '6-7'">
                                                <el-input type="textarea" :rows="3" v-model="form.rowModel"
                                                    placeholder="请输入所需参数，json格式，请记得加{}"></el-input>
                                            </el-form-item>
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in other_menu_data"
                                    :key="'other-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`other-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="搜索条件" v-if="activeIndex == '7-1' || activeIndex == '7-2'">
                                                <el-col :span="8">
                                                    <el-form-item prop="attr">
                                                        <el-select v-model="form.attr" placeholder="请选择">
                                                            <el-option :label="value.Label" :value="value.Name"
                                                                v-for="(value, index) in childList" :key="index">
                                                            </el-option>
                                                        </el-select>
                                                    </el-form-item>
                                                </el-col>
                                            ...
                                            <el-form-item label="已添加" prop="value"
                                                v-if="activeIndex == '7-1' || activeIndex == '7-2'">
                                                <el-col style="display:none;">{{ form.value }}</el-col>
                                                <el-col v-for="(item, index) in valueSearch" :key="index">
                                                    {{ item.label }} : {{ item.value }}
                                                    <el-button style="margin-left:20px;" size="mini"
                                            ...
                                            <el-form-item label="名称" prop="attr"
                                                v-if="activeIndex == '7-3' || activeIndex == '7-4'">
                                                <el-select v-model="form.attr" placeholder="请选择">
                                                    <el-option :label="value.Label" :value="value.Name"
                                                        v-for="(value, index) in childList" :key="index"></el-option>
                                                </el-select>
                                            ...
                                            <el-form-item label="参数" prop="value" v-if="activeIndex == '7-3'">
                                                <el-input type="textarea" :rows="3" v-model="form.value"
                                                    placeholder="请输入所需参数，json格式"></el-input>
                                            </el-form-item>
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in visit_menu_data"
                                    :key="'visit-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`visit-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="字段名称" prop="name"
                                                v-if="activeIndex !== '8-7' && activeIndex !== '8-8' && activeIndex !== '8-9' && activeIndex !== '8-10' && activeIndex !== '8-11' && activeIndex !== '8-13'">
                                                <el-select v-model="form.name" placeholder="请选择">
                                                    <el-option :label="value.Label" :value="value.Name"
                                                        v-for="(value, index) in fields" :key="index"></el-option>
                                                </el-select>
                                ...
                                <div v-show="activeIndex == item.index" v-for="(item, index) in work_flow_data"
                                    :key="'work-' + index">
                                    <div class="fieldset">
                                        <h3>{{ item.title }}</h3>
                                        <p>{{ item.cont }}</p>
                                        <el-form :ref="`work-form${index}`" class="fieldset-form" :model="form"
                                            label-width="80px" :rules="rules">
                                            <el-form-item label="功能描述" prop="miaoshu">
                                                <el-input style="width:215px;" type="textarea" :rows="2"
                                                    placeholder="请输入该V8功能的描述" v-model="form.miaoshu">
                                            ...
                                            <el-form-item label="流程图" prop="name">
                                                <el-select v-model="form.name" placeholder="请选择流程图">
                                                    <el-option :label="item.FlowName" :value="item.Id"
                                                        v-for="(item, index) in liuchengList" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item label="线内容" prop="okText">
                                                <el-input type="text" v-model="form.okText"
                                                    placeholder="请输入LineValue（只有一条线时可不传）"></el-input>
                                            </el-form-item>
                        ...
                        <el-form-item label="关联数据" prop="value1">
                          <el-input type="text" v-model="form.value1" placeholder="请输入TableRowId（必传，默认为当前表单Id，V8.Form.Id）"></el-input>
                                            ...
                                            <el-form-item label="通知数据" prop="attr">
                                                <el-select v-model="form.attr" multiple placeholder="请选择">
                                                    <el-option :label="item.Label" :value="item.Id"
                                                        v-for="(item, index) in fields" :key="index"></el-option>
                                                </el-select>
                                            </el-form-item>
                            ...
                            <el-col v-show="spanRight > 0" :span="spanRight"
                                style="border-left: 1px solid #e6e6e6;position: relative;">
...
export default {
    ...
    methods: {
            ...
            this.$refs[formName][0].validate((valid) => {
                if (valid) {
                    ...
                    if (type.includes('4-')) {
                        ...
                        if (type == '4-9') {
                            var txt = code + '(\'' + formlist.msg + '\',\nfunction(){\n  //点击确认后，可执行...\n\n},\nfunction(){\n  //点击取消后，可执行...\n\n},\n{Title:\''
                                + formlist.title + '\',OkText:\'' + formlist.okText + '\',CancelText:\'' + formlist.cancelText + '\',Icon:\'\'})\n\n'
                        }
                        if (type == '4-10') {
                    ...
                    if (type.includes('6-')) {
                        ...
                        if (type == '6-5') {
                            if (formlist.params) {
                                var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\',_FormData:' + formlist.params
                                    + '},function(data){\n  //your code...\n\n})\n\n'
                            } else {
                        ...
                        if (type == '6-6' || type == '6-7') {
                            var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\',_FormData:' + formlist.rowModel
                                + '},function(data){\n  //your code...\n\n})\n\n'
                        }
                        if (type == '6-8') {
                            var txt = code + '({TableId:\'' + formlist.value + '\',_TableRowId:\'' + formlist.msg + '\'},function(data){\n  //your code...\n\n})\n\n'
                    ...
                    if (type.includes('9-')) {
                        ...
                        var txt = 'v8.WorkFlow.StartWork({\n FlowDesignId:\'' + formlist.name + '\',\n LineValue:\''
                            + formlist.okText + '\',\n FormData:{},\n TableRowId:V8.Form.Id,\n NoticeFields:[' + abbString
        ...
        getFormList() {
            var self = this
            // console.log('数据库sql-------')
            this.$axios.post(this.https + '/api/diytable/getDiyTable', qs.stringify({
                _Keyword: '',
            }), {
                headers: {
                    'authorization': 'Bearer ' + localStorage.getItem('authorization'),
        ...
        getTableRowId(id) {
            var self = this
            this.$axios.post(this.https + '/api/diytable/getDiyTableRow', qs.stringify({
                _Keyword: '',
                TableId: id,
            }), {
                headers: {
        ...
        thatList() {
            ...
            aa[0] = this.fuzhi_menu_data.map(item => {
                return { value: `${JSON.stringify(item)}`, label: `${item.title},${item.code}` };
            });
