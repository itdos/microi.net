...
<div
    ...
    <el-tabs
        ...
        <el-row :gutter="10">
          <el-col :span="4" :xs="24">
              <el-card
                  class="box-card" style="height: 89vh;"
                  >
                  ...
                  <div class="text item"  style="max-height: calc(100vh - 220px);overflow-y: scroll;">
                     ...
                     <el-tree
                          ...
                          @node-click="TreeCateClick"></el-tree>
                  </div>
              </el-card>
          </el-col>
...
export default {
    ...
    mounted() {
        ...
        //刘诚2024-12-7新增开始
        self.query = this.$route.query;
        if(self.query && self.query.MenuId){
          self.GetCateList(self.query.MenuId);
        }
        //刘诚2024-12-7新增结束
        if(self.ParentFormLoadFinish !== false){
            self.Init();
    ...
    methods: {
      ...
      //刘诚2024-12-7新增结束
        ...
        TableSetData(dataObj){
            var slef = this;
            sself.DiyTableRowList = dataObj.Data;
