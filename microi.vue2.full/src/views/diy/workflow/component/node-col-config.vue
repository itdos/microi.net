<template>
    <div style="padding:10px;">
        ...
        <el-table
            ...
            label="通知"
            width="50">
                <template slot-scope="scope" v-if="scope.row.Component!=='AutoNumber'&&scope.row.Component!=='TableChild'&&scope.row.Component!=='Guid'&&scope.row.Component!=='Progress'&&scope.row.Component!=='FontAwesome'&&scope.row.Component!=='DevComponent'&&scope.row.Component!=='ImgUpload'&&scope.row.Component!=='FileUpload'&&scope.row.Component!=='Divider'&&scope.row.Component!=='HTML'">
