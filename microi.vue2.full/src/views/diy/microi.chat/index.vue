    ...
    <div class="vChat-panel" style="background-image: url(src/assets/img/placeholder/vchat__panel-bg01.jpg);">
        <div class="vChat-inner flexbox">
                ...
                <div class="list flex1">
                    <ul class="clearfix">
                        ...
                        <router-link 
                            ...
                            active-class="on" tag="li" to="" exact>
                            <span 
                                @click="ChatMiddlebarType = 'RecentContacts'"
                                class="ico">
                        ...
                        <!-- to="/contact" -->
                        <router-link 
                            active-class="on" tag="li" to=""><span class="ico">
                                <i 
                                    @click="GetSysUserPublicInfo();ChatMiddlebarType = 'Contacts';"
                                    class="iconfont icon-side__tongxunlu"></i></span>
                        </router-link>
                        <!-- to="/qzone" -->
            ...
            <div class="flex1 flexbox">
                ...
                <div 
                    v-if="FirstConnectWebsocket" 
                    style="z-index:1;height:100%;background-color:#ccc;position: absolute;width: calc(100% - 60px);opacity: 0.5;"></div>
                <div 
                    ...
                    <div class="vc-searArea">
                        <div class="iptbox flexbox">
                            <el-input placeholder="搜索" prefix-icon="el-icon-search" v-model="kw"></el-input></div>
                    </div>
                ...
                <div 
                    ...
                    class="vChat-middlebar flexbox flex__direction-column"> 
                    <div class="vc-searArea"> <div class="iptbox flexbox">
                        <el-input placeholder="搜索" prefix-icon="el-icon-search" v-model="kw"></el-input></div>
                    </div>
                    <div class="vc-addrFriendList flex1 flexbox flex__direction-column" style="overflow:auto;">
                            ...
                            <li id="A">
                                <div @click="$root.OpenDiyChat(user);ChatMiddlebarType = 'RecentContacts';" 
                                    v-for="(user, index) in AllContactsList" 
                                    :key="'contacts_' + user.Id">
                                    <!-- <h2 class="initial wc__borT">A</h2> -->
                                    <router-link   
                                        to="" class="row flexbox flex-alignc wc__material-cell"> 
                ...
                <div class="vChat-container flex1 flexbox flex__direction-column">
                    <div class="vChat__header">
                        <div class="inner flexbox">
                            <h2 class="barTit flex1">
                                {{DiyCommon.IsNull(GetCurrentLastContact.ContactUserName) ? '' : GetCurrentLastContact.ContactUserName}}</h2>
                        ...
                        <div class="vChatMsg-cnt">
                            <ul class="clearfix" id="J__chatMsgList">
                                ...
                                <li 
                                    ...
                                    :class="(chat.FromUserId == GetCurrentUser.Id) 
                                                ? 'me' : 'others'">
                                    <router-link 
                    ...
                    <div class="vChat__footTool">
                        ...
                        <div class="wc__editor-panel wc__borT flexbox flex__direction-column"
                            :style="{backgroundColor:DiyCommon.IsNull(GetCurrentLastContact.ContactUserId) 
                                        ? 'rgba(245, 245, 245, .95)' : 'rgba(255,255,255,.9)'}"
                            >
                            ...
                            <div class="wrap-editor flex1">
                                <div class="editor J__wcEditor" id="J__wcEditor" 
                                    :placeholder="(!DiyCommon.IsNull(GetCurrentLastContact.ContactUserId)) 
                                                    ? '输入文字或Ctrl+V粘贴图片...'
                                                    : '请选择一个聊天对象！'"
                            ...
                            <el-button 
                                ...
                                :style="{backgroundColor:(DiyCommon.IsNull(GetCurrentLastContact.ContactUserId)) ? '#d5d5d5' : ''}"
                                @click="SendMessage">
                                发送
                            </el-button>
                        </div>
                            ...
                            <div class="wrap-emotion">
                                <div class="emotion__cells flexbox flex__direction-column">
                                    ...
                                    <div class="emotion__cells-footer" id="J__emotionFootTab">
                                        <ul class="clearfix">
                                            <li class="swiperTmpl cur" tmpl="swiper__tmpl-emotion01"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/face-lbl.png'" alt=""></li>
                                            <li class="swiperTmpl" tmpl="swiper__tmpl-emotion02"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/face-lbl.gif'" alt=""></li>
                                            <li class="swiperTmpl" tmpl="swiper__tmpl-emotion03"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/face-lbl.gif'" alt=""></li>
                                            <li class="swiperTmpl" tmpl="swiper__tmpl-emotion04"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/face-lbl.gif'" alt=""></li>
                                            <li class="swiperTmpl" tmpl="swiper__tmpl-emotion05"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/face-lbl.gif'" alt=""></li>
                                            <li class="swiperTmpl" tmpl="swiper__tmpl-emotion06"><img :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/face-lbl.gif'" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper__tmpl-emotion01" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__sm-list"> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/0.png'" /></span>
                        ...
                        <div class="swiper-slide">
                            <div class="face-list face__sm-list">
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/26.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/27.png'" /></span>
                                ...
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/51.png'" /></span><span><img class="del" src="/static/diy-chat/img/icon__emotion-del.png" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__sm-list">
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/52.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/53.png'" /></span>
                                ...
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/75.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/76.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/77.png'" /></span> <span><img class="del" src="/static/diy-chat/img/icon__emotion-del.png" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__sm-list"><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/78.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/79.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/80.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/81.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/82.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/83.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/84.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/85.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/86.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/87.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/88.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/89.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/90.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/91.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/92.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/93.png'" /></span><span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/94.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/95.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/96.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/97.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/98.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/99.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/100.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/101.png'" /></span> <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/102.png'" /></span>
                                <span><img class="face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face01/103.png'" /></span> <span><img class="del" src="/static/diy-chat/img/icon__emotion-del.png" /></span>
                            </div>
                        </div>
                    </div>
                    <!-- //动图2 -->
                    <div class="swiper__tmpl-emotion02" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/0.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/1.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/2.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/3.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/4.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/5.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/6.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/7.gif'" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/8.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/9.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/10.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/11.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/12.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/13.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/14.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face02/15.gif'" /></span>
                            </div>
                        </div>
                    </div>
                    <!-- //动图3 -->
                    <div class="swiper__tmpl-emotion03" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/0.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/1.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/2.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/3.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/4.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/5.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/6.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/7.gif'" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/8.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/9.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/10.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/11.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/12.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/13.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/14.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face03/15.gif'" /></span>
                            </div>
                        </div>
                    </div>
                    <!-- //动图4 -->
                    <div class="swiper__tmpl-emotion04" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/0.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/1.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/2.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/3.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/4.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/5.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/6.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/7.gif'" /></span></div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/8.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/9.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/10.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/11.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/12.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/13.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/14.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face04/15.gif'" /></span> </div>
                        </div>
                    </div>
                    <!-- //动图5 -->
                    <div class="swiper__tmpl-emotion05" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/0.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/1.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/2.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/3.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/4.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/5.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/6.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/7.gif'" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/8.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/9.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/10.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/11.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/12.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/13.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face05/14.gif'" /></span>
                    ...
                    <div class="swiper__tmpl-emotion06" style="display: none;">
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/0.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/1.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/2.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/3.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/4.gif'" /></span><span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/5.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/6.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/7.gif'" /></span>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="face-list face__lg-list"> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/8.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/9.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/10.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/11.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/12.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/13.gif'" /></span>
                                <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/14.gif'" /></span> <span><img class="lg-face" :src="DiyCommon.GetFileServer() + '/static/diy-chat/img/emotion/face06/15.gif'" /></span>
                            </div>
                        </div>
                    </div>
                    <!-- …… 表情模板.End -->
...
export default {
    ...
    mounted() {
        ...
        $(function () {
            ...
            $("body").on("click", "#J__swiperEmotion .face-list span img", function () {
                var that = $(this),
                    range;
                if (that.hasClass("face") || that.hasClass("lg-face")) { //小表情
    ...
    methods: {
        GetSysUserPublicInfo(){
            var self = this;
            self.DiyCommon.Post('/api/SysUser/getSysUserPublicInfo', {
                State : 1
            }, function(result){
        ...
        SendLastContacts(){
            ...
            self.$websocket.invoke("SendLastContacts", {
        ...
        SendUnreadCountToUser(){
            ...
            self.$websocket.invoke("SendUnreadCountToUser", {
        ...
        SendMessage() {
            ...
            try {
                ...
                self.$websocket.invoke("SendToUser", {
                    Content: _html, //msgTpl,
                    OsClient: self.DiyCommon.GetOsClient(),
                    ToUserId: self.GetCurrentLastContact.ContactUserId,
