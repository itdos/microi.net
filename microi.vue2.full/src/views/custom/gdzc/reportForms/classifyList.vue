    ...
    methods: {
      async onExportExcel(){
        let payload = {
         ...
         const url = `${this.$apiHost}/export/export_zichan_fenlei_report?`+qs.stringify(payload);
      ...
      async getTableList(init = false) {
        ...
        this.DiyCommon.Get(`${self.$apiHost}/zichan/get_zichan_fenlei`,payload,function (result) {
            if (result.Code == 1) {
