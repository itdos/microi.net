                ...
                <el-form
                    ...
                    <el-form-item size="mini">
                        ...
                        <el-button
                            type="primary"
                            icon="el-icon-plus"
                            @click="OpenSysUser()">{{ $t('Msg.Add') }}</el-button>
                    </el-form-item>
                    <el-form-item
                        size="mini">
                        <el-input
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-button
                                    ...
                                    class="marginRight5"
                                    icon="el-icon-s-help"
                                    @click="OpenSysUser(scope.row)">{{ $t('Msg.Edit') }}</el-button>
                                <el-button
                                    type="text"
                                    size="mini"
                                    class="marginRight5"
                                    icon="el-icon-chat-dot-round"
                                    @click="$root.OpenDiyChat(scope.row)">{{ '微聊' }}</el-button>
                                <el-button
                                    type="text"
                                    size="mini"
                                    class="marginRight5"
                                    icon="el-icon-s-help"
                                    @click="DelSysUser(scope.row)">{{ $t('Msg.Del') }}</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                    <el-pagination
                            ...
                            <el-card class="box-card card-data-animate">
                                <div slot="header">
                                    <div>
                                        ...
                                        <div class="pull-left marginRight5 title">{{model.Name}} </div>
                                        <div class="pull-left"><el-tag>Lv.{{model.Level}}</el-tag></div>
                                    </div>
                                    <div style="float: right;">
                                        <el-button
                                            ...
                                            class="marginRight5"
                                            icon="el-icon-s-help"
                                            @click="OpenSysUser(model)">{{ $t('Msg.Edit') }}</el-button>
                                ...
                                <div class="item clear">
                                    ...
                                    <i class="el-icon-mobile-phone" style="margin-left:10px;"></i> {{model.Phone}} 
                                    <i class="el-icon-open" style="margin-left:10px;"></i> {{ model.State == 1 ? '启用' : '停用' }}
                                </div>
                                <div class="item" style="padding-top: 3px;">
                                    ...
                                    <el-tooltip 
                                        ...
                                        effect="dark" :content="GetRolesStr(model._Roles)" placement="top">
                                        <el-tag >
                                                <div style="max-width:150px;" class="over-hide no-br">{{GetRolesStr(model._Roles)}}</div>
                                        </el-tag>
                                    </el-tooltip>
                                </div>
                                <div class="bottom-time">
    ...
    <el-dialog
        ...
        <el-form
            ...
            <el-row :gutter="20">
                ...
                <el-col
                    :span="8"
                    :xs="24"
                    v-if="GetCurrentUser._IsAdmin === true && !DiyCommon.IsNull(CurrentSysUserModel.Id)"
                    >
                    <el-form-item
                        size="mini">
                ...
                <el-col
                    ...
                    <el-form-item
                        ...
                        <el-cascader
                            ...
                            :options="SysDeptList"
                            :props="{ value: 'Id', label:'Name', children:'_Child',checkStrictly : true, emitPath : false }"
                ...
                <el-col
                    ...
                    <el-form-item
                        :label="'组织机构代码'"
                        size="mini">
                        <el-input readonly disabled :value="DiyCommon.IsNull(CurrentSysUserModel.DeptCode)? '' : CurrentSysUserModel.DeptCode.substring(0, CurrentSysUserModel.DeptCode.length - 1)" placeholder="自动生成" />
                ...
                <el-col
                    ...
                    <el-form-item
                        :label="$t('Msg.Remark')"
                        size="mini">
                        <el-input v-model="CurrentSysUserModel.Remark" 
                            type="textarea"
                            :rows="2"/>
                    </el-form-item>
                </el-col>
        ...
        <span slot="footer" class="dialog-footer">
            <el-button
                ...
                size="mini"
                icon="el-icon-s-help"
                @click="SaveSysUser">{{ $t('Msg.Save') }}</el-button>
            <el-button
                size="mini"
                icon="el-icon-close"
...
export default {
    ...
    methods: {
        ...
        GetSysUserPassword(){
            var self = this;
            self.DiyCommon.Post('/api/SysUser/GetSysUserPassword', {
        ...
        GetSysUser(initPageIndex) {
            ...
            self.DiyCommon.Post(self.DiyApi.GetSysUser(), {
        ...
        DelSysUser(m) {
            ...
            self.DiyCommon.OsConfirm(self.$t('Msg.ConfirmDelTo') + '【' + m.Name + '】？', function () {
                self.DiyCommon.Post(self.DiyApi.DelSysUser(), {
                        Id: m.Id
                    },
                    function (result) {
                        if (self.DiyCommon.Result(result)) {
        ...
        SaveSysUser() {
            ...
            try {
                ...
                self.DiyCommon.Post(url, realParam, function (result) {
                    self.SaveSysUserLoding = false;
                    if (self.DiyCommon.Result(result)) {
                        self.DiyCommon.Tips(self.$t('Msg.Success'))
                        self.GetSysUser()
