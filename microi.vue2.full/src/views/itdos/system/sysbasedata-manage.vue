...
-->
<div
    id="diviTdosSystemManage"
    class="pluginPage">
    <div class="pluginPage-aero" />
    <div class="row microi-desktop-tab">
        <div
            :class="'microi-desktop-tab-right col-md-10 col-sm-10 col-xs-10 transition3 ' + (LeftMenuHide ? 'width100' : '')"
            style="">
                ...
                <div
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" v-if="!DiyCommon.IsNull(CurrentSysBaseDataModel.Id)">
                            <el-form
                                :model="CurrentSysBaseDataModel"
                                class="demo-form-inline">
                                <el-form-item label="Key">
                                    <el-input
                                        v-model="CurrentSysBaseDataModel.Key"
                                        placeholder="Code"></el-input>
                                </el-form-item>
                                <el-form-item label="Value">
                                    <el-input
                                        v-model="CurrentSysBaseDataModel.Value"
                                        placeholder="值"></el-input>
                                </el-form-item>
                                <el-form-item label="备注">
                                    <el-input
                                        v-model="CurrentSysBaseDataModel.Remark"
                                        placeholder=""></el-input>
                                </el-form-item>
                                <el-form-item label="Id">
                                    <el-input
                                        v-model="CurrentSysBaseDataModel.Id"
                                        :readonly="true"
                                        :disabled="true"
                                        placeholder=""></el-input>
                                </el-form-item>
                                <el-form-item>
                                    <el-button
                                        type="primary"
                                        @click.stop="UptSysBaseData">{{$t('Msg.Save')}}</el-button>
                                </el-form-item>
                            </el-form>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        UptSysBaseData() {
            var self = this;
            self.DiyCommon.Post(self.DiyApi.UptSysBaseData(), {
                    ...
                    var setting = {
                            ...
                            addHoverDom: function (treeId, treeNode) {
                                ...
                                if (btn) {
                                    btn.bind('click', function () {
                                        ...
                                        self.DiyCommon.Post(self.DiyApi.AddSysBaseData(), param, function (
                                            data2
                                        ) {
                        ...
                        callback: {
                            ...
                            beforeRename: function (treeId, treeNode, newName, isCancel) {
                                ...
                                self.DiyCommon.Post(self.DiyApi.UptSysBaseData(), param, function (
                                    data3
                                ) {
