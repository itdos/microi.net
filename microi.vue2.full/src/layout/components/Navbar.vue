<template>
    <div class="navbar-microi" :style="GetNavbarMicroiStyle()">
        ...
        <div class="right-menu">
            <!-- v-if="device !== 'mobile'" -->
            <template>
                <span v-if="GetCurrentUser.TenantName"
                    class="right-menu-item hand" style="line-height: 50px;font-size: 14px;">
                ...
                <span 
                    ...
                    <el-badge 
                        ...
                        <i class="el-icon-chat-dot-round" 
                            :style="{fontSize: '21px', display: 'block', 
                                    color : (WebSocketOnline ? '#000' : '#000')}"></i>
                    </el-badge>
                </span>
        ...
        <el-dialog
            ...
            <div
                ...
                <el-button
                    size="mini"
                    icon="el-icon-close"
                    @click="dialogUptPwd = false">取 消</el-button>
                <el-button
                    type="primary"
                    size="mini"
                    icon="el-icon-check"
                    @click="UptSysUser">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
